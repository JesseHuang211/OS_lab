...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800038:	56450513          	addi	a0,a0,1380 # 800598 <main+0x58>
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  800058:	56450513          	addi	a0,a0,1380 # 8005b8 <main+0x78>
...
exit(int error_code) {
  ...
  800126:	49e50513          	addi	a0,a0,1182 # 8005c0 <main+0x80>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800182:	45a78793          	addi	a5,a5,1114 # 8005d8 <main+0x98>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001da:	53aa8a93          	addi	s5,s5,1338 # 800710 <main+0x1d0>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  800404:	46878793          	addi	a5,a5,1128 # 800868 <error_string>
  ...
  800414:	1f860613          	addi	a2,a2,504 # 800608 <main+0xc8>
  ...
  800428:	1d460613          	addi	a2,a2,468 # 8005f8 <main+0xb8>
  ...
  80049c:	159a0a13          	addi	s4,s4,345 # 8005f1 <main+0xb1>
  ...
  8004da:	11a50513          	addi	a0,a0,282 # 8005f0 <main+0xb0>
  8004de:	046000ef          	jal	800524 <strnlen>
  8004e2:	40ac8cbb          	subw	s9,s9,a0
                p = "(null)";
  8004e6:	00000417          	auipc	s0,0x0
  8004ea:	10a40413          	addi	s0,s0,266 # 8005f0 <main+0xb0>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
  8004ee:	00000a17          	auipc	s4,0x0
  8004f2:	103a0a13          	addi	s4,s4,259 # 8005f1 <main+0xb1>
...
int main(void) {
  ...
  800542:	e406                	sd	ra,8(sp)
    if (zero == 0) {
  800544:	00001797          	auipc	a5,0x1
  800548:	abc7a783          	lw	a5,-1348(a5) # 801000 <zero>
  80054c:	eb99                	bnez	a5,800562 <main+0x22>
        cprintf("value is -1.\n"); // 输出 -1
  80054e:	00000517          	auipc	a0,0x0
  800552:	18250513          	addi	a0,a0,386 # 8006d0 <main+0x190>
  800556:	b4bff0ef          	jal	8000a0 <cprintf>
        return -1; // 返回 -1
    }
    cprintf("value is %d.\n", 1 / zero);
    panic("FAIL: T.T\n");
}
  80055a:	60a2                	ld	ra,8(sp)
  80055c:	557d                	li	a0,-1
  80055e:	0141                	addi	sp,sp,16
  800560:	8082                	ret
    cprintf("value is %d.\n", 1 / zero);
  800562:	0017871b          	addiw	a4,a5,1
  800566:	00373713          	sltiu	a4,a4,3
  80056a:	4581                	li	a1,0
  80056c:	c319                	beqz	a4,800572 <main+0x32>
  80056e:	0007859b          	sext.w	a1,a5
  800572:	00000517          	auipc	a0,0x0
  800576:	16e50513          	addi	a0,a0,366 # 8006e0 <main+0x1a0>
  80057a:	b27ff0ef          	jal	8000a0 <cprintf>
    panic("FAIL: T.T\n");
  80057e:	00000617          	auipc	a2,0x0
  800582:	17260613          	addi	a2,a2,370 # 8006f0 <main+0x1b0>
  800586:	45b1                	li	a1,12
  800588:	00000517          	auipc	a0,0x0
  80058c:	17850513          	addi	a0,a0,376 # 800700 <main+0x1c0>
  800590:	a97ff0ef          	jal	800026 <__panic>
