...
ffffffffc0200048:	e406                	sd	ra,8(sp)
    memset(edata, 0, end - edata);
ffffffffc020004a:	5e5040ef          	jal	ffffffffc0204e2e <memset>
...
ffffffffc0200056:	e2e58593          	addi	a1,a1,-466 # ffffffffc0204e80 <etext+0x4>
ffffffffc020005a:	00005517          	auipc	a0,0x5
ffffffffc020005e:	e4650513          	addi	a0,a0,-442 # ffffffffc0204ea0 <etext+0x24>
...
ffffffffc020007a:	58a040ef          	jal	ffffffffc0204604 <proc_init>
...
ffffffffc020008e:	7c2040ef          	jal	ffffffffc0204850 <cpu_idle>
...
ffffffffc02000ac:	e0050513          	addi	a0,a0,-512 # ffffffffc0204ea8 <etext+0x2c>
...
ffffffffc0200172:	c602                	sw	zero,12(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc0200174:	0ab040ef          	jal	ffffffffc0204a1e <vprintfmt>
    return cnt;
}
...
ffffffffc02001a6:	c202                	sw	zero,4(sp)
    vprintfmt((void*)cputch, &cnt, fmt, ap);
ffffffffc02001a8:	077040ef          	jal	ffffffffc0204a1e <vprintfmt>
    cnt = vcprintf(fmt, ap);
    va_end(ap);
    return cnt;
}
...
ffffffffc02001cc:	ce850513          	addi	a0,a0,-792 # ffffffffc0204eb0 <etext+0x34>
void print_kerninfo(void) {
...
ffffffffc02001e2:	cf250513          	addi	a0,a0,-782 # ffffffffc0204ed0 <etext+0x54>
ffffffffc02001e6:	f9bff0ef          	jal	ffffffffc0200180 <cprintf>
    cprintf("  etext  0x%08x (virtual)\n", etext);
ffffffffc02001ea:	00005597          	auipc	a1,0x5
ffffffffc02001ee:	c9258593          	addi	a1,a1,-878 # ffffffffc0204e7c <etext>
ffffffffc02001f2:	00005517          	auipc	a0,0x5
ffffffffc02001f6:	cfe50513          	addi	a0,a0,-770 # ffffffffc0204ef0 <etext+0x74>
...
ffffffffc020020a:	d0a50513          	addi	a0,a0,-758 # ffffffffc0204f10 <etext+0x94>
...
ffffffffc020021e:	d1650513          	addi	a0,a0,-746 # ffffffffc0204f30 <etext+0xb4>
...
ffffffffc020024a:	d0a50513          	addi	a0,a0,-758 # ffffffffc0204f50 <etext+0xd4>
}
...
ffffffffc0200258:	d2c60613          	addi	a2,a2,-724 # ffffffffc0204f80 <etext+0x104>
ffffffffc020025c:	04d00593          	li	a1,77
ffffffffc0200260:	00005517          	auipc	a0,0x5
ffffffffc0200264:	d3850513          	addi	a0,a0,-712 # ffffffffc0204f98 <etext+0x11c>
void print_stackframe(void) {
...
ffffffffc0200274:	d4060613          	addi	a2,a2,-704 # ffffffffc0204fb0 <etext+0x134>
ffffffffc0200278:	00005597          	auipc	a1,0x5
ffffffffc020027c:	d5858593          	addi	a1,a1,-680 # ffffffffc0204fd0 <etext+0x154>
ffffffffc0200280:	00005517          	auipc	a0,0x5
ffffffffc0200284:	d5850513          	addi	a0,a0,-680 # ffffffffc0204fd8 <etext+0x15c>
mon_help(int argc, char **argv, struct trapframe *tf) {
...
ffffffffc0200292:	d5a60613          	addi	a2,a2,-678 # ffffffffc0204fe8 <etext+0x16c>
ffffffffc0200296:	00005597          	auipc	a1,0x5
ffffffffc020029a:	d7a58593          	addi	a1,a1,-646 # ffffffffc0205010 <etext+0x194>
ffffffffc020029e:	00005517          	auipc	a0,0x5
ffffffffc02002a2:	d3a50513          	addi	a0,a0,-710 # ffffffffc0204fd8 <etext+0x15c>
ffffffffc02002a6:	edbff0ef          	jal	ffffffffc0200180 <cprintf>
ffffffffc02002aa:	00005617          	auipc	a2,0x5
ffffffffc02002ae:	d7660613          	addi	a2,a2,-650 # ffffffffc0205020 <etext+0x1a4>
ffffffffc02002b2:	00005597          	auipc	a1,0x5
ffffffffc02002b6:	d8e58593          	addi	a1,a1,-626 # ffffffffc0205040 <etext+0x1c4>
ffffffffc02002ba:	00005517          	auipc	a0,0x5
ffffffffc02002be:	d1e50513          	addi	a0,a0,-738 # ffffffffc0204fd8 <etext+0x15c>
...
ffffffffc02002f8:	d5c50513          	addi	a0,a0,-676 # ffffffffc0205050 <etext+0x1d4>
kmonitor(struct trapframe *tf) {
...
ffffffffc020031a:	d6250513          	addi	a0,a0,-670 # ffffffffc0205078 <etext+0x1fc>
...
ffffffffc020033c:	9b0c0c13          	addi	s8,s8,-1616 # ffffffffc0206ce8 <commands>
        if ((buf = readline("K> ")) != NULL) {
ffffffffc0200340:	00005917          	auipc	s2,0x5
ffffffffc0200344:	d6090913          	addi	s2,s2,-672 # ffffffffc02050a0 <etext+0x224>
        while (*buf != '\0' && strchr(WHITESPACE, *buf) != NULL) {
ffffffffc0200348:	00005497          	auipc	s1,0x5
ffffffffc020034c:	d6048493          	addi	s1,s1,-672 # ffffffffc02050a8 <etext+0x22c>
        if (argc == MAXARGS - 1) {
ffffffffc0200350:	49bd                	li	s3,15
            cprintf("Too many arguments (max %d).\n", MAXARGS);
ffffffffc0200352:	00005a97          	auipc	s5,0x5
ffffffffc0200356:	d5ea8a93          	addi	s5,s5,-674 # ffffffffc02050b0 <etext+0x234>
    for (i = 0; i < NCOMMANDS; i ++) {
ffffffffc020035a:	4a0d                	li	s4,3
    cprintf("Unknown command '%s'\n", argv[0]);
ffffffffc020035c:	00005b97          	auipc	s7,0x5
ffffffffc0200360:	d74b8b93          	addi	s7,s7,-652 # ffffffffc02050d0 <etext+0x254>
        if ((buf = readline("K> ")) != NULL) {
...
ffffffffc020037e:	96ed0d13          	addi	s10,s10,-1682 # ffffffffc0206ce8 <commands>
    for (i = 0; i < NCOMMANDS; i ++) {
ffffffffc0200382:	4401                	li	s0,0
        if (strcmp(commands[i].name, argv[0]) == 0) {
ffffffffc0200384:	6582                	ld	a1,0(sp)
ffffffffc0200386:	000d3503          	ld	a0,0(s10)
ffffffffc020038a:	257040ef          	jal	ffffffffc0204de0 <strcmp>
...
ffffffffc02003a4:	275040ef          	jal	ffffffffc0204e18 <strchr>
...
ffffffffc02003e4:	235040ef          	jal	ffffffffc0204e18 <strchr>
...
ffffffffc0200464:	c8850513          	addi	a0,a0,-888 # ffffffffc02050e8 <etext+0x26c>
    va_start(ap, fmt);
...
ffffffffc020047a:	c9250513          	addi	a0,a0,-878 # ffffffffc0205108 <etext+0x28c>
...
ffffffffc02004ba:	c5a50513          	addi	a0,a0,-934 # ffffffffc0205110 <etext+0x294>
    ticks = 0;
...
ffffffffc0200578:	e406                	sd	ra,8(sp)
    memcpy(dst, &ide[iobase], nsecs * SECTSIZE);
ffffffffc020057a:	0c7040ef          	jal	ffffffffc0204e40 <memcpy>
    return 0;
}
...
ffffffffc020059c:	e406                	sd	ra,8(sp)
    memcpy(&ide[iobase], src, nsecs * SECTSIZE);
ffffffffc020059e:	0a3040ef          	jal	ffffffffc0204e40 <memcpy>
    return 0;
}
...
ffffffffc02005ec:	b4850513          	addi	a0,a0,-1208 # ffffffffc0205130 <etext+0x2b4>
...
ffffffffc0200614:	b4060613          	addi	a2,a2,-1216 # ffffffffc0205150 <etext+0x2d4>
ffffffffc0200618:	06200593          	li	a1,98
ffffffffc020061c:	00005517          	auipc	a0,0x5
ffffffffc0200620:	b4c50513          	addi	a0,a0,-1204 # ffffffffc0205168 <etext+0x2ec>
...
ffffffffc020064e:	b3650513          	addi	a0,a0,-1226 # ffffffffc0205180 <etext+0x304>
void print_regs(struct pushregs *gpr) {
...
ffffffffc020065e:	b3e50513          	addi	a0,a0,-1218 # ffffffffc0205198 <etext+0x31c>
...
ffffffffc020066c:	b4850513          	addi	a0,a0,-1208 # ffffffffc02051b0 <etext+0x334>
...
ffffffffc020067a:	b5250513          	addi	a0,a0,-1198 # ffffffffc02051c8 <etext+0x34c>
...
ffffffffc0200688:	b5c50513          	addi	a0,a0,-1188 # ffffffffc02051e0 <etext+0x364>
...
ffffffffc0200696:	b6650513          	addi	a0,a0,-1178 # ffffffffc02051f8 <etext+0x37c>
...
ffffffffc02006a4:	b7050513          	addi	a0,a0,-1168 # ffffffffc0205210 <etext+0x394>
...
ffffffffc02006b2:	b7a50513          	addi	a0,a0,-1158 # ffffffffc0205228 <etext+0x3ac>
...
ffffffffc02006c0:	b8450513          	addi	a0,a0,-1148 # ffffffffc0205240 <etext+0x3c4>
...
ffffffffc02006ce:	b8e50513          	addi	a0,a0,-1138 # ffffffffc0205258 <etext+0x3dc>
...
ffffffffc02006dc:	b9850513          	addi	a0,a0,-1128 # ffffffffc0205270 <etext+0x3f4>
...
ffffffffc02006ea:	ba250513          	addi	a0,a0,-1118 # ffffffffc0205288 <etext+0x40c>
...
ffffffffc02006f8:	bac50513          	addi	a0,a0,-1108 # ffffffffc02052a0 <etext+0x424>
...
ffffffffc0200706:	bb650513          	addi	a0,a0,-1098 # ffffffffc02052b8 <etext+0x43c>
...
ffffffffc0200714:	bc050513          	addi	a0,a0,-1088 # ffffffffc02052d0 <etext+0x454>
...
ffffffffc0200722:	bca50513          	addi	a0,a0,-1078 # ffffffffc02052e8 <etext+0x46c>
...
ffffffffc0200730:	bd450513          	addi	a0,a0,-1068 # ffffffffc0205300 <etext+0x484>
...
ffffffffc020073e:	bde50513          	addi	a0,a0,-1058 # ffffffffc0205318 <etext+0x49c>
...
ffffffffc020074c:	be850513          	addi	a0,a0,-1048 # ffffffffc0205330 <etext+0x4b4>
...
ffffffffc020075a:	bf250513          	addi	a0,a0,-1038 # ffffffffc0205348 <etext+0x4cc>
...
ffffffffc0200768:	bfc50513          	addi	a0,a0,-1028 # ffffffffc0205360 <etext+0x4e4>
...
ffffffffc0200776:	c0650513          	addi	a0,a0,-1018 # ffffffffc0205378 <etext+0x4fc>
...
ffffffffc0200784:	c1050513          	addi	a0,a0,-1008 # ffffffffc0205390 <etext+0x514>
...
ffffffffc0200792:	c1a50513          	addi	a0,a0,-998 # ffffffffc02053a8 <etext+0x52c>
...
ffffffffc02007a0:	c2450513          	addi	a0,a0,-988 # ffffffffc02053c0 <etext+0x544>
...
ffffffffc02007ae:	c2e50513          	addi	a0,a0,-978 # ffffffffc02053d8 <etext+0x55c>
...
ffffffffc02007bc:	c3850513          	addi	a0,a0,-968 # ffffffffc02053f0 <etext+0x574>
...
ffffffffc02007ca:	c4250513          	addi	a0,a0,-958 # ffffffffc0205408 <etext+0x58c>
...
ffffffffc02007d8:	c4c50513          	addi	a0,a0,-948 # ffffffffc0205420 <etext+0x5a4>
...
ffffffffc02007e6:	c5650513          	addi	a0,a0,-938 # ffffffffc0205438 <etext+0x5bc>
...
ffffffffc02007f4:	c6050513          	addi	a0,a0,-928 # ffffffffc0205450 <etext+0x5d4>
...
ffffffffc0200806:	c6650513          	addi	a0,a0,-922 # ffffffffc0205468 <etext+0x5ec>
}
...
ffffffffc020081c:	c6850513          	addi	a0,a0,-920 # ffffffffc0205480 <etext+0x604>
void print_trapframe(struct trapframe *tf) {
...
ffffffffc0200834:	c6850513          	addi	a0,a0,-920 # ffffffffc0205498 <etext+0x61c>
...
ffffffffc0200844:	c7050513          	addi	a0,a0,-912 # ffffffffc02054b0 <etext+0x634>
...
ffffffffc0200854:	c7850513          	addi	a0,a0,-904 # ffffffffc02054c8 <etext+0x64c>
...
ffffffffc0200868:	c7c50513          	addi	a0,a0,-900 # ffffffffc02054e0 <etext+0x664>
}
...
ffffffffc0200884:	4b070713          	addi	a4,a4,1200 # ffffffffc0206d30 <commands+0x48>
...
ffffffffc02008ec:	ca050513          	addi	a0,a0,-864 # ffffffffc0205588 <etext+0x70c>
...
ffffffffc0200900:	c7c50513          	addi	a0,a0,-900 # ffffffffc0205578 <etext+0x6fc>
}
...
ffffffffc0200920:	44470713          	addi	a4,a4,1092 # ffffffffc0206d60 <commands+0x78>
...
ffffffffc0200932:	e1a50513          	addi	a0,a0,-486 # ffffffffc0205748 <etext+0x8cc>
...
ffffffffc0200956:	c5650513          	addi	a0,a0,-938 # ffffffffc02055a8 <etext+0x72c>
}
...
ffffffffc0200a5e:	bee60613          	addi	a2,a2,-1042 # ffffffffc0205648 <etext+0x7cc>
ffffffffc0200a62:	0d300593          	li	a1,211
ffffffffc0200a66:	00004517          	auipc	a0,0x4
ffffffffc0200a6a:	70250513          	addi	a0,a0,1794 # ffffffffc0205168 <etext+0x2ec>
...
ffffffffc0200a88:	bc460613          	addi	a2,a2,-1084 # ffffffffc0205648 <etext+0x7cc>
ffffffffc0200a8c:	0da00593          	li	a1,218
ffffffffc0200a90:	00004517          	auipc	a0,0x4
ffffffffc0200a94:	6d850513          	addi	a0,a0,1752 # ffffffffc0205168 <etext+0x2ec>
...
ffffffffc0200c1e:	34e63603          	ld	a2,846(a2) # ffffffffc0206f68 <nbase>
...
ffffffffc0200e64:	90068693          	addi	a3,a3,-1792 # ffffffffc0205760 <etext+0x8e4>
ffffffffc0200e68:	00005617          	auipc	a2,0x5
ffffffffc0200e6c:	90860613          	addi	a2,a2,-1784 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0200e70:	0f000593          	li	a1,240
ffffffffc0200e74:	00005517          	auipc	a0,0x5
ffffffffc0200e78:	91450513          	addi	a0,a0,-1772 # ffffffffc0205788 <etext+0x90c>
ffffffffc0200e7c:	db6ff0ef          	jal	ffffffffc0200432 <__panic>
    assert(p0 != p1 && p0 != p2 && p1 != p2);
ffffffffc0200e80:	00005697          	auipc	a3,0x5
ffffffffc0200e84:	9a068693          	addi	a3,a3,-1632 # ffffffffc0205820 <etext+0x9a4>
ffffffffc0200e88:	00005617          	auipc	a2,0x5
ffffffffc0200e8c:	8e860613          	addi	a2,a2,-1816 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0200e90:	0bd00593          	li	a1,189
ffffffffc0200e94:	00005517          	auipc	a0,0x5
ffffffffc0200e98:	8f450513          	addi	a0,a0,-1804 # ffffffffc0205788 <etext+0x90c>
ffffffffc0200e9c:	d96ff0ef          	jal	ffffffffc0200432 <__panic>
    assert(page_ref(p0) == 0 && page_ref(p1) == 0 && page_ref(p2) == 0);
ffffffffc0200ea0:	00005697          	auipc	a3,0x5
ffffffffc0200ea4:	9a868693          	addi	a3,a3,-1624 # ffffffffc0205848 <etext+0x9cc>
ffffffffc0200ea8:	00005617          	auipc	a2,0x5
ffffffffc0200eac:	8c860613          	addi	a2,a2,-1848 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0200eb0:	0be00593          	li	a1,190
ffffffffc0200eb4:	00005517          	auipc	a0,0x5
ffffffffc0200eb8:	8d450513          	addi	a0,a0,-1836 # ffffffffc0205788 <etext+0x90c>
ffffffffc0200ebc:	d76ff0ef          	jal	ffffffffc0200432 <__panic>
    assert(page2pa(p0) < npage * PGSIZE);
ffffffffc0200ec0:	00005697          	auipc	a3,0x5
ffffffffc0200ec4:	9c868693          	addi	a3,a3,-1592 # ffffffffc0205888 <etext+0xa0c>
ffffffffc0200ec8:	00005617          	auipc	a2,0x5
ffffffffc0200ecc:	8a860613          	addi	a2,a2,-1880 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0200ed0:	0c000593          	li	a1,192
ffffffffc0200ed4:	00005517          	auipc	a0,0x5
ffffffffc0200ed8:	8b450513          	addi	a0,a0,-1868 # ffffffffc0205788 <etext+0x90c>
ffffffffc0200edc:	d56ff0ef          	jal	ffffffffc0200432 <__panic>
    assert(!list_empty(&free_list));
ffffffffc0200ee0:	00005697          	auipc	a3,0x5
ffffffffc0200ee4:	a3068693          	addi	a3,a3,-1488 # ffffffffc0205910 <etext+0xa94>
ffffffffc0200ee8:	00005617          	auipc	a2,0x5
ffffffffc0200eec:	88860613          	addi	a2,a2,-1912 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0200ef0:	0d900593          	li	a1,217
ffffffffc0200ef4:	00005517          	auipc	a0,0x5
ffffffffc0200ef8:	89450513          	addi	a0,a0,-1900 # ffffffffc0205788 <etext+0x90c>
ffffffffc0200efc:	d36ff0ef          	jal	ffffffffc0200432 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0200f00:	00005697          	auipc	a3,0x5
ffffffffc0200f04:	8c068693          	addi	a3,a3,-1856 # ffffffffc02057c0 <etext+0x944>
ffffffffc0200f08:	00005617          	auipc	a2,0x5
ffffffffc0200f0c:	86860613          	addi	a2,a2,-1944 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0200f10:	0d200593          	li	a1,210
ffffffffc0200f14:	00005517          	auipc	a0,0x5
ffffffffc0200f18:	87450513          	addi	a0,a0,-1932 # ffffffffc0205788 <etext+0x90c>
ffffffffc0200f1c:	d16ff0ef          	jal	ffffffffc0200432 <__panic>
    assert(nr_free == 3);
ffffffffc0200f20:	00005697          	auipc	a3,0x5
ffffffffc0200f24:	9e068693          	addi	a3,a3,-1568 # ffffffffc0205900 <etext+0xa84>
ffffffffc0200f28:	00005617          	auipc	a2,0x5
ffffffffc0200f2c:	84860613          	addi	a2,a2,-1976 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0200f30:	0d000593          	li	a1,208
ffffffffc0200f34:	00005517          	auipc	a0,0x5
ffffffffc0200f38:	85450513          	addi	a0,a0,-1964 # ffffffffc0205788 <etext+0x90c>
ffffffffc0200f3c:	cf6ff0ef          	jal	ffffffffc0200432 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200f40:	00005697          	auipc	a3,0x5
ffffffffc0200f44:	9a868693          	addi	a3,a3,-1624 # ffffffffc02058e8 <etext+0xa6c>
ffffffffc0200f48:	00005617          	auipc	a2,0x5
ffffffffc0200f4c:	82860613          	addi	a2,a2,-2008 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0200f50:	0cb00593          	li	a1,203
ffffffffc0200f54:	00005517          	auipc	a0,0x5
ffffffffc0200f58:	83450513          	addi	a0,a0,-1996 # ffffffffc0205788 <etext+0x90c>
ffffffffc0200f5c:	cd6ff0ef          	jal	ffffffffc0200432 <__panic>
    assert(page2pa(p2) < npage * PGSIZE);
ffffffffc0200f60:	00005697          	auipc	a3,0x5
ffffffffc0200f64:	96868693          	addi	a3,a3,-1688 # ffffffffc02058c8 <etext+0xa4c>
ffffffffc0200f68:	00005617          	auipc	a2,0x5
ffffffffc0200f6c:	80860613          	addi	a2,a2,-2040 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0200f70:	0c200593          	li	a1,194
ffffffffc0200f74:	00005517          	auipc	a0,0x5
ffffffffc0200f78:	81450513          	addi	a0,a0,-2028 # ffffffffc0205788 <etext+0x90c>
ffffffffc0200f7c:	cb6ff0ef          	jal	ffffffffc0200432 <__panic>
    assert(p0 != NULL);
ffffffffc0200f80:	00005697          	auipc	a3,0x5
ffffffffc0200f84:	9d868693          	addi	a3,a3,-1576 # ffffffffc0205958 <etext+0xadc>
ffffffffc0200f88:	00004617          	auipc	a2,0x4
ffffffffc0200f8c:	7e860613          	addi	a2,a2,2024 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0200f90:	0f800593          	li	a1,248
ffffffffc0200f94:	00004517          	auipc	a0,0x4
ffffffffc0200f98:	7f450513          	addi	a0,a0,2036 # ffffffffc0205788 <etext+0x90c>
ffffffffc0200f9c:	c96ff0ef          	jal	ffffffffc0200432 <__panic>
    assert(nr_free == 0);
ffffffffc0200fa0:	00005697          	auipc	a3,0x5
ffffffffc0200fa4:	9a868693          	addi	a3,a3,-1624 # ffffffffc0205948 <etext+0xacc>
ffffffffc0200fa8:	00004617          	auipc	a2,0x4
ffffffffc0200fac:	7c860613          	addi	a2,a2,1992 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0200fb0:	0df00593          	li	a1,223
ffffffffc0200fb4:	00004517          	auipc	a0,0x4
ffffffffc0200fb8:	7d450513          	addi	a0,a0,2004 # ffffffffc0205788 <etext+0x90c>
ffffffffc0200fbc:	c76ff0ef          	jal	ffffffffc0200432 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0200fc0:	00005697          	auipc	a3,0x5
ffffffffc0200fc4:	92868693          	addi	a3,a3,-1752 # ffffffffc02058e8 <etext+0xa6c>
ffffffffc0200fc8:	00004617          	auipc	a2,0x4
ffffffffc0200fcc:	7a860613          	addi	a2,a2,1960 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0200fd0:	0dd00593          	li	a1,221
ffffffffc0200fd4:	00004517          	auipc	a0,0x4
ffffffffc0200fd8:	7b450513          	addi	a0,a0,1972 # ffffffffc0205788 <etext+0x90c>
ffffffffc0200fdc:	c56ff0ef          	jal	ffffffffc0200432 <__panic>
    assert((p = alloc_page()) == p0);
ffffffffc0200fe0:	00005697          	auipc	a3,0x5
ffffffffc0200fe4:	94868693          	addi	a3,a3,-1720 # ffffffffc0205928 <etext+0xaac>
ffffffffc0200fe8:	00004617          	auipc	a2,0x4
ffffffffc0200fec:	78860613          	addi	a2,a2,1928 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0200ff0:	0dc00593          	li	a1,220
ffffffffc0200ff4:	00004517          	auipc	a0,0x4
ffffffffc0200ff8:	79450513          	addi	a0,a0,1940 # ffffffffc0205788 <etext+0x90c>
ffffffffc0200ffc:	c36ff0ef          	jal	ffffffffc0200432 <__panic>
    assert((p0 = alloc_page()) != NULL);
ffffffffc0201000:	00004697          	auipc	a3,0x4
ffffffffc0201004:	7c068693          	addi	a3,a3,1984 # ffffffffc02057c0 <etext+0x944>
ffffffffc0201008:	00004617          	auipc	a2,0x4
ffffffffc020100c:	76860613          	addi	a2,a2,1896 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0201010:	0b900593          	li	a1,185
ffffffffc0201014:	00004517          	auipc	a0,0x4
ffffffffc0201018:	77450513          	addi	a0,a0,1908 # ffffffffc0205788 <etext+0x90c>
ffffffffc020101c:	c16ff0ef          	jal	ffffffffc0200432 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201020:	00005697          	auipc	a3,0x5
ffffffffc0201024:	8c868693          	addi	a3,a3,-1848 # ffffffffc02058e8 <etext+0xa6c>
ffffffffc0201028:	00004617          	auipc	a2,0x4
ffffffffc020102c:	74860613          	addi	a2,a2,1864 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0201030:	0d600593          	li	a1,214
ffffffffc0201034:	00004517          	auipc	a0,0x4
ffffffffc0201038:	75450513          	addi	a0,a0,1876 # ffffffffc0205788 <etext+0x90c>
ffffffffc020103c:	bf6ff0ef          	jal	ffffffffc0200432 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0201040:	00004697          	auipc	a3,0x4
ffffffffc0201044:	7c068693          	addi	a3,a3,1984 # ffffffffc0205800 <etext+0x984>
ffffffffc0201048:	00004617          	auipc	a2,0x4
ffffffffc020104c:	72860613          	addi	a2,a2,1832 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0201050:	0d400593          	li	a1,212
ffffffffc0201054:	00004517          	auipc	a0,0x4
ffffffffc0201058:	73450513          	addi	a0,a0,1844 # ffffffffc0205788 <etext+0x90c>
ffffffffc020105c:	bd6ff0ef          	jal	ffffffffc0200432 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc0201060:	00004697          	auipc	a3,0x4
ffffffffc0201064:	78068693          	addi	a3,a3,1920 # ffffffffc02057e0 <etext+0x964>
ffffffffc0201068:	00004617          	auipc	a2,0x4
ffffffffc020106c:	70860613          	addi	a2,a2,1800 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0201070:	0d300593          	li	a1,211
ffffffffc0201074:	00004517          	auipc	a0,0x4
ffffffffc0201078:	71450513          	addi	a0,a0,1812 # ffffffffc0205788 <etext+0x90c>
ffffffffc020107c:	bb6ff0ef          	jal	ffffffffc0200432 <__panic>
    assert((p2 = alloc_page()) != NULL);
ffffffffc0201080:	00004697          	auipc	a3,0x4
ffffffffc0201084:	78068693          	addi	a3,a3,1920 # ffffffffc0205800 <etext+0x984>
ffffffffc0201088:	00004617          	auipc	a2,0x4
ffffffffc020108c:	6e860613          	addi	a2,a2,1768 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0201090:	0bb00593          	li	a1,187
ffffffffc0201094:	00004517          	auipc	a0,0x4
ffffffffc0201098:	6f450513          	addi	a0,a0,1780 # ffffffffc0205788 <etext+0x90c>
ffffffffc020109c:	b96ff0ef          	jal	ffffffffc0200432 <__panic>
    assert(count == 0);
ffffffffc02010a0:	00005697          	auipc	a3,0x5
ffffffffc02010a4:	a0868693          	addi	a3,a3,-1528 # ffffffffc0205aa8 <etext+0xc2c>
ffffffffc02010a8:	00004617          	auipc	a2,0x4
ffffffffc02010ac:	6c860613          	addi	a2,a2,1736 # ffffffffc0205770 <etext+0x8f4>
ffffffffc02010b0:	12500593          	li	a1,293
ffffffffc02010b4:	00004517          	auipc	a0,0x4
ffffffffc02010b8:	6d450513          	addi	a0,a0,1748 # ffffffffc0205788 <etext+0x90c>
ffffffffc02010bc:	b76ff0ef          	jal	ffffffffc0200432 <__panic>
    assert(nr_free == 0);
ffffffffc02010c0:	00005697          	auipc	a3,0x5
ffffffffc02010c4:	88868693          	addi	a3,a3,-1912 # ffffffffc0205948 <etext+0xacc>
ffffffffc02010c8:	00004617          	auipc	a2,0x4
ffffffffc02010cc:	6a860613          	addi	a2,a2,1704 # ffffffffc0205770 <etext+0x8f4>
ffffffffc02010d0:	11a00593          	li	a1,282
ffffffffc02010d4:	00004517          	auipc	a0,0x4
ffffffffc02010d8:	6b450513          	addi	a0,a0,1716 # ffffffffc0205788 <etext+0x90c>
ffffffffc02010dc:	b56ff0ef          	jal	ffffffffc0200432 <__panic>
    assert(alloc_page() == NULL);
ffffffffc02010e0:	00005697          	auipc	a3,0x5
ffffffffc02010e4:	80868693          	addi	a3,a3,-2040 # ffffffffc02058e8 <etext+0xa6c>
ffffffffc02010e8:	00004617          	auipc	a2,0x4
ffffffffc02010ec:	68860613          	addi	a2,a2,1672 # ffffffffc0205770 <etext+0x8f4>
ffffffffc02010f0:	11800593          	li	a1,280
ffffffffc02010f4:	00004517          	auipc	a0,0x4
ffffffffc02010f8:	69450513          	addi	a0,a0,1684 # ffffffffc0205788 <etext+0x90c>
ffffffffc02010fc:	b36ff0ef          	jal	ffffffffc0200432 <__panic>
    assert(page2pa(p1) < npage * PGSIZE);
ffffffffc0201100:	00004697          	auipc	a3,0x4
ffffffffc0201104:	7a868693          	addi	a3,a3,1960 # ffffffffc02058a8 <etext+0xa2c>
ffffffffc0201108:	00004617          	auipc	a2,0x4
ffffffffc020110c:	66860613          	addi	a2,a2,1640 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0201110:	0c100593          	li	a1,193
ffffffffc0201114:	00004517          	auipc	a0,0x4
ffffffffc0201118:	67450513          	addi	a0,a0,1652 # ffffffffc0205788 <etext+0x90c>
ffffffffc020111c:	b16ff0ef          	jal	ffffffffc0200432 <__panic>
    assert((p0 = alloc_pages(2)) == p2 + 1);
ffffffffc0201120:	00005697          	auipc	a3,0x5
ffffffffc0201124:	94868693          	addi	a3,a3,-1720 # ffffffffc0205a68 <etext+0xbec>
ffffffffc0201128:	00004617          	auipc	a2,0x4
ffffffffc020112c:	64860613          	addi	a2,a2,1608 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0201130:	11200593          	li	a1,274
ffffffffc0201134:	00004517          	auipc	a0,0x4
ffffffffc0201138:	65450513          	addi	a0,a0,1620 # ffffffffc0205788 <etext+0x90c>
ffffffffc020113c:	af6ff0ef          	jal	ffffffffc0200432 <__panic>
    assert((p0 = alloc_page()) == p2 - 1);
ffffffffc0201140:	00005697          	auipc	a3,0x5
ffffffffc0201144:	90868693          	addi	a3,a3,-1784 # ffffffffc0205a48 <etext+0xbcc>
ffffffffc0201148:	00004617          	auipc	a2,0x4
ffffffffc020114c:	62860613          	addi	a2,a2,1576 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0201150:	11000593          	li	a1,272
ffffffffc0201154:	00004517          	auipc	a0,0x4
ffffffffc0201158:	63450513          	addi	a0,a0,1588 # ffffffffc0205788 <etext+0x90c>
ffffffffc020115c:	ad6ff0ef          	jal	ffffffffc0200432 <__panic>
    assert(PageProperty(p1) && p1->property == 3);
ffffffffc0201160:	00005697          	auipc	a3,0x5
ffffffffc0201164:	8c068693          	addi	a3,a3,-1856 # ffffffffc0205a20 <etext+0xba4>
ffffffffc0201168:	00004617          	auipc	a2,0x4
ffffffffc020116c:	60860613          	addi	a2,a2,1544 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0201170:	10e00593          	li	a1,270
ffffffffc0201174:	00004517          	auipc	a0,0x4
ffffffffc0201178:	61450513          	addi	a0,a0,1556 # ffffffffc0205788 <etext+0x90c>
ffffffffc020117c:	ab6ff0ef          	jal	ffffffffc0200432 <__panic>
    assert(PageProperty(p0) && p0->property == 1);
ffffffffc0201180:	00005697          	auipc	a3,0x5
ffffffffc0201184:	87868693          	addi	a3,a3,-1928 # ffffffffc02059f8 <etext+0xb7c>
ffffffffc0201188:	00004617          	auipc	a2,0x4
ffffffffc020118c:	5e860613          	addi	a2,a2,1512 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0201190:	10d00593          	li	a1,269
ffffffffc0201194:	00004517          	auipc	a0,0x4
ffffffffc0201198:	5f450513          	addi	a0,a0,1524 # ffffffffc0205788 <etext+0x90c>
ffffffffc020119c:	a96ff0ef          	jal	ffffffffc0200432 <__panic>
    assert(p0 + 2 == p1);
ffffffffc02011a0:	00005697          	auipc	a3,0x5
ffffffffc02011a4:	84868693          	addi	a3,a3,-1976 # ffffffffc02059e8 <etext+0xb6c>
ffffffffc02011a8:	00004617          	auipc	a2,0x4
ffffffffc02011ac:	5c860613          	addi	a2,a2,1480 # ffffffffc0205770 <etext+0x8f4>
ffffffffc02011b0:	10800593          	li	a1,264
ffffffffc02011b4:	00004517          	auipc	a0,0x4
ffffffffc02011b8:	5d450513          	addi	a0,a0,1492 # ffffffffc0205788 <etext+0x90c>
ffffffffc02011bc:	a76ff0ef          	jal	ffffffffc0200432 <__panic>
    assert(alloc_page() == NULL);
ffffffffc02011c0:	00004697          	auipc	a3,0x4
ffffffffc02011c4:	72868693          	addi	a3,a3,1832 # ffffffffc02058e8 <etext+0xa6c>
ffffffffc02011c8:	00004617          	auipc	a2,0x4
ffffffffc02011cc:	5a860613          	addi	a2,a2,1448 # ffffffffc0205770 <etext+0x8f4>
ffffffffc02011d0:	10700593          	li	a1,263
ffffffffc02011d4:	00004517          	auipc	a0,0x4
ffffffffc02011d8:	5b450513          	addi	a0,a0,1460 # ffffffffc0205788 <etext+0x90c>
ffffffffc02011dc:	a56ff0ef          	jal	ffffffffc0200432 <__panic>
    assert((p1 = alloc_pages(3)) != NULL);
ffffffffc02011e0:	00004697          	auipc	a3,0x4
ffffffffc02011e4:	7e868693          	addi	a3,a3,2024 # ffffffffc02059c8 <etext+0xb4c>
ffffffffc02011e8:	00004617          	auipc	a2,0x4
ffffffffc02011ec:	58860613          	addi	a2,a2,1416 # ffffffffc0205770 <etext+0x8f4>
ffffffffc02011f0:	10600593          	li	a1,262
ffffffffc02011f4:	00004517          	auipc	a0,0x4
ffffffffc02011f8:	59450513          	addi	a0,a0,1428 # ffffffffc0205788 <etext+0x90c>
ffffffffc02011fc:	a36ff0ef          	jal	ffffffffc0200432 <__panic>
    assert(PageProperty(p0 + 2) && p0[2].property == 3);
ffffffffc0201200:	00004697          	auipc	a3,0x4
ffffffffc0201204:	79868693          	addi	a3,a3,1944 # ffffffffc0205998 <etext+0xb1c>
ffffffffc0201208:	00004617          	auipc	a2,0x4
ffffffffc020120c:	56860613          	addi	a2,a2,1384 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0201210:	10500593          	li	a1,261
ffffffffc0201214:	00004517          	auipc	a0,0x4
ffffffffc0201218:	57450513          	addi	a0,a0,1396 # ffffffffc0205788 <etext+0x90c>
ffffffffc020121c:	a16ff0ef          	jal	ffffffffc0200432 <__panic>
    assert(alloc_pages(4) == NULL);
ffffffffc0201220:	00004697          	auipc	a3,0x4
ffffffffc0201224:	76068693          	addi	a3,a3,1888 # ffffffffc0205980 <etext+0xb04>
ffffffffc0201228:	00004617          	auipc	a2,0x4
ffffffffc020122c:	54860613          	addi	a2,a2,1352 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0201230:	10400593          	li	a1,260
ffffffffc0201234:	00004517          	auipc	a0,0x4
ffffffffc0201238:	55450513          	addi	a0,a0,1364 # ffffffffc0205788 <etext+0x90c>
ffffffffc020123c:	9f6ff0ef          	jal	ffffffffc0200432 <__panic>
    assert(alloc_page() == NULL);
ffffffffc0201240:	00004697          	auipc	a3,0x4
ffffffffc0201244:	6a868693          	addi	a3,a3,1704 # ffffffffc02058e8 <etext+0xa6c>
ffffffffc0201248:	00004617          	auipc	a2,0x4
ffffffffc020124c:	52860613          	addi	a2,a2,1320 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0201250:	0fe00593          	li	a1,254
ffffffffc0201254:	00004517          	auipc	a0,0x4
ffffffffc0201258:	53450513          	addi	a0,a0,1332 # ffffffffc0205788 <etext+0x90c>
ffffffffc020125c:	9d6ff0ef          	jal	ffffffffc0200432 <__panic>
    assert(!PageProperty(p0));
ffffffffc0201260:	00004697          	auipc	a3,0x4
ffffffffc0201264:	70868693          	addi	a3,a3,1800 # ffffffffc0205968 <etext+0xaec>
ffffffffc0201268:	00004617          	auipc	a2,0x4
ffffffffc020126c:	50860613          	addi	a2,a2,1288 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0201270:	0f900593          	li	a1,249
ffffffffc0201274:	00004517          	auipc	a0,0x4
ffffffffc0201278:	51450513          	addi	a0,a0,1300 # ffffffffc0205788 <etext+0x90c>
ffffffffc020127c:	9b6ff0ef          	jal	ffffffffc0200432 <__panic>
    assert((p0 = alloc_pages(5)) != NULL);
ffffffffc0201280:	00005697          	auipc	a3,0x5
ffffffffc0201284:	80868693          	addi	a3,a3,-2040 # ffffffffc0205a88 <etext+0xc0c>
ffffffffc0201288:	00004617          	auipc	a2,0x4
ffffffffc020128c:	4e860613          	addi	a2,a2,1256 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0201290:	11700593          	li	a1,279
ffffffffc0201294:	00004517          	auipc	a0,0x4
ffffffffc0201298:	4f450513          	addi	a0,a0,1268 # ffffffffc0205788 <etext+0x90c>
ffffffffc020129c:	996ff0ef          	jal	ffffffffc0200432 <__panic>
    assert(total == 0);
ffffffffc02012a0:	00005697          	auipc	a3,0x5
ffffffffc02012a4:	81868693          	addi	a3,a3,-2024 # ffffffffc0205ab8 <etext+0xc3c>
ffffffffc02012a8:	00004617          	auipc	a2,0x4
ffffffffc02012ac:	4c860613          	addi	a2,a2,1224 # ffffffffc0205770 <etext+0x8f4>
ffffffffc02012b0:	12600593          	li	a1,294
ffffffffc02012b4:	00004517          	auipc	a0,0x4
ffffffffc02012b8:	4d450513          	addi	a0,a0,1236 # ffffffffc0205788 <etext+0x90c>
ffffffffc02012bc:	976ff0ef          	jal	ffffffffc0200432 <__panic>
    assert(total == nr_free_pages());
ffffffffc02012c0:	00004697          	auipc	a3,0x4
ffffffffc02012c4:	4e068693          	addi	a3,a3,1248 # ffffffffc02057a0 <etext+0x924>
ffffffffc02012c8:	00004617          	auipc	a2,0x4
ffffffffc02012cc:	4a860613          	addi	a2,a2,1192 # ffffffffc0205770 <etext+0x8f4>
ffffffffc02012d0:	0f300593          	li	a1,243
ffffffffc02012d4:	00004517          	auipc	a0,0x4
ffffffffc02012d8:	4b450513          	addi	a0,a0,1204 # ffffffffc0205788 <etext+0x90c>
ffffffffc02012dc:	956ff0ef          	jal	ffffffffc0200432 <__panic>
    assert((p1 = alloc_page()) != NULL);
ffffffffc02012e0:	00004697          	auipc	a3,0x4
ffffffffc02012e4:	50068693          	addi	a3,a3,1280 # ffffffffc02057e0 <etext+0x964>
ffffffffc02012e8:	00004617          	auipc	a2,0x4
ffffffffc02012ec:	48860613          	addi	a2,a2,1160 # ffffffffc0205770 <etext+0x8f4>
ffffffffc02012f0:	0ba00593          	li	a1,186
ffffffffc02012f4:	00004517          	auipc	a0,0x4
ffffffffc02012f8:	49450513          	addi	a0,a0,1172 # ffffffffc0205788 <etext+0x90c>
...
ffffffffc0201430:	6a468693          	addi	a3,a3,1700 # ffffffffc0205ad0 <etext+0xc54>
ffffffffc0201434:	00004617          	auipc	a2,0x4
ffffffffc0201438:	33c60613          	addi	a2,a2,828 # ffffffffc0205770 <etext+0x8f4>
ffffffffc020143c:	08300593          	li	a1,131
ffffffffc0201440:	00004517          	auipc	a0,0x4
ffffffffc0201444:	34850513          	addi	a0,a0,840 # ffffffffc0205788 <etext+0x90c>
ffffffffc0201448:	febfe0ef          	jal	ffffffffc0200432 <__panic>
    assert(n > 0);
ffffffffc020144c:	00004697          	auipc	a3,0x4
ffffffffc0201450:	67c68693          	addi	a3,a3,1660 # ffffffffc0205ac8 <etext+0xc4c>
ffffffffc0201454:	00004617          	auipc	a2,0x4
ffffffffc0201458:	31c60613          	addi	a2,a2,796 # ffffffffc0205770 <etext+0x8f4>
ffffffffc020145c:	08000593          	li	a1,128
ffffffffc0201460:	00004517          	auipc	a0,0x4
ffffffffc0201464:	32850513          	addi	a0,a0,808 # ffffffffc0205788 <etext+0x90c>
...
ffffffffc0201504:	5c868693          	addi	a3,a3,1480 # ffffffffc0205ac8 <etext+0xc4c>
ffffffffc0201508:	00004617          	auipc	a2,0x4
ffffffffc020150c:	26860613          	addi	a2,a2,616 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0201510:	06200593          	li	a1,98
ffffffffc0201514:	00004517          	auipc	a0,0x4
ffffffffc0201518:	27450513          	addi	a0,a0,628 # ffffffffc0205788 <etext+0x90c>
default_alloc_pages(size_t n) {
...
ffffffffc02015d6:	52668693          	addi	a3,a3,1318 # ffffffffc0205af8 <etext+0xc7c>
ffffffffc02015da:	00004617          	auipc	a2,0x4
ffffffffc02015de:	19660613          	addi	a2,a2,406 # ffffffffc0205770 <etext+0x8f4>
ffffffffc02015e2:	04900593          	li	a1,73
ffffffffc02015e6:	00004517          	auipc	a0,0x4
ffffffffc02015ea:	1a250513          	addi	a0,a0,418 # ffffffffc0205788 <etext+0x90c>
ffffffffc02015ee:	e45fe0ef          	jal	ffffffffc0200432 <__panic>
    assert(n > 0);
ffffffffc02015f2:	00004697          	auipc	a3,0x4
ffffffffc02015f6:	4d668693          	addi	a3,a3,1238 # ffffffffc0205ac8 <etext+0xc4c>
ffffffffc02015fa:	00004617          	auipc	a2,0x4
ffffffffc02015fe:	17660613          	addi	a2,a2,374 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0201602:	04600593          	li	a1,70
ffffffffc0201606:	00004517          	auipc	a0,0x4
ffffffffc020160a:	18250513          	addi	a0,a0,386 # ffffffffc0205788 <etext+0x90c>
...
ffffffffc02016ce:	89e7b783          	ld	a5,-1890(a5) # ffffffffc0206f68 <nbase>
...
ffffffffc02016fe:	42660613          	addi	a2,a2,1062 # ffffffffc0205b20 <etext+0xca4>
ffffffffc0201702:	06900593          	li	a1,105
ffffffffc0201706:	00004517          	auipc	a0,0x4
ffffffffc020170a:	44250513          	addi	a0,a0,1090 # ffffffffc0205b48 <etext+0xccc>
...
ffffffffc02017ec:	37068693          	addi	a3,a3,880 # ffffffffc0205b58 <etext+0xcdc>
ffffffffc02017f0:	00004617          	auipc	a2,0x4
ffffffffc02017f4:	f8060613          	addi	a2,a2,-128 # ffffffffc0205770 <etext+0x8f4>
ffffffffc02017f8:	06300593          	li	a1,99
ffffffffc02017fc:	00004517          	auipc	a0,0x4
ffffffffc0201800:	37c50513          	addi	a0,a0,892 # ffffffffc0205b78 <etext+0xcfc>
...
ffffffffc020180e:	38650513          	addi	a0,a0,902 # ffffffffc0205b90 <etext+0xd14>
kmalloc_init(void) {
...
ffffffffc020181e:	38e50513          	addi	a0,a0,910 # ffffffffc0205ba8 <etext+0xd2c>
}
...
ffffffffc020193c:	6307b783          	ld	a5,1584(a5) # ffffffffc0206f68 <nbase>
...
ffffffffc020199a:	25a60613          	addi	a2,a2,602 # ffffffffc0205bf0 <etext+0xd74>
ffffffffc020199e:	06200593          	li	a1,98
ffffffffc02019a2:	00004517          	auipc	a0,0x4
ffffffffc02019a6:	1a650513          	addi	a0,a0,422 # ffffffffc0205b48 <etext+0xccc>
...
ffffffffc02019b4:	21860613          	addi	a2,a2,536 # ffffffffc0205bc8 <etext+0xd4c>
ffffffffc02019b8:	06e00593          	li	a1,110
ffffffffc02019bc:	00004517          	auipc	a0,0x4
ffffffffc02019c0:	18c50513          	addi	a0,a0,396 # ffffffffc0205b48 <etext+0xccc>
...
ffffffffc02019ce:	22660613          	addi	a2,a2,550 # ffffffffc0205bf0 <etext+0xd74>
ffffffffc02019d2:	06200593          	li	a1,98
ffffffffc02019d6:	00004517          	auipc	a0,0x4
ffffffffc02019da:	17250513          	addi	a0,a0,370 # ffffffffc0205b48 <etext+0xccc>
pa2page(uintptr_t pa) {
...
ffffffffc02019ea:	22a60613          	addi	a2,a2,554 # ffffffffc0205c10 <etext+0xd94>
ffffffffc02019ee:	07400593          	li	a1,116
ffffffffc02019f2:	00004517          	auipc	a0,0x4
ffffffffc02019f6:	15650513          	addi	a0,a0,342 # ffffffffc0205b48 <etext+0xccc>
pte2page(pte_t pte) {
...
ffffffffc0201b90:	29e030ef          	jal	ffffffffc0204e2e <memset>
    return page - pages + nbase;
...
ffffffffc0201c26:	208030ef          	jal	ffffffffc0204e2e <memset>
    return page - pages + nbase;
...
ffffffffc0201c80:	ea460613          	addi	a2,a2,-348 # ffffffffc0205b20 <etext+0xca4>
ffffffffc0201c84:	0e400593          	li	a1,228
ffffffffc0201c88:	00004517          	auipc	a0,0x4
ffffffffc0201c8c:	fb050513          	addi	a0,a0,-80 # ffffffffc0205c38 <etext+0xdbc>
...
ffffffffc0201c9a:	e8a60613          	addi	a2,a2,-374 # ffffffffc0205b20 <etext+0xca4>
ffffffffc0201c9e:	0ef00593          	li	a1,239
ffffffffc0201ca2:	00004517          	auipc	a0,0x4
ffffffffc0201ca6:	f9650513          	addi	a0,a0,-106 # ffffffffc0205c38 <etext+0xdbc>
...
ffffffffc0201cb4:	e7060613          	addi	a2,a2,-400 # ffffffffc0205b20 <etext+0xca4>
ffffffffc0201cb8:	0ec00593          	li	a1,236
ffffffffc0201cbc:	00004517          	auipc	a0,0x4
ffffffffc0201cc0:	f7c50513          	addi	a0,a0,-132 # ffffffffc0205c38 <etext+0xdbc>
...
ffffffffc0201cce:	e5660613          	addi	a2,a2,-426 # ffffffffc0205b20 <etext+0xca4>
ffffffffc0201cd2:	0e100593          	li	a1,225
ffffffffc0201cd6:	00004517          	auipc	a0,0x4
ffffffffc0201cda:	f6250513          	addi	a0,a0,-158 # ffffffffc0205c38 <etext+0xdbc>
...
ffffffffc0201eca:	eda78793          	addi	a5,a5,-294 # ffffffffc0206da0 <default_pmm_manager>
...
ffffffffc0201ef2:	d5a50513          	addi	a0,a0,-678 # ffffffffc0205c48 <etext+0xdcc>
    pmm_manager = &default_pmm_manager;
...
ffffffffc0201f26:	d3e50513          	addi	a0,a0,-706 # ffffffffc0205c60 <etext+0xde4>
    va_pa_offset = KERNBASE - 0x80200000;
...
ffffffffc0201f46:	d3650513          	addi	a0,a0,-714 # ffffffffc0205c78 <etext+0xdfc>
...
ffffffffc0201fb2:	cf250513          	addi	a0,a0,-782 # ffffffffc0205ca0 <etext+0xe24>
...
ffffffffc0201fce:	cee50513          	addi	a0,a0,-786 # ffffffffc0205cb8 <etext+0xe3c>
...
ffffffffc020226a:	d3a50513          	addi	a0,a0,-710 # ffffffffc0205fa0 <etext+0x1124>
...
ffffffffc020231c:	dc058593          	addi	a1,a1,-576 # ffffffffc02060d8 <etext+0x125c>
ffffffffc0202320:	10000513          	li	a0,256
ffffffffc0202324:	2ab020ef          	jal	ffffffffc0204dce <strcpy>
...
ffffffffc0202332:	2af020ef          	jal	ffffffffc0204de0 <strcmp>
...
ffffffffc0202362:	10078023          	sb	zero,256(a5) # 80100 <kern_entry-0xffffffffc017ff00>
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202366:	233020ef          	jal	ffffffffc0204d98 <strlen>
...
ffffffffc020242e:	d2650513          	addi	a0,a0,-730 # ffffffffc0206150 <etext+0x12d4>
...
ffffffffc020254a:	aba68693          	addi	a3,a3,-1350 # ffffffffc0206000 <etext+0x1184>
ffffffffc020254e:	00003617          	auipc	a2,0x3
ffffffffc0202552:	22260613          	addi	a2,a2,546 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0202556:	19e00593          	li	a1,414
ffffffffc020255a:	00003517          	auipc	a0,0x3
ffffffffc020255e:	6de50513          	addi	a0,a0,1758 # ffffffffc0205c38 <etext+0xdbc>
ffffffffc0202562:	ed1fd0ef          	jal	ffffffffc0200432 <__panic>
        assert((ptep = get_pte(boot_pgdir, (uintptr_t)KADDR(i), 0)) != NULL);
ffffffffc0202566:	00004697          	auipc	a3,0x4
ffffffffc020256a:	a5a68693          	addi	a3,a3,-1446 # ffffffffc0205fc0 <etext+0x1144>
ffffffffc020256e:	00003617          	auipc	a2,0x3
ffffffffc0202572:	20260613          	addi	a2,a2,514 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0202576:	19d00593          	li	a1,413
ffffffffc020257a:	00003517          	auipc	a0,0x3
ffffffffc020257e:	6be50513          	addi	a0,a0,1726 # ffffffffc0205c38 <etext+0xdbc>
...
ffffffffc020258c:	59860613          	addi	a2,a2,1432 # ffffffffc0205b20 <etext+0xca4>
ffffffffc0202590:	19d00593          	li	a1,413
ffffffffc0202594:	00003517          	auipc	a0,0x3
ffffffffc0202598:	6a450513          	addi	a0,a0,1700 # ffffffffc0205c38 <etext+0xdbc>
...
ffffffffc02025a8:	62460613          	addi	a2,a2,1572 # ffffffffc0205bc8 <etext+0xd4c>
ffffffffc02025ac:	07f00593          	li	a1,127
ffffffffc02025b0:	00003517          	auipc	a0,0x3
ffffffffc02025b4:	68850513          	addi	a0,a0,1672 # ffffffffc0205c38 <etext+0xdbc>
ffffffffc02025b8:	e7bfd0ef          	jal	ffffffffc0200432 <__panic>
    boot_cr3 = PADDR(boot_pgdir);
ffffffffc02025bc:	00003617          	auipc	a2,0x3
ffffffffc02025c0:	60c60613          	addi	a2,a2,1548 # ffffffffc0205bc8 <etext+0xd4c>
ffffffffc02025c4:	0c300593          	li	a1,195
ffffffffc02025c8:	00003517          	auipc	a0,0x3
ffffffffc02025cc:	67050513          	addi	a0,a0,1648 # ffffffffc0205c38 <etext+0xdbc>
ffffffffc02025d0:	e63fd0ef          	jal	ffffffffc0200432 <__panic>
    assert(boot_pgdir != NULL && (uint32_t)PGOFF(boot_pgdir) == 0);
ffffffffc02025d4:	00003697          	auipc	a3,0x3
ffffffffc02025d8:	72468693          	addi	a3,a3,1828 # ffffffffc0205cf8 <etext+0xe7c>
ffffffffc02025dc:	00003617          	auipc	a2,0x3
ffffffffc02025e0:	19460613          	addi	a2,a2,404 # ffffffffc0205770 <etext+0x8f4>
ffffffffc02025e4:	16100593          	li	a1,353
ffffffffc02025e8:	00003517          	auipc	a0,0x3
ffffffffc02025ec:	65050513          	addi	a0,a0,1616 # ffffffffc0205c38 <etext+0xdbc>
ffffffffc02025f0:	e43fd0ef          	jal	ffffffffc0200432 <__panic>
    assert(npage <= KERNTOP / PGSIZE);
ffffffffc02025f4:	00003697          	auipc	a3,0x3
ffffffffc02025f8:	6e468693          	addi	a3,a3,1764 # ffffffffc0205cd8 <etext+0xe5c>
ffffffffc02025fc:	00003617          	auipc	a2,0x3
ffffffffc0202600:	17460613          	addi	a2,a2,372 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0202604:	16000593          	li	a1,352
ffffffffc0202608:	00003517          	auipc	a0,0x3
ffffffffc020260c:	63050513          	addi	a0,a0,1584 # ffffffffc0205c38 <etext+0xdbc>
...
ffffffffc020261c:	77068693          	addi	a3,a3,1904 # ffffffffc0205d88 <etext+0xf0c>
ffffffffc0202620:	00003617          	auipc	a2,0x3
ffffffffc0202624:	15060613          	addi	a2,a2,336 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0202628:	16900593          	li	a1,361
ffffffffc020262c:	00003517          	auipc	a0,0x3
ffffffffc0202630:	60c50513          	addi	a0,a0,1548 # ffffffffc0205c38 <etext+0xdbc>
ffffffffc0202634:	dfffd0ef          	jal	ffffffffc0200432 <__panic>
    assert(page_insert(boot_pgdir, p1, 0x0, 0) == 0);
ffffffffc0202638:	00003697          	auipc	a3,0x3
ffffffffc020263c:	72068693          	addi	a3,a3,1824 # ffffffffc0205d58 <etext+0xedc>
ffffffffc0202640:	00003617          	auipc	a2,0x3
ffffffffc0202644:	13060613          	addi	a2,a2,304 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0202648:	16600593          	li	a1,358
ffffffffc020264c:	00003517          	auipc	a0,0x3
ffffffffc0202650:	5ec50513          	addi	a0,a0,1516 # ffffffffc0205c38 <etext+0xdbc>
ffffffffc0202654:	ddffd0ef          	jal	ffffffffc0200432 <__panic>
    assert(get_page(boot_pgdir, 0x0, NULL) == NULL);
ffffffffc0202658:	00003697          	auipc	a3,0x3
ffffffffc020265c:	6d868693          	addi	a3,a3,1752 # ffffffffc0205d30 <etext+0xeb4>
ffffffffc0202660:	00003617          	auipc	a2,0x3
ffffffffc0202664:	11060613          	addi	a2,a2,272 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0202668:	16200593          	li	a1,354
ffffffffc020266c:	00003517          	auipc	a0,0x3
ffffffffc0202670:	5cc50513          	addi	a0,a0,1484 # ffffffffc0205c38 <etext+0xdbc>
ffffffffc0202674:	dbffd0ef          	jal	ffffffffc0200432 <__panic>
    assert(page_insert(boot_pgdir, p2, PGSIZE, PTE_U | PTE_W) == 0);
ffffffffc0202678:	00003697          	auipc	a3,0x3
ffffffffc020267c:	79868693          	addi	a3,a3,1944 # ffffffffc0205e10 <etext+0xf94>
ffffffffc0202680:	00003617          	auipc	a2,0x3
ffffffffc0202684:	0f060613          	addi	a2,a2,240 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0202688:	17200593          	li	a1,370
ffffffffc020268c:	00003517          	auipc	a0,0x3
ffffffffc0202690:	5ac50513          	addi	a0,a0,1452 # ffffffffc0205c38 <etext+0xdbc>
ffffffffc0202694:	d9ffd0ef          	jal	ffffffffc0200432 <__panic>
    assert(page_ref(p2) == 1);
ffffffffc0202698:	00004697          	auipc	a3,0x4
ffffffffc020269c:	81868693          	addi	a3,a3,-2024 # ffffffffc0205eb0 <etext+0x1034>
ffffffffc02026a0:	00003617          	auipc	a2,0x3
ffffffffc02026a4:	0d060613          	addi	a2,a2,208 # ffffffffc0205770 <etext+0x8f4>
ffffffffc02026a8:	17700593          	li	a1,375
ffffffffc02026ac:	00003517          	auipc	a0,0x3
ffffffffc02026b0:	58c50513          	addi	a0,a0,1420 # ffffffffc0205c38 <etext+0xdbc>
ffffffffc02026b4:	d7ffd0ef          	jal	ffffffffc0200432 <__panic>
    assert(get_pte(boot_pgdir, PGSIZE, 0) == ptep);
ffffffffc02026b8:	00003697          	auipc	a3,0x3
ffffffffc02026bc:	73068693          	addi	a3,a3,1840 # ffffffffc0205de8 <etext+0xf6c>
ffffffffc02026c0:	00003617          	auipc	a2,0x3
ffffffffc02026c4:	0b060613          	addi	a2,a2,176 # ffffffffc0205770 <etext+0x8f4>
ffffffffc02026c8:	16f00593          	li	a1,367
ffffffffc02026cc:	00003517          	auipc	a0,0x3
ffffffffc02026d0:	56c50513          	addi	a0,a0,1388 # ffffffffc0205c38 <etext+0xdbc>
...
ffffffffc02026de:	44660613          	addi	a2,a2,1094 # ffffffffc0205b20 <etext+0xca4>
ffffffffc02026e2:	16e00593          	li	a1,366
ffffffffc02026e6:	00003517          	auipc	a0,0x3
ffffffffc02026ea:	55250513          	addi	a0,a0,1362 # ffffffffc0205c38 <etext+0xdbc>
ffffffffc02026ee:	d45fd0ef          	jal	ffffffffc0200432 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc02026f2:	00003697          	auipc	a3,0x3
ffffffffc02026f6:	75668693          	addi	a3,a3,1878 # ffffffffc0205e48 <etext+0xfcc>
ffffffffc02026fa:	00003617          	auipc	a2,0x3
ffffffffc02026fe:	07660613          	addi	a2,a2,118 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0202702:	17c00593          	li	a1,380
ffffffffc0202706:	00003517          	auipc	a0,0x3
ffffffffc020270a:	53250513          	addi	a0,a0,1330 # ffffffffc0205c38 <etext+0xdbc>
ffffffffc020270e:	d25fd0ef          	jal	ffffffffc0200432 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc0202712:	00003697          	auipc	a3,0x3
ffffffffc0202716:	7fe68693          	addi	a3,a3,2046 # ffffffffc0205f10 <etext+0x1094>
ffffffffc020271a:	00003617          	auipc	a2,0x3
ffffffffc020271e:	05660613          	addi	a2,a2,86 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0202722:	17b00593          	li	a1,379
ffffffffc0202726:	00003517          	auipc	a0,0x3
ffffffffc020272a:	51250513          	addi	a0,a0,1298 # ffffffffc0205c38 <etext+0xdbc>
ffffffffc020272e:	d05fd0ef          	jal	ffffffffc0200432 <__panic>
    assert(page_ref(p1) == 2);
ffffffffc0202732:	00003697          	auipc	a3,0x3
ffffffffc0202736:	7c668693          	addi	a3,a3,1990 # ffffffffc0205ef8 <etext+0x107c>
ffffffffc020273a:	00003617          	auipc	a2,0x3
ffffffffc020273e:	03660613          	addi	a2,a2,54 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0202742:	17a00593          	li	a1,378
ffffffffc0202746:	00003517          	auipc	a0,0x3
ffffffffc020274a:	4f250513          	addi	a0,a0,1266 # ffffffffc0205c38 <etext+0xdbc>
ffffffffc020274e:	ce5fd0ef          	jal	ffffffffc0200432 <__panic>
    assert(page_insert(boot_pgdir, p1, PGSIZE, 0) == 0);
ffffffffc0202752:	00003697          	auipc	a3,0x3
ffffffffc0202756:	77668693          	addi	a3,a3,1910 # ffffffffc0205ec8 <etext+0x104c>
ffffffffc020275a:	00003617          	auipc	a2,0x3
ffffffffc020275e:	01660613          	addi	a2,a2,22 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0202762:	17900593          	li	a1,377
ffffffffc0202766:	00003517          	auipc	a0,0x3
ffffffffc020276a:	4d250513          	addi	a0,a0,1234 # ffffffffc0205c38 <etext+0xdbc>
ffffffffc020276e:	cc5fd0ef          	jal	ffffffffc0200432 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100 + PGSIZE, PTE_W | PTE_R) == 0);
ffffffffc0202772:	00004697          	auipc	a3,0x4
ffffffffc0202776:	90e68693          	addi	a3,a3,-1778 # ffffffffc0206080 <etext+0x1204>
ffffffffc020277a:	00003617          	auipc	a2,0x3
ffffffffc020277e:	ff660613          	addi	a2,a2,-10 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0202782:	1a700593          	li	a1,423
ffffffffc0202786:	00003517          	auipc	a0,0x3
ffffffffc020278a:	4b250513          	addi	a0,a0,1202 # ffffffffc0205c38 <etext+0xdbc>
ffffffffc020278e:	ca5fd0ef          	jal	ffffffffc0200432 <__panic>
    assert(boot_pgdir[0] & PTE_U);
ffffffffc0202792:	00003697          	auipc	a3,0x3
ffffffffc0202796:	70668693          	addi	a3,a3,1798 # ffffffffc0205e98 <etext+0x101c>
ffffffffc020279a:	00003617          	auipc	a2,0x3
ffffffffc020279e:	fd660613          	addi	a2,a2,-42 # ffffffffc0205770 <etext+0x8f4>
ffffffffc02027a2:	17600593          	li	a1,374
ffffffffc02027a6:	00003517          	auipc	a0,0x3
ffffffffc02027aa:	49250513          	addi	a0,a0,1170 # ffffffffc0205c38 <etext+0xdbc>
ffffffffc02027ae:	c85fd0ef          	jal	ffffffffc0200432 <__panic>
    assert(*ptep & PTE_W);
ffffffffc02027b2:	00003697          	auipc	a3,0x3
ffffffffc02027b6:	6d668693          	addi	a3,a3,1750 # ffffffffc0205e88 <etext+0x100c>
ffffffffc02027ba:	00003617          	auipc	a2,0x3
ffffffffc02027be:	fb660613          	addi	a2,a2,-74 # ffffffffc0205770 <etext+0x8f4>
ffffffffc02027c2:	17500593          	li	a1,373
ffffffffc02027c6:	00003517          	auipc	a0,0x3
ffffffffc02027ca:	47250513          	addi	a0,a0,1138 # ffffffffc0205c38 <etext+0xdbc>
ffffffffc02027ce:	c65fd0ef          	jal	ffffffffc0200432 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc02027d2:	00003697          	auipc	a3,0x3
ffffffffc02027d6:	7ae68693          	addi	a3,a3,1966 # ffffffffc0205f80 <etext+0x1104>
ffffffffc02027da:	00003617          	auipc	a2,0x3
ffffffffc02027de:	f9660613          	addi	a2,a2,-106 # ffffffffc0205770 <etext+0x8f4>
ffffffffc02027e2:	1b800593          	li	a1,440
ffffffffc02027e6:	00003517          	auipc	a0,0x3
ffffffffc02027ea:	45250513          	addi	a0,a0,1106 # ffffffffc0205c38 <etext+0xdbc>
ffffffffc02027ee:	c45fd0ef          	jal	ffffffffc0200432 <__panic>
    assert(*ptep & PTE_U);
ffffffffc02027f2:	00003697          	auipc	a3,0x3
ffffffffc02027f6:	68668693          	addi	a3,a3,1670 # ffffffffc0205e78 <etext+0xffc>
ffffffffc02027fa:	00003617          	auipc	a2,0x3
ffffffffc02027fe:	f7660613          	addi	a2,a2,-138 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0202802:	17400593          	li	a1,372
ffffffffc0202806:	00003517          	auipc	a0,0x3
ffffffffc020280a:	43250513          	addi	a0,a0,1074 # ffffffffc0205c38 <etext+0xdbc>
ffffffffc020280e:	c25fd0ef          	jal	ffffffffc0200432 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc0202812:	00003697          	auipc	a3,0x3
ffffffffc0202816:	5be68693          	addi	a3,a3,1470 # ffffffffc0205dd0 <etext+0xf54>
ffffffffc020281a:	00003617          	auipc	a2,0x3
ffffffffc020281e:	f5660613          	addi	a2,a2,-170 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0202822:	18100593          	li	a1,385
ffffffffc0202826:	00003517          	auipc	a0,0x3
ffffffffc020282a:	41250513          	addi	a0,a0,1042 # ffffffffc0205c38 <etext+0xdbc>
ffffffffc020282e:	c05fd0ef          	jal	ffffffffc0200432 <__panic>
    assert((*ptep & PTE_U) == 0);
ffffffffc0202832:	00003697          	auipc	a3,0x3
ffffffffc0202836:	6f668693          	addi	a3,a3,1782 # ffffffffc0205f28 <etext+0x10ac>
ffffffffc020283a:	00003617          	auipc	a2,0x3
ffffffffc020283e:	f3660613          	addi	a2,a2,-202 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0202842:	17e00593          	li	a1,382
ffffffffc0202846:	00003517          	auipc	a0,0x3
ffffffffc020284a:	3f250513          	addi	a0,a0,1010 # ffffffffc0205c38 <etext+0xdbc>
ffffffffc020284e:	be5fd0ef          	jal	ffffffffc0200432 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc0202852:	00003697          	auipc	a3,0x3
ffffffffc0202856:	56668693          	addi	a3,a3,1382 # ffffffffc0205db8 <etext+0xf3c>
ffffffffc020285a:	00003617          	auipc	a2,0x3
ffffffffc020285e:	f1660613          	addi	a2,a2,-234 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0202862:	17d00593          	li	a1,381
ffffffffc0202866:	00003517          	auipc	a0,0x3
ffffffffc020286a:	3d250513          	addi	a0,a0,978 # ffffffffc0205c38 <etext+0xdbc>
ffffffffc020286e:	bc5fd0ef          	jal	ffffffffc0200432 <__panic>
    return KADDR(page2pa(page));
ffffffffc0202872:	00003617          	auipc	a2,0x3
ffffffffc0202876:	2ae60613          	addi	a2,a2,686 # ffffffffc0205b20 <etext+0xca4>
ffffffffc020287a:	06900593          	li	a1,105
ffffffffc020287e:	00003517          	auipc	a0,0x3
ffffffffc0202882:	2ca50513          	addi	a0,a0,714 # ffffffffc0205b48 <etext+0xccc>
ffffffffc0202886:	badfd0ef          	jal	ffffffffc0200432 <__panic>
    assert(page_ref(pde2page(boot_pgdir[0])) == 1);
ffffffffc020288a:	00003697          	auipc	a3,0x3
ffffffffc020288e:	6ce68693          	addi	a3,a3,1742 # ffffffffc0205f58 <etext+0x10dc>
ffffffffc0202892:	00003617          	auipc	a2,0x3
ffffffffc0202896:	ede60613          	addi	a2,a2,-290 # ffffffffc0205770 <etext+0x8f4>
ffffffffc020289a:	18800593          	li	a1,392
ffffffffc020289e:	00003517          	auipc	a0,0x3
ffffffffc02028a2:	39a50513          	addi	a0,a0,922 # ffffffffc0205c38 <etext+0xdbc>
ffffffffc02028a6:	b8dfd0ef          	jal	ffffffffc0200432 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc02028aa:	00003697          	auipc	a3,0x3
ffffffffc02028ae:	66668693          	addi	a3,a3,1638 # ffffffffc0205f10 <etext+0x1094>
ffffffffc02028b2:	00003617          	auipc	a2,0x3
ffffffffc02028b6:	ebe60613          	addi	a2,a2,-322 # ffffffffc0205770 <etext+0x8f4>
ffffffffc02028ba:	18600593          	li	a1,390
ffffffffc02028be:	00003517          	auipc	a0,0x3
ffffffffc02028c2:	37a50513          	addi	a0,a0,890 # ffffffffc0205c38 <etext+0xdbc>
ffffffffc02028c6:	b6dfd0ef          	jal	ffffffffc0200432 <__panic>
    assert(page_ref(p1) == 0);
ffffffffc02028ca:	00003697          	auipc	a3,0x3
ffffffffc02028ce:	67668693          	addi	a3,a3,1654 # ffffffffc0205f40 <etext+0x10c4>
ffffffffc02028d2:	00003617          	auipc	a2,0x3
ffffffffc02028d6:	e9e60613          	addi	a2,a2,-354 # ffffffffc0205770 <etext+0x8f4>
ffffffffc02028da:	18500593          	li	a1,389
ffffffffc02028de:	00003517          	auipc	a0,0x3
ffffffffc02028e2:	35a50513          	addi	a0,a0,858 # ffffffffc0205c38 <etext+0xdbc>
ffffffffc02028e6:	b4dfd0ef          	jal	ffffffffc0200432 <__panic>
    assert(page_ref(p2) == 0);
ffffffffc02028ea:	00003697          	auipc	a3,0x3
ffffffffc02028ee:	62668693          	addi	a3,a3,1574 # ffffffffc0205f10 <etext+0x1094>
ffffffffc02028f2:	00003617          	auipc	a2,0x3
ffffffffc02028f6:	e7e60613          	addi	a2,a2,-386 # ffffffffc0205770 <etext+0x8f4>
ffffffffc02028fa:	18200593          	li	a1,386
ffffffffc02028fe:	00003517          	auipc	a0,0x3
ffffffffc0202902:	33a50513          	addi	a0,a0,826 # ffffffffc0205c38 <etext+0xdbc>
ffffffffc0202906:	b2dfd0ef          	jal	ffffffffc0200432 <__panic>
    assert(page_ref(p) == 1);
ffffffffc020290a:	00003697          	auipc	a3,0x3
ffffffffc020290e:	75e68693          	addi	a3,a3,1886 # ffffffffc0206068 <etext+0x11ec>
ffffffffc0202912:	00003617          	auipc	a2,0x3
ffffffffc0202916:	e5e60613          	addi	a2,a2,-418 # ffffffffc0205770 <etext+0x8f4>
ffffffffc020291a:	1a600593          	li	a1,422
ffffffffc020291e:	00003517          	auipc	a0,0x3
ffffffffc0202922:	31a50513          	addi	a0,a0,794 # ffffffffc0205c38 <etext+0xdbc>
ffffffffc0202926:	b0dfd0ef          	jal	ffffffffc0200432 <__panic>
    assert(page_insert(boot_pgdir, p, 0x100, PTE_W | PTE_R) == 0);
ffffffffc020292a:	00003697          	auipc	a3,0x3
ffffffffc020292e:	70668693          	addi	a3,a3,1798 # ffffffffc0206030 <etext+0x11b4>
ffffffffc0202932:	00003617          	auipc	a2,0x3
ffffffffc0202936:	e3e60613          	addi	a2,a2,-450 # ffffffffc0205770 <etext+0x8f4>
ffffffffc020293a:	1a500593          	li	a1,421
ffffffffc020293e:	00003517          	auipc	a0,0x3
ffffffffc0202942:	2fa50513          	addi	a0,a0,762 # ffffffffc0205c38 <etext+0xdbc>
ffffffffc0202946:	aedfd0ef          	jal	ffffffffc0200432 <__panic>
    assert(boot_pgdir[0] == 0);
ffffffffc020294a:	00003697          	auipc	a3,0x3
ffffffffc020294e:	6ce68693          	addi	a3,a3,1742 # ffffffffc0206018 <etext+0x119c>
ffffffffc0202952:	00003617          	auipc	a2,0x3
ffffffffc0202956:	e1e60613          	addi	a2,a2,-482 # ffffffffc0205770 <etext+0x8f4>
ffffffffc020295a:	1a100593          	li	a1,417
ffffffffc020295e:	00003517          	auipc	a0,0x3
ffffffffc0202962:	2da50513          	addi	a0,a0,730 # ffffffffc0205c38 <etext+0xdbc>
ffffffffc0202966:	acdfd0ef          	jal	ffffffffc0200432 <__panic>
    assert(nr_free_store==nr_free_pages());
ffffffffc020296a:	00003697          	auipc	a3,0x3
ffffffffc020296e:	61668693          	addi	a3,a3,1558 # ffffffffc0205f80 <etext+0x1104>
ffffffffc0202972:	00003617          	auipc	a2,0x3
ffffffffc0202976:	dfe60613          	addi	a2,a2,-514 # ffffffffc0205770 <etext+0x8f4>
ffffffffc020297a:	19000593          	li	a1,400
ffffffffc020297e:	00003517          	auipc	a0,0x3
ffffffffc0202982:	2ba50513          	addi	a0,a0,698 # ffffffffc0205c38 <etext+0xdbc>
ffffffffc0202986:	aadfd0ef          	jal	ffffffffc0200432 <__panic>
    assert(pte2page(*ptep) == p1);
ffffffffc020298a:	00003697          	auipc	a3,0x3
ffffffffc020298e:	42e68693          	addi	a3,a3,1070 # ffffffffc0205db8 <etext+0xf3c>
ffffffffc0202992:	00003617          	auipc	a2,0x3
ffffffffc0202996:	dde60613          	addi	a2,a2,-546 # ffffffffc0205770 <etext+0x8f4>
ffffffffc020299a:	16a00593          	li	a1,362
ffffffffc020299e:	00003517          	auipc	a0,0x3
ffffffffc02029a2:	29a50513          	addi	a0,a0,666 # ffffffffc0205c38 <etext+0xdbc>
ffffffffc02029a6:	a8dfd0ef          	jal	ffffffffc0200432 <__panic>
    ptep = (pte_t *)KADDR(PDE_ADDR(boot_pgdir[0]));
ffffffffc02029aa:	00003617          	auipc	a2,0x3
ffffffffc02029ae:	17660613          	addi	a2,a2,374 # ffffffffc0205b20 <etext+0xca4>
ffffffffc02029b2:	16d00593          	li	a1,365
ffffffffc02029b6:	00003517          	auipc	a0,0x3
ffffffffc02029ba:	28250513          	addi	a0,a0,642 # ffffffffc0205c38 <etext+0xdbc>
ffffffffc02029be:	a75fd0ef          	jal	ffffffffc0200432 <__panic>
    assert(page_ref(p1) == 1);
ffffffffc02029c2:	00003697          	auipc	a3,0x3
ffffffffc02029c6:	40e68693          	addi	a3,a3,1038 # ffffffffc0205dd0 <etext+0xf54>
ffffffffc02029ca:	00003617          	auipc	a2,0x3
ffffffffc02029ce:	da660613          	addi	a2,a2,-602 # ffffffffc0205770 <etext+0x8f4>
ffffffffc02029d2:	16b00593          	li	a1,363
ffffffffc02029d6:	00003517          	auipc	a0,0x3
ffffffffc02029da:	26250513          	addi	a0,a0,610 # ffffffffc0205c38 <etext+0xdbc>
ffffffffc02029de:	a55fd0ef          	jal	ffffffffc0200432 <__panic>
    assert((ptep = get_pte(boot_pgdir, PGSIZE, 0)) != NULL);
ffffffffc02029e2:	00003697          	auipc	a3,0x3
ffffffffc02029e6:	46668693          	addi	a3,a3,1126 # ffffffffc0205e48 <etext+0xfcc>
ffffffffc02029ea:	00003617          	auipc	a2,0x3
ffffffffc02029ee:	d8660613          	addi	a2,a2,-634 # ffffffffc0205770 <etext+0x8f4>
ffffffffc02029f2:	17300593          	li	a1,371
ffffffffc02029f6:	00003517          	auipc	a0,0x3
ffffffffc02029fa:	24250513          	addi	a0,a0,578 # ffffffffc0205c38 <etext+0xdbc>
ffffffffc02029fe:	a35fd0ef          	jal	ffffffffc0200432 <__panic>
    assert(strlen((const char *)0x100) == 0);
ffffffffc0202a02:	00003697          	auipc	a3,0x3
ffffffffc0202a06:	72668693          	addi	a3,a3,1830 # ffffffffc0206128 <etext+0x12ac>
ffffffffc0202a0a:	00003617          	auipc	a2,0x3
ffffffffc0202a0e:	d6660613          	addi	a2,a2,-666 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0202a12:	1af00593          	li	a1,431
ffffffffc0202a16:	00003517          	auipc	a0,0x3
ffffffffc0202a1a:	22250513          	addi	a0,a0,546 # ffffffffc0205c38 <etext+0xdbc>
ffffffffc0202a1e:	a15fd0ef          	jal	ffffffffc0200432 <__panic>
    assert(strcmp((void *)0x100, (void *)(0x100 + PGSIZE)) == 0);
ffffffffc0202a22:	00003697          	auipc	a3,0x3
ffffffffc0202a26:	6ce68693          	addi	a3,a3,1742 # ffffffffc02060f0 <etext+0x1274>
ffffffffc0202a2a:	00003617          	auipc	a2,0x3
ffffffffc0202a2e:	d4660613          	addi	a2,a2,-698 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0202a32:	1ac00593          	li	a1,428
ffffffffc0202a36:	00003517          	auipc	a0,0x3
ffffffffc0202a3a:	20250513          	addi	a0,a0,514 # ffffffffc0205c38 <etext+0xdbc>
ffffffffc0202a3e:	9f5fd0ef          	jal	ffffffffc0200432 <__panic>
    assert(page_ref(p) == 2);
ffffffffc0202a42:	00003697          	auipc	a3,0x3
ffffffffc0202a46:	67e68693          	addi	a3,a3,1662 # ffffffffc02060c0 <etext+0x1244>
ffffffffc0202a4a:	00003617          	auipc	a2,0x3
ffffffffc0202a4e:	d2660613          	addi	a2,a2,-730 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0202a52:	1a800593          	li	a1,424
ffffffffc0202a56:	00003517          	auipc	a0,0x3
ffffffffc0202a5a:	1e250513          	addi	a0,a0,482 # ffffffffc0205c38 <etext+0xdbc>
...
ffffffffc0202ae8:	68c68693          	addi	a3,a3,1676 # ffffffffc0206170 <etext+0x12f4>
ffffffffc0202aec:	00003617          	auipc	a2,0x3
ffffffffc0202af0:	c8460613          	addi	a2,a2,-892 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0202af4:	14800593          	li	a1,328
ffffffffc0202af8:	00003517          	auipc	a0,0x3
ffffffffc0202afc:	14050513          	addi	a0,a0,320 # ffffffffc0205c38 <etext+0xdbc>
...
ffffffffc0202b26:	0ce60613          	addi	a2,a2,206 # ffffffffc0205bf0 <etext+0xd74>
ffffffffc0202b2a:	06200593          	li	a1,98
ffffffffc0202b2e:	00003517          	auipc	a0,0x3
ffffffffc0202b32:	01a50513          	addi	a0,a0,26 # ffffffffc0205b48 <etext+0xccc>
pa2page(uintptr_t pa) {
...
ffffffffc0202b8e:	62e50513          	addi	a0,a0,1582 # ffffffffc02061b8 <etext+0x133c>
...
ffffffffc0202bf4:	5e050513          	addi	a0,a0,1504 # ffffffffc02061d0 <etext+0x1354>
...
ffffffffc0202c4c:	5f850513          	addi	a0,a0,1528 # ffffffffc0206240 <etext+0x13c4>
...
ffffffffc0202c66:	62e50513          	addi	a0,a0,1582 # ffffffffc0206290 <etext+0x1414>
...
ffffffffc0202cda:	64250513          	addi	a0,a0,1602 # ffffffffc0206318 <etext+0x149c>
...
ffffffffc0202dc4:	1a8c8c93          	addi	s9,s9,424 # ffffffffc0206f68 <nbase>
...
ffffffffc0202e22:	5a250513          	addi	a0,a0,1442 # ffffffffc02063c0 <etext+0x1544>
...
ffffffffc0202ef6:	51e50513          	addi	a0,a0,1310 # ffffffffc0206410 <etext+0x1594>
...
ffffffffc0202f26:	83e68693          	addi	a3,a3,-1986 # ffffffffc0205760 <etext+0x8e4>
ffffffffc0202f2a:	00003617          	auipc	a2,0x3
ffffffffc0202f2e:	84660613          	addi	a2,a2,-1978 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0202f32:	0bd00593          	li	a1,189
ffffffffc0202f36:	00003517          	auipc	a0,0x3
ffffffffc0202f3a:	27250513          	addi	a0,a0,626 # ffffffffc02061a8 <etext+0x132c>
...
ffffffffc0202f4a:	caa60613          	addi	a2,a2,-854 # ffffffffc0205bf0 <etext+0xd74>
ffffffffc0202f4e:	06200593          	li	a1,98
ffffffffc0202f52:	00003517          	auipc	a0,0x3
ffffffffc0202f56:	bf650513          	addi	a0,a0,-1034 # ffffffffc0205b48 <etext+0xccc>
ffffffffc0202f5a:	cd8fd0ef          	jal	ffffffffc0200432 <__panic>
         assert(pte2page(*check_ptep[i]) == check_rp[i]);
ffffffffc0202f5e:	00003697          	auipc	a3,0x3
ffffffffc0202f62:	43a68693          	addi	a3,a3,1082 # ffffffffc0206398 <etext+0x151c>
ffffffffc0202f66:	00003617          	auipc	a2,0x3
ffffffffc0202f6a:	80a60613          	addi	a2,a2,-2038 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0202f6e:	0fd00593          	li	a1,253
ffffffffc0202f72:	00003517          	auipc	a0,0x3
ffffffffc0202f76:	23650513          	addi	a0,a0,566 # ffffffffc02061a8 <etext+0x132c>
ffffffffc0202f7a:	cb8fd0ef          	jal	ffffffffc0200432 <__panic>
          assert(check_rp[i] != NULL );
ffffffffc0202f7e:	00003697          	auipc	a3,0x3
ffffffffc0202f82:	33a68693          	addi	a3,a3,826 # ffffffffc02062b8 <etext+0x143c>
ffffffffc0202f86:	00002617          	auipc	a2,0x2
ffffffffc0202f8a:	7ea60613          	addi	a2,a2,2026 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0202f8e:	0dd00593          	li	a1,221
ffffffffc0202f92:	00003517          	auipc	a0,0x3
ffffffffc0202f96:	21650513          	addi	a0,a0,534 # ffffffffc02061a8 <etext+0x132c>
ffffffffc0202f9a:	c98fd0ef          	jal	ffffffffc0200432 <__panic>
        panic("bad max_swap_offset %08x.\n", max_swap_offset);
ffffffffc0202f9e:	00003617          	auipc	a2,0x3
ffffffffc0202fa2:	1ea60613          	addi	a2,a2,490 # ffffffffc0206188 <etext+0x130c>
ffffffffc0202fa6:	02a00593          	li	a1,42
ffffffffc0202faa:	00003517          	auipc	a0,0x3
ffffffffc0202fae:	1fe50513          	addi	a0,a0,510 # ffffffffc02061a8 <etext+0x132c>
...
ffffffffc0202fd2:	3b268693          	addi	a3,a3,946 # ffffffffc0206380 <etext+0x1504>
ffffffffc0202fd6:	00002617          	auipc	a2,0x2
ffffffffc0202fda:	79a60613          	addi	a2,a2,1946 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0202fde:	0fc00593          	li	a1,252
ffffffffc0202fe2:	00003517          	auipc	a0,0x3
ffffffffc0202fe6:	1c650513          	addi	a0,a0,454 # ffffffffc02061a8 <etext+0x132c>
ffffffffc0202fea:	c48fd0ef          	jal	ffffffffc0200432 <__panic>
        panic("pte2page called with invalid pte");
ffffffffc0202fee:	00003617          	auipc	a2,0x3
ffffffffc0202ff2:	c2260613          	addi	a2,a2,-990 # ffffffffc0205c10 <etext+0xd94>
ffffffffc0202ff6:	07400593          	li	a1,116
ffffffffc0202ffa:	00003517          	auipc	a0,0x3
ffffffffc0202ffe:	b4e50513          	addi	a0,a0,-1202 # ffffffffc0205b48 <etext+0xccc>
ffffffffc0203002:	c30fd0ef          	jal	ffffffffc0200432 <__panic>
          assert(!PageProperty(check_rp[i]));
ffffffffc0203006:	00003697          	auipc	a3,0x3
ffffffffc020300a:	2ca68693          	addi	a3,a3,714 # ffffffffc02062d0 <etext+0x1454>
ffffffffc020300e:	00002617          	auipc	a2,0x2
ffffffffc0203012:	76260613          	addi	a2,a2,1890 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0203016:	0de00593          	li	a1,222
ffffffffc020301a:	00003517          	auipc	a0,0x3
ffffffffc020301e:	18e50513          	addi	a0,a0,398 # ffffffffc02061a8 <etext+0x132c>
ffffffffc0203022:	c10fd0ef          	jal	ffffffffc0200432 <__panic>
     assert(check_mm_struct == NULL);
ffffffffc0203026:	00003697          	auipc	a3,0x3
ffffffffc020302a:	1e268693          	addi	a3,a3,482 # ffffffffc0206208 <etext+0x138c>
ffffffffc020302e:	00002617          	auipc	a2,0x2
ffffffffc0203032:	74260613          	addi	a2,a2,1858 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0203036:	0c800593          	li	a1,200
ffffffffc020303a:	00003517          	auipc	a0,0x3
ffffffffc020303e:	16e50513          	addi	a0,a0,366 # ffffffffc02061a8 <etext+0x132c>
ffffffffc0203042:	bf0fd0ef          	jal	ffffffffc0200432 <__panic>
     assert(total == nr_free_pages());
ffffffffc0203046:	00002697          	auipc	a3,0x2
ffffffffc020304a:	75a68693          	addi	a3,a3,1882 # ffffffffc02057a0 <etext+0x924>
ffffffffc020304e:	00002617          	auipc	a2,0x2
ffffffffc0203052:	72260613          	addi	a2,a2,1826 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0203056:	0c000593          	li	a1,192
ffffffffc020305a:	00003517          	auipc	a0,0x3
ffffffffc020305e:	14e50513          	addi	a0,a0,334 # ffffffffc02061a8 <etext+0x132c>
ffffffffc0203062:	bd0fd0ef          	jal	ffffffffc0200432 <__panic>
     assert( nr_free == 0);         
ffffffffc0203066:	00003697          	auipc	a3,0x3
ffffffffc020306a:	8e268693          	addi	a3,a3,-1822 # ffffffffc0205948 <etext+0xacc>
ffffffffc020306e:	00002617          	auipc	a2,0x2
ffffffffc0203072:	70260613          	addi	a2,a2,1794 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0203076:	0f400593          	li	a1,244
ffffffffc020307a:	00003517          	auipc	a0,0x3
ffffffffc020307e:	12e50513          	addi	a0,a0,302 # ffffffffc02061a8 <etext+0x132c>
ffffffffc0203082:	bb0fd0ef          	jal	ffffffffc0200432 <__panic>
     assert(pgdir[0] == 0);
ffffffffc0203086:	00003697          	auipc	a3,0x3
ffffffffc020308a:	19a68693          	addi	a3,a3,410 # ffffffffc0206220 <etext+0x13a4>
ffffffffc020308e:	00002617          	auipc	a2,0x2
ffffffffc0203092:	6e260613          	addi	a2,a2,1762 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0203096:	0cd00593          	li	a1,205
ffffffffc020309a:	00003517          	auipc	a0,0x3
ffffffffc020309e:	10e50513          	addi	a0,a0,270 # ffffffffc02061a8 <etext+0x132c>
ffffffffc02030a2:	b90fd0ef          	jal	ffffffffc0200432 <__panic>
     assert(mm != NULL);
ffffffffc02030a6:	00003697          	auipc	a3,0x3
ffffffffc02030aa:	15268693          	addi	a3,a3,338 # ffffffffc02061f8 <etext+0x137c>
ffffffffc02030ae:	00002617          	auipc	a2,0x2
ffffffffc02030b2:	6c260613          	addi	a2,a2,1730 # ffffffffc0205770 <etext+0x8f4>
ffffffffc02030b6:	0c500593          	li	a1,197
ffffffffc02030ba:	00003517          	auipc	a0,0x3
ffffffffc02030be:	0ee50513          	addi	a0,a0,238 # ffffffffc02061a8 <etext+0x132c>
ffffffffc02030c2:	b70fd0ef          	jal	ffffffffc0200432 <__panic>
     assert(total==0);
ffffffffc02030c6:	00003697          	auipc	a3,0x3
ffffffffc02030ca:	33a68693          	addi	a3,a3,826 # ffffffffc0206400 <etext+0x1584>
ffffffffc02030ce:	00002617          	auipc	a2,0x2
ffffffffc02030d2:	6a260613          	addi	a2,a2,1698 # ffffffffc0205770 <etext+0x8f4>
ffffffffc02030d6:	11d00593          	li	a1,285
ffffffffc02030da:	00003517          	auipc	a0,0x3
ffffffffc02030de:	0ce50513          	addi	a0,a0,206 # ffffffffc02061a8 <etext+0x132c>
ffffffffc02030e2:	b50fd0ef          	jal	ffffffffc0200432 <__panic>
    return KADDR(page2pa(page));
ffffffffc02030e6:	00003617          	auipc	a2,0x3
ffffffffc02030ea:	a3a60613          	addi	a2,a2,-1478 # ffffffffc0205b20 <etext+0xca4>
ffffffffc02030ee:	06900593          	li	a1,105
ffffffffc02030f2:	00003517          	auipc	a0,0x3
ffffffffc02030f6:	a5650513          	addi	a0,a0,-1450 # ffffffffc0205b48 <etext+0xccc>
ffffffffc02030fa:	b38fd0ef          	jal	ffffffffc0200432 <__panic>
     assert(count==0);
ffffffffc02030fe:	00003697          	auipc	a3,0x3
ffffffffc0203102:	2f268693          	addi	a3,a3,754 # ffffffffc02063f0 <etext+0x1574>
ffffffffc0203106:	00002617          	auipc	a2,0x2
ffffffffc020310a:	66a60613          	addi	a2,a2,1642 # ffffffffc0205770 <etext+0x8f4>
ffffffffc020310e:	11c00593          	li	a1,284
ffffffffc0203112:	00003517          	auipc	a0,0x3
ffffffffc0203116:	09650513          	addi	a0,a0,150 # ffffffffc02061a8 <etext+0x132c>
ffffffffc020311a:	b18fd0ef          	jal	ffffffffc0200432 <__panic>
     assert(pgfault_num==1);
ffffffffc020311e:	00003697          	auipc	a3,0x3
ffffffffc0203122:	22268693          	addi	a3,a3,546 # ffffffffc0206340 <etext+0x14c4>
ffffffffc0203126:	00002617          	auipc	a2,0x2
ffffffffc020312a:	64a60613          	addi	a2,a2,1610 # ffffffffc0205770 <etext+0x8f4>
ffffffffc020312e:	09600593          	li	a1,150
ffffffffc0203132:	00003517          	auipc	a0,0x3
ffffffffc0203136:	07650513          	addi	a0,a0,118 # ffffffffc02061a8 <etext+0x132c>
ffffffffc020313a:	af8fd0ef          	jal	ffffffffc0200432 <__panic>
     assert(nr_free==CHECK_VALID_PHY_PAGE_NUM);
ffffffffc020313e:	00003697          	auipc	a3,0x3
ffffffffc0203142:	1b268693          	addi	a3,a3,434 # ffffffffc02062f0 <etext+0x1474>
ffffffffc0203146:	00002617          	auipc	a2,0x2
ffffffffc020314a:	62a60613          	addi	a2,a2,1578 # ffffffffc0205770 <etext+0x8f4>
ffffffffc020314e:	0eb00593          	li	a1,235
ffffffffc0203152:	00003517          	auipc	a0,0x3
ffffffffc0203156:	05650513          	addi	a0,a0,86 # ffffffffc02061a8 <etext+0x132c>
ffffffffc020315a:	ad8fd0ef          	jal	ffffffffc0200432 <__panic>
     assert(temp_ptep!= NULL);
ffffffffc020315e:	00003697          	auipc	a3,0x3
ffffffffc0203162:	11a68693          	addi	a3,a3,282 # ffffffffc0206278 <etext+0x13fc>
ffffffffc0203166:	00002617          	auipc	a2,0x2
ffffffffc020316a:	60a60613          	addi	a2,a2,1546 # ffffffffc0205770 <etext+0x8f4>
ffffffffc020316e:	0d800593          	li	a1,216
ffffffffc0203172:	00003517          	auipc	a0,0x3
ffffffffc0203176:	03650513          	addi	a0,a0,54 # ffffffffc02061a8 <etext+0x132c>
ffffffffc020317a:	ab8fd0ef          	jal	ffffffffc0200432 <__panic>
     assert(ret==0);
ffffffffc020317e:	00003697          	auipc	a3,0x3
ffffffffc0203182:	26a68693          	addi	a3,a3,618 # ffffffffc02063e8 <etext+0x156c>
ffffffffc0203186:	00002617          	auipc	a2,0x2
ffffffffc020318a:	5ea60613          	addi	a2,a2,1514 # ffffffffc0205770 <etext+0x8f4>
ffffffffc020318e:	10300593          	li	a1,259
ffffffffc0203192:	00003517          	auipc	a0,0x3
ffffffffc0203196:	01650513          	addi	a0,a0,22 # ffffffffc02061a8 <etext+0x132c>
ffffffffc020319a:	a98fd0ef          	jal	ffffffffc0200432 <__panic>
     assert(vma != NULL);
ffffffffc020319e:	00003697          	auipc	a3,0x3
ffffffffc02031a2:	09268693          	addi	a3,a3,146 # ffffffffc0206230 <etext+0x13b4>
ffffffffc02031a6:	00002617          	auipc	a2,0x2
ffffffffc02031aa:	5ca60613          	addi	a2,a2,1482 # ffffffffc0205770 <etext+0x8f4>
ffffffffc02031ae:	0d000593          	li	a1,208
ffffffffc02031b2:	00003517          	auipc	a0,0x3
ffffffffc02031b6:	ff650513          	addi	a0,a0,-10 # ffffffffc02061a8 <etext+0x132c>
ffffffffc02031ba:	a78fd0ef          	jal	ffffffffc0200432 <__panic>
     assert(pgfault_num==4);
ffffffffc02031be:	00003697          	auipc	a3,0x3
ffffffffc02031c2:	1b268693          	addi	a3,a3,434 # ffffffffc0206370 <etext+0x14f4>
ffffffffc02031c6:	00002617          	auipc	a2,0x2
ffffffffc02031ca:	5aa60613          	addi	a2,a2,1450 # ffffffffc0205770 <etext+0x8f4>
ffffffffc02031ce:	0a000593          	li	a1,160
ffffffffc02031d2:	00003517          	auipc	a0,0x3
ffffffffc02031d6:	fd650513          	addi	a0,a0,-42 # ffffffffc02061a8 <etext+0x132c>
ffffffffc02031da:	a58fd0ef          	jal	ffffffffc0200432 <__panic>
     assert(pgfault_num==4);
ffffffffc02031de:	00003697          	auipc	a3,0x3
ffffffffc02031e2:	19268693          	addi	a3,a3,402 # ffffffffc0206370 <etext+0x14f4>
ffffffffc02031e6:	00002617          	auipc	a2,0x2
ffffffffc02031ea:	58a60613          	addi	a2,a2,1418 # ffffffffc0205770 <etext+0x8f4>
ffffffffc02031ee:	0a200593          	li	a1,162
ffffffffc02031f2:	00003517          	auipc	a0,0x3
ffffffffc02031f6:	fb650513          	addi	a0,a0,-74 # ffffffffc02061a8 <etext+0x132c>
ffffffffc02031fa:	a38fd0ef          	jal	ffffffffc0200432 <__panic>
     assert(pgfault_num==2);
ffffffffc02031fe:	00003697          	auipc	a3,0x3
ffffffffc0203202:	15268693          	addi	a3,a3,338 # ffffffffc0206350 <etext+0x14d4>
ffffffffc0203206:	00002617          	auipc	a2,0x2
ffffffffc020320a:	56a60613          	addi	a2,a2,1386 # ffffffffc0205770 <etext+0x8f4>
ffffffffc020320e:	09800593          	li	a1,152
ffffffffc0203212:	00003517          	auipc	a0,0x3
ffffffffc0203216:	f9650513          	addi	a0,a0,-106 # ffffffffc02061a8 <etext+0x132c>
ffffffffc020321a:	a18fd0ef          	jal	ffffffffc0200432 <__panic>
     assert(pgfault_num==2);
ffffffffc020321e:	00003697          	auipc	a3,0x3
ffffffffc0203222:	13268693          	addi	a3,a3,306 # ffffffffc0206350 <etext+0x14d4>
ffffffffc0203226:	00002617          	auipc	a2,0x2
ffffffffc020322a:	54a60613          	addi	a2,a2,1354 # ffffffffc0205770 <etext+0x8f4>
ffffffffc020322e:	09a00593          	li	a1,154
ffffffffc0203232:	00003517          	auipc	a0,0x3
ffffffffc0203236:	f7650513          	addi	a0,a0,-138 # ffffffffc02061a8 <etext+0x132c>
ffffffffc020323a:	9f8fd0ef          	jal	ffffffffc0200432 <__panic>
     assert(pgfault_num==3);
ffffffffc020323e:	00003697          	auipc	a3,0x3
ffffffffc0203242:	12268693          	addi	a3,a3,290 # ffffffffc0206360 <etext+0x14e4>
ffffffffc0203246:	00002617          	auipc	a2,0x2
ffffffffc020324a:	52a60613          	addi	a2,a2,1322 # ffffffffc0205770 <etext+0x8f4>
ffffffffc020324e:	09c00593          	li	a1,156
ffffffffc0203252:	00003517          	auipc	a0,0x3
ffffffffc0203256:	f5650513          	addi	a0,a0,-170 # ffffffffc02061a8 <etext+0x132c>
ffffffffc020325a:	9d8fd0ef          	jal	ffffffffc0200432 <__panic>
     assert(pgfault_num==3);
ffffffffc020325e:	00003697          	auipc	a3,0x3
ffffffffc0203262:	10268693          	addi	a3,a3,258 # ffffffffc0206360 <etext+0x14e4>
ffffffffc0203266:	00002617          	auipc	a2,0x2
ffffffffc020326a:	50a60613          	addi	a2,a2,1290 # ffffffffc0205770 <etext+0x8f4>
ffffffffc020326e:	09e00593          	li	a1,158
ffffffffc0203272:	00003517          	auipc	a0,0x3
ffffffffc0203276:	f3650513          	addi	a0,a0,-202 # ffffffffc02061a8 <etext+0x132c>
ffffffffc020327a:	9b8fd0ef          	jal	ffffffffc0200432 <__panic>
     assert(pgfault_num==1);
ffffffffc020327e:	00003697          	auipc	a3,0x3
ffffffffc0203282:	0c268693          	addi	a3,a3,194 # ffffffffc0206340 <etext+0x14c4>
ffffffffc0203286:	00002617          	auipc	a2,0x2
ffffffffc020328a:	4ea60613          	addi	a2,a2,1258 # ffffffffc0205770 <etext+0x8f4>
ffffffffc020328e:	09400593          	li	a1,148
ffffffffc0203292:	00003517          	auipc	a0,0x3
ffffffffc0203296:	f1650513          	addi	a0,a0,-234 # ffffffffc02061a8 <etext+0x132c>
...
ffffffffc02032e4:	1b0b0b13          	addi	s6,s6,432 # ffffffffc0206490 <etext+0x1614>
                    cprintf("SWAP: failed to save\n");
ffffffffc02032e8:	00003b97          	auipc	s7,0x3
ffffffffc02032ec:	190b8b93          	addi	s7,s7,400 # ffffffffc0206478 <etext+0x15fc>
...
ffffffffc020339e:	09650513          	addi	a0,a0,150 # ffffffffc0206430 <etext+0x15b4>
...
ffffffffc02033b0:	0b468693          	addi	a3,a3,180 # ffffffffc0206460 <etext+0x15e4>
ffffffffc02033b4:	00002617          	auipc	a2,0x2
ffffffffc02033b8:	3bc60613          	addi	a2,a2,956 # ffffffffc0205770 <etext+0x8f4>
ffffffffc02033bc:	06900593          	li	a1,105
ffffffffc02033c0:	00003517          	auipc	a0,0x3
ffffffffc02033c4:	de850513          	addi	a0,a0,-536 # ffffffffc02061a8 <etext+0x132c>
...
ffffffffc0203408:	0dc50513          	addi	a0,a0,220 # ffffffffc02064e0 <etext+0x1664>
...
ffffffffc020342a:	0aa68693          	addi	a3,a3,170 # ffffffffc02064d0 <etext+0x1654>
ffffffffc020342e:	00002617          	auipc	a2,0x2
ffffffffc0203432:	34260613          	addi	a2,a2,834 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0203436:	07f00593          	li	a1,127
ffffffffc020343a:	00003517          	auipc	a0,0x3
ffffffffc020343e:	d6e50513          	addi	a0,a0,-658 # ffffffffc02061a8 <etext+0x132c>
...
ffffffffc020346e:	0b650513          	addi	a0,a0,182 # ffffffffc0206520 <etext+0x16a4>
    *(unsigned char *)0x3000 = 0x0c;
...
ffffffffc02034a2:	0c250513          	addi	a0,a0,194 # ffffffffc0206560 <etext+0x16e4>
    *(unsigned char *)0x1000 = 0x0a;
...
ffffffffc02034c8:	0c450513          	addi	a0,a0,196 # ffffffffc0206588 <etext+0x170c>
    *(unsigned char *)0x4000 = 0x0d;
...
ffffffffc02034e6:	0ce50513          	addi	a0,a0,206 # ffffffffc02065b0 <etext+0x1734>
    *(unsigned char *)0x2000 = 0x0b;
...
ffffffffc0203500:	0dc50513          	addi	a0,a0,220 # ffffffffc02065d8 <etext+0x175c>
...
ffffffffc0203520:	09450513          	addi	a0,a0,148 # ffffffffc02065b0 <etext+0x1734>
...
ffffffffc0203536:	02e50513          	addi	a0,a0,46 # ffffffffc0206560 <etext+0x16e4>
...
ffffffffc020354e:	06650513          	addi	a0,a0,102 # ffffffffc02065b0 <etext+0x1734>
...
ffffffffc0203566:	fbe50513          	addi	a0,a0,-66 # ffffffffc0206520 <etext+0x16a4>
...
ffffffffc020357e:	00e50513          	addi	a0,a0,14 # ffffffffc0206588 <etext+0x170c>
...
ffffffffc0203596:	04650513          	addi	a0,a0,70 # ffffffffc02065d8 <etext+0x175c>
...
ffffffffc02035b6:	fae50513          	addi	a0,a0,-82 # ffffffffc0206560 <etext+0x16e4>
...
ffffffffc02035f0:	d8468693          	addi	a3,a3,-636 # ffffffffc0206370 <etext+0x14f4>
ffffffffc02035f4:	00002617          	auipc	a2,0x2
ffffffffc02035f8:	17c60613          	addi	a2,a2,380 # ffffffffc0205770 <etext+0x8f4>
ffffffffc02035fc:	05100593          	li	a1,81
ffffffffc0203600:	00003517          	auipc	a0,0x3
ffffffffc0203604:	f4850513          	addi	a0,a0,-184 # ffffffffc0206548 <etext+0x16cc>
ffffffffc0203608:	e2bfc0ef          	jal	ffffffffc0200432 <__panic>
    assert(pgfault_num==11);
ffffffffc020360c:	00003697          	auipc	a3,0x3
ffffffffc0203610:	07c68693          	addi	a3,a3,124 # ffffffffc0206688 <etext+0x180c>
ffffffffc0203614:	00002617          	auipc	a2,0x2
ffffffffc0203618:	15c60613          	addi	a2,a2,348 # ffffffffc0205770 <etext+0x8f4>
ffffffffc020361c:	07300593          	li	a1,115
ffffffffc0203620:	00003517          	auipc	a0,0x3
ffffffffc0203624:	f2850513          	addi	a0,a0,-216 # ffffffffc0206548 <etext+0x16cc>
ffffffffc0203628:	e0bfc0ef          	jal	ffffffffc0200432 <__panic>
    assert(*(unsigned char *)0x1000 == 0x0a);
ffffffffc020362c:	00003697          	auipc	a3,0x3
ffffffffc0203630:	03468693          	addi	a3,a3,52 # ffffffffc0206660 <etext+0x17e4>
ffffffffc0203634:	00002617          	auipc	a2,0x2
ffffffffc0203638:	13c60613          	addi	a2,a2,316 # ffffffffc0205770 <etext+0x8f4>
ffffffffc020363c:	07100593          	li	a1,113
ffffffffc0203640:	00003517          	auipc	a0,0x3
ffffffffc0203644:	f0850513          	addi	a0,a0,-248 # ffffffffc0206548 <etext+0x16cc>
ffffffffc0203648:	debfc0ef          	jal	ffffffffc0200432 <__panic>
    assert(pgfault_num==10);
ffffffffc020364c:	00003697          	auipc	a3,0x3
ffffffffc0203650:	00468693          	addi	a3,a3,4 # ffffffffc0206650 <etext+0x17d4>
ffffffffc0203654:	00002617          	auipc	a2,0x2
ffffffffc0203658:	11c60613          	addi	a2,a2,284 # ffffffffc0205770 <etext+0x8f4>
ffffffffc020365c:	06f00593          	li	a1,111
ffffffffc0203660:	00003517          	auipc	a0,0x3
ffffffffc0203664:	ee850513          	addi	a0,a0,-280 # ffffffffc0206548 <etext+0x16cc>
ffffffffc0203668:	dcbfc0ef          	jal	ffffffffc0200432 <__panic>
    assert(pgfault_num==9);
ffffffffc020366c:	00003697          	auipc	a3,0x3
ffffffffc0203670:	fd468693          	addi	a3,a3,-44 # ffffffffc0206640 <etext+0x17c4>
ffffffffc0203674:	00002617          	auipc	a2,0x2
ffffffffc0203678:	0fc60613          	addi	a2,a2,252 # ffffffffc0205770 <etext+0x8f4>
ffffffffc020367c:	06c00593          	li	a1,108
ffffffffc0203680:	00003517          	auipc	a0,0x3
ffffffffc0203684:	ec850513          	addi	a0,a0,-312 # ffffffffc0206548 <etext+0x16cc>
ffffffffc0203688:	dabfc0ef          	jal	ffffffffc0200432 <__panic>
    assert(pgfault_num==8);
ffffffffc020368c:	00003697          	auipc	a3,0x3
ffffffffc0203690:	fa468693          	addi	a3,a3,-92 # ffffffffc0206630 <etext+0x17b4>
ffffffffc0203694:	00002617          	auipc	a2,0x2
ffffffffc0203698:	0dc60613          	addi	a2,a2,220 # ffffffffc0205770 <etext+0x8f4>
ffffffffc020369c:	06900593          	li	a1,105
ffffffffc02036a0:	00003517          	auipc	a0,0x3
ffffffffc02036a4:	ea850513          	addi	a0,a0,-344 # ffffffffc0206548 <etext+0x16cc>
ffffffffc02036a8:	d8bfc0ef          	jal	ffffffffc0200432 <__panic>
    assert(pgfault_num==7);
ffffffffc02036ac:	00003697          	auipc	a3,0x3
ffffffffc02036b0:	f7468693          	addi	a3,a3,-140 # ffffffffc0206620 <etext+0x17a4>
ffffffffc02036b4:	00002617          	auipc	a2,0x2
ffffffffc02036b8:	0bc60613          	addi	a2,a2,188 # ffffffffc0205770 <etext+0x8f4>
ffffffffc02036bc:	06600593          	li	a1,102
ffffffffc02036c0:	00003517          	auipc	a0,0x3
ffffffffc02036c4:	e8850513          	addi	a0,a0,-376 # ffffffffc0206548 <etext+0x16cc>
ffffffffc02036c8:	d6bfc0ef          	jal	ffffffffc0200432 <__panic>
    assert(pgfault_num==6);
ffffffffc02036cc:	00003697          	auipc	a3,0x3
ffffffffc02036d0:	f4468693          	addi	a3,a3,-188 # ffffffffc0206610 <etext+0x1794>
ffffffffc02036d4:	00002617          	auipc	a2,0x2
ffffffffc02036d8:	09c60613          	addi	a2,a2,156 # ffffffffc0205770 <etext+0x8f4>
ffffffffc02036dc:	06300593          	li	a1,99
ffffffffc02036e0:	00003517          	auipc	a0,0x3
ffffffffc02036e4:	e6850513          	addi	a0,a0,-408 # ffffffffc0206548 <etext+0x16cc>
ffffffffc02036e8:	d4bfc0ef          	jal	ffffffffc0200432 <__panic>
    assert(pgfault_num==5);
ffffffffc02036ec:	00003697          	auipc	a3,0x3
ffffffffc02036f0:	f1468693          	addi	a3,a3,-236 # ffffffffc0206600 <etext+0x1784>
ffffffffc02036f4:	00002617          	auipc	a2,0x2
ffffffffc02036f8:	07c60613          	addi	a2,a2,124 # ffffffffc0205770 <etext+0x8f4>
ffffffffc02036fc:	06000593          	li	a1,96
ffffffffc0203700:	00003517          	auipc	a0,0x3
ffffffffc0203704:	e4850513          	addi	a0,a0,-440 # ffffffffc0206548 <etext+0x16cc>
ffffffffc0203708:	d2bfc0ef          	jal	ffffffffc0200432 <__panic>
    assert(pgfault_num==5);
ffffffffc020370c:	00003697          	auipc	a3,0x3
ffffffffc0203710:	ef468693          	addi	a3,a3,-268 # ffffffffc0206600 <etext+0x1784>
ffffffffc0203714:	00002617          	auipc	a2,0x2
ffffffffc0203718:	05c60613          	addi	a2,a2,92 # ffffffffc0205770 <etext+0x8f4>
ffffffffc020371c:	05d00593          	li	a1,93
ffffffffc0203720:	00003517          	auipc	a0,0x3
ffffffffc0203724:	e2850513          	addi	a0,a0,-472 # ffffffffc0206548 <etext+0x16cc>
ffffffffc0203728:	d0bfc0ef          	jal	ffffffffc0200432 <__panic>
    assert(pgfault_num==4);
ffffffffc020372c:	00003697          	auipc	a3,0x3
ffffffffc0203730:	c4468693          	addi	a3,a3,-956 # ffffffffc0206370 <etext+0x14f4>
ffffffffc0203734:	00002617          	auipc	a2,0x2
ffffffffc0203738:	03c60613          	addi	a2,a2,60 # ffffffffc0205770 <etext+0x8f4>
ffffffffc020373c:	05a00593          	li	a1,90
ffffffffc0203740:	00003517          	auipc	a0,0x3
ffffffffc0203744:	e0850513          	addi	a0,a0,-504 # ffffffffc0206548 <etext+0x16cc>
ffffffffc0203748:	cebfc0ef          	jal	ffffffffc0200432 <__panic>
    assert(pgfault_num==4);
ffffffffc020374c:	00003697          	auipc	a3,0x3
ffffffffc0203750:	c2468693          	addi	a3,a3,-988 # ffffffffc0206370 <etext+0x14f4>
ffffffffc0203754:	00002617          	auipc	a2,0x2
ffffffffc0203758:	01c60613          	addi	a2,a2,28 # ffffffffc0205770 <etext+0x8f4>
ffffffffc020375c:	05700593          	li	a1,87
ffffffffc0203760:	00003517          	auipc	a0,0x3
ffffffffc0203764:	de850513          	addi	a0,a0,-536 # ffffffffc0206548 <etext+0x16cc>
ffffffffc0203768:	ccbfc0ef          	jal	ffffffffc0200432 <__panic>
    assert(pgfault_num==4);
ffffffffc020376c:	00003697          	auipc	a3,0x3
ffffffffc0203770:	c0468693          	addi	a3,a3,-1020 # ffffffffc0206370 <etext+0x14f4>
ffffffffc0203774:	00002617          	auipc	a2,0x2
ffffffffc0203778:	ffc60613          	addi	a2,a2,-4 # ffffffffc0205770 <etext+0x8f4>
ffffffffc020377c:	05400593          	li	a1,84
ffffffffc0203780:	00003517          	auipc	a0,0x3
ffffffffc0203784:	dc850513          	addi	a0,a0,-568 # ffffffffc0206548 <etext+0x16cc>
...
ffffffffc02037b2:	eea68693          	addi	a3,a3,-278 # ffffffffc0206698 <etext+0x181c>
ffffffffc02037b6:	00002617          	auipc	a2,0x2
ffffffffc02037ba:	fba60613          	addi	a2,a2,-70 # ffffffffc0205770 <etext+0x8f4>
ffffffffc02037be:	04100593          	li	a1,65
ffffffffc02037c2:	00003517          	auipc	a0,0x3
ffffffffc02037c6:	d8650513          	addi	a0,a0,-634 # ffffffffc0206548 <etext+0x16cc>
ffffffffc02037ca:	c69fc0ef          	jal	ffffffffc0200432 <__panic>
     assert(in_tick==0);
ffffffffc02037ce:	00003697          	auipc	a3,0x3
ffffffffc02037d2:	eda68693          	addi	a3,a3,-294 # ffffffffc02066a8 <etext+0x182c>
ffffffffc02037d6:	00002617          	auipc	a2,0x2
ffffffffc02037da:	f9a60613          	addi	a2,a2,-102 # ffffffffc0205770 <etext+0x8f4>
ffffffffc02037de:	04200593          	li	a1,66
ffffffffc02037e2:	00003517          	auipc	a0,0x3
ffffffffc02037e6:	d6650513          	addi	a0,a0,-666 # ffffffffc0206548 <etext+0x16cc>
...
ffffffffc020380a:	eb268693          	addi	a3,a3,-334 # ffffffffc02066b8 <etext+0x183c>
ffffffffc020380e:	00002617          	auipc	a2,0x2
ffffffffc0203812:	f6260613          	addi	a2,a2,-158 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0203816:	03200593          	li	a1,50
ffffffffc020381a:	00003517          	auipc	a0,0x3
ffffffffc020381e:	d2e50513          	addi	a0,a0,-722 # ffffffffc0206548 <etext+0x16cc>
{
...
ffffffffc020382e:	ec668693          	addi	a3,a3,-314 # ffffffffc02066f0 <etext+0x1874>
ffffffffc0203832:	00002617          	auipc	a2,0x2
ffffffffc0203836:	f3e60613          	addi	a2,a2,-194 # ffffffffc0205770 <etext+0x8f4>
ffffffffc020383a:	07e00593          	li	a1,126
ffffffffc020383e:	00003517          	auipc	a0,0x3
ffffffffc0203842:	ed250513          	addi	a0,a0,-302 # ffffffffc0206710 <etext+0x1894>
check_vma_overlap(struct vma_struct *prev, struct vma_struct *next) {
...
ffffffffc0203976:	dae68693          	addi	a3,a3,-594 # ffffffffc0206720 <etext+0x18a4>
ffffffffc020397a:	00002617          	auipc	a2,0x2
ffffffffc020397e:	df660613          	addi	a2,a2,-522 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0203982:	08500593          	li	a1,133
ffffffffc0203986:	00003517          	auipc	a0,0x3
ffffffffc020398a:	d8a50513          	addi	a0,a0,-630 # ffffffffc0206710 <etext+0x1894>
ffffffffc020398e:	aa5fc0ef          	jal	ffffffffc0200432 <__panic>
    assert(prev->vm_end <= next->vm_start);
ffffffffc0203992:	00003697          	auipc	a3,0x3
ffffffffc0203996:	dce68693          	addi	a3,a3,-562 # ffffffffc0206760 <etext+0x18e4>
ffffffffc020399a:	00002617          	auipc	a2,0x2
ffffffffc020399e:	dd660613          	addi	a2,a2,-554 # ffffffffc0205770 <etext+0x8f4>
ffffffffc02039a2:	07d00593          	li	a1,125
ffffffffc02039a6:	00003517          	auipc	a0,0x3
ffffffffc02039aa:	d6a50513          	addi	a0,a0,-662 # ffffffffc0206710 <etext+0x1894>
ffffffffc02039ae:	a85fc0ef          	jal	ffffffffc0200432 <__panic>
    assert(prev->vm_start < prev->vm_end);
ffffffffc02039b2:	00003697          	auipc	a3,0x3
ffffffffc02039b6:	d8e68693          	addi	a3,a3,-626 # ffffffffc0206740 <etext+0x18c4>
ffffffffc02039ba:	00002617          	auipc	a2,0x2
ffffffffc02039be:	db660613          	addi	a2,a2,-586 # ffffffffc0205770 <etext+0x8f4>
ffffffffc02039c2:	07c00593          	li	a1,124
ffffffffc02039c6:	00003517          	auipc	a0,0x3
ffffffffc02039ca:	d4a50513          	addi	a0,a0,-694 # ffffffffc0206710 <etext+0x1894>
...
ffffffffc0203b7c:	d4850513          	addi	a0,a0,-696 # ffffffffc02068c0 <etext+0x1a44>
...
ffffffffc0203c52:	31aa3a03          	ld	s4,794(s4) # ffffffffc0206f68 <nbase>
...
ffffffffc0203d0c:	c4850513          	addi	a0,a0,-952 # ffffffffc0206950 <etext+0x1ad4>
...
ffffffffc0203d28:	c4c50513          	addi	a0,a0,-948 # ffffffffc0206970 <etext+0x1af4>
}
...
ffffffffc0203d3c:	4f868693          	addi	a3,a3,1272 # ffffffffc0206230 <etext+0x13b4>
ffffffffc0203d40:	00002617          	auipc	a2,0x2
ffffffffc0203d44:	a3060613          	addi	a2,a2,-1488 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0203d48:	0c900593          	li	a1,201
ffffffffc0203d4c:	00003517          	auipc	a0,0x3
ffffffffc0203d50:	9c450513          	addi	a0,a0,-1596 # ffffffffc0206710 <etext+0x1894>
ffffffffc0203d54:	edefc0ef          	jal	ffffffffc0200432 <__panic>
    assert(mm != NULL);
ffffffffc0203d58:	00002697          	auipc	a3,0x2
ffffffffc0203d5c:	4a068693          	addi	a3,a3,1184 # ffffffffc02061f8 <etext+0x137c>
ffffffffc0203d60:	00002617          	auipc	a2,0x2
ffffffffc0203d64:	a1060613          	addi	a2,a2,-1520 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0203d68:	0c200593          	li	a1,194
ffffffffc0203d6c:	00003517          	auipc	a0,0x3
ffffffffc0203d70:	9a450513          	addi	a0,a0,-1628 # ffffffffc0206710 <etext+0x1894>
ffffffffc0203d74:	ebefc0ef          	jal	ffffffffc0200432 <__panic>
        assert(vma != NULL);
ffffffffc0203d78:	00002697          	auipc	a3,0x2
ffffffffc0203d7c:	4b868693          	addi	a3,a3,1208 # ffffffffc0206230 <etext+0x13b4>
ffffffffc0203d80:	00002617          	auipc	a2,0x2
ffffffffc0203d84:	9f060613          	addi	a2,a2,-1552 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0203d88:	0cf00593          	li	a1,207
ffffffffc0203d8c:	00003517          	auipc	a0,0x3
ffffffffc0203d90:	98450513          	addi	a0,a0,-1660 # ffffffffc0206710 <etext+0x1894>
ffffffffc0203d94:	e9efc0ef          	jal	ffffffffc0200432 <__panic>
    assert(vma != NULL);
ffffffffc0203d98:	00002697          	auipc	a3,0x2
ffffffffc0203d9c:	49868693          	addi	a3,a3,1176 # ffffffffc0206230 <etext+0x13b4>
ffffffffc0203da0:	00002617          	auipc	a2,0x2
ffffffffc0203da4:	9d060613          	addi	a2,a2,-1584 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0203da8:	10800593          	li	a1,264
ffffffffc0203dac:	00003517          	auipc	a0,0x3
ffffffffc0203db0:	96450513          	addi	a0,a0,-1692 # ffffffffc0206710 <etext+0x1894>
ffffffffc0203db4:	e7efc0ef          	jal	ffffffffc0200432 <__panic>
    assert(check_mm_struct != NULL);
ffffffffc0203db8:	00003697          	auipc	a3,0x3
ffffffffc0203dbc:	b2868693          	addi	a3,a3,-1240 # ffffffffc02068e0 <etext+0x1a64>
ffffffffc0203dc0:	00002617          	auipc	a2,0x2
ffffffffc0203dc4:	9b060613          	addi	a2,a2,-1616 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0203dc8:	10100593          	li	a1,257
ffffffffc0203dcc:	00003517          	auipc	a0,0x3
ffffffffc0203dd0:	94450513          	addi	a0,a0,-1724 # ffffffffc0206710 <etext+0x1894>
    check_mm_struct = mm_create();
...
ffffffffc0203dea:	a6a68693          	addi	a3,a3,-1430 # ffffffffc0206850 <etext+0x19d4>
ffffffffc0203dee:	00002617          	auipc	a2,0x2
ffffffffc0203df2:	98260613          	addi	a2,a2,-1662 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0203df6:	0e900593          	li	a1,233
ffffffffc0203dfa:	00003517          	auipc	a0,0x3
ffffffffc0203dfe:	91650513          	addi	a0,a0,-1770 # ffffffffc0206710 <etext+0x1894>
ffffffffc0203e02:	e30fc0ef          	jal	ffffffffc0200432 <__panic>
        assert(vma1->vm_start == i  && vma1->vm_end == i  + 2);
ffffffffc0203e06:	00003697          	auipc	a3,0x3
ffffffffc0203e0a:	a1a68693          	addi	a3,a3,-1510 # ffffffffc0206820 <etext+0x19a4>
ffffffffc0203e0e:	00002617          	auipc	a2,0x2
ffffffffc0203e12:	96260613          	addi	a2,a2,-1694 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0203e16:	0e800593          	li	a1,232
ffffffffc0203e1a:	00003517          	auipc	a0,0x3
ffffffffc0203e1e:	8f650513          	addi	a0,a0,-1802 # ffffffffc0206710 <etext+0x1894>
ffffffffc0203e22:	e10fc0ef          	jal	ffffffffc0200432 <__panic>
        assert(mmap->vm_start == i * 5 && mmap->vm_end == i * 5 + 2);
ffffffffc0203e26:	00003697          	auipc	a3,0x3
ffffffffc0203e2a:	97268693          	addi	a3,a3,-1678 # ffffffffc0206798 <etext+0x191c>
ffffffffc0203e2e:	00002617          	auipc	a2,0x2
ffffffffc0203e32:	94260613          	addi	a2,a2,-1726 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0203e36:	0d800593          	li	a1,216
ffffffffc0203e3a:	00003517          	auipc	a0,0x3
ffffffffc0203e3e:	8d650513          	addi	a0,a0,-1834 # ffffffffc0206710 <etext+0x1894>
ffffffffc0203e42:	df0fc0ef          	jal	ffffffffc0200432 <__panic>
        assert(le != &(mm->mmap_list));
ffffffffc0203e46:	00003697          	auipc	a3,0x3
ffffffffc0203e4a:	93a68693          	addi	a3,a3,-1734 # ffffffffc0206780 <etext+0x1904>
ffffffffc0203e4e:	00002617          	auipc	a2,0x2
ffffffffc0203e52:	92260613          	addi	a2,a2,-1758 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0203e56:	0d600593          	li	a1,214
ffffffffc0203e5a:	00003517          	auipc	a0,0x3
ffffffffc0203e5e:	8b650513          	addi	a0,a0,-1866 # ffffffffc0206710 <etext+0x1894>
ffffffffc0203e62:	dd0fc0ef          	jal	ffffffffc0200432 <__panic>
        assert(vma2 != NULL);
ffffffffc0203e66:	00003697          	auipc	a3,0x3
ffffffffc0203e6a:	97a68693          	addi	a3,a3,-1670 # ffffffffc02067e0 <etext+0x1964>
ffffffffc0203e6e:	00002617          	auipc	a2,0x2
ffffffffc0203e72:	90260613          	addi	a2,a2,-1790 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0203e76:	0e000593          	li	a1,224
ffffffffc0203e7a:	00003517          	auipc	a0,0x3
ffffffffc0203e7e:	89650513          	addi	a0,a0,-1898 # ffffffffc0206710 <etext+0x1894>
ffffffffc0203e82:	db0fc0ef          	jal	ffffffffc0200432 <__panic>
        assert(vma1 != NULL);
ffffffffc0203e86:	00003697          	auipc	a3,0x3
ffffffffc0203e8a:	94a68693          	addi	a3,a3,-1718 # ffffffffc02067d0 <etext+0x1954>
ffffffffc0203e8e:	00002617          	auipc	a2,0x2
ffffffffc0203e92:	8e260613          	addi	a2,a2,-1822 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0203e96:	0de00593          	li	a1,222
ffffffffc0203e9a:	00003517          	auipc	a0,0x3
ffffffffc0203e9e:	87650513          	addi	a0,a0,-1930 # ffffffffc0206710 <etext+0x1894>
ffffffffc0203ea2:	d90fc0ef          	jal	ffffffffc0200432 <__panic>
        assert(vma5 == NULL);
ffffffffc0203ea6:	00003697          	auipc	a3,0x3
ffffffffc0203eaa:	96a68693          	addi	a3,a3,-1686 # ffffffffc0206810 <etext+0x1994>
ffffffffc0203eae:	00002617          	auipc	a2,0x2
ffffffffc0203eb2:	8c260613          	addi	a2,a2,-1854 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0203eb6:	0e600593          	li	a1,230
ffffffffc0203eba:	00003517          	auipc	a0,0x3
ffffffffc0203ebe:	85650513          	addi	a0,a0,-1962 # ffffffffc0206710 <etext+0x1894>
ffffffffc0203ec2:	d70fc0ef          	jal	ffffffffc0200432 <__panic>
        assert(vma4 == NULL);
ffffffffc0203ec6:	00003697          	auipc	a3,0x3
ffffffffc0203eca:	93a68693          	addi	a3,a3,-1734 # ffffffffc0206800 <etext+0x1984>
ffffffffc0203ece:	00002617          	auipc	a2,0x2
ffffffffc0203ed2:	8a260613          	addi	a2,a2,-1886 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0203ed6:	0e400593          	li	a1,228
ffffffffc0203eda:	00003517          	auipc	a0,0x3
ffffffffc0203ede:	83650513          	addi	a0,a0,-1994 # ffffffffc0206710 <etext+0x1894>
ffffffffc0203ee2:	d50fc0ef          	jal	ffffffffc0200432 <__panic>
        assert(vma3 == NULL);
ffffffffc0203ee6:	00003697          	auipc	a3,0x3
ffffffffc0203eea:	90a68693          	addi	a3,a3,-1782 # ffffffffc02067f0 <etext+0x1974>
ffffffffc0203eee:	00002617          	auipc	a2,0x2
ffffffffc0203ef2:	88260613          	addi	a2,a2,-1918 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0203ef6:	0e200593          	li	a1,226
ffffffffc0203efa:	00003517          	auipc	a0,0x3
ffffffffc0203efe:	81650513          	addi	a0,a0,-2026 # ffffffffc0206710 <etext+0x1894>
...
ffffffffc0203f12:	97250513          	addi	a0,a0,-1678 # ffffffffc0206880 <etext+0x1a04>
ffffffffc0203f16:	a6afc0ef          	jal	ffffffffc0200180 <cprintf>
        assert(vma_below_5 == NULL);
ffffffffc0203f1a:	00003697          	auipc	a3,0x3
ffffffffc0203f1e:	98e68693          	addi	a3,a3,-1650 # ffffffffc02068a8 <etext+0x1a2c>
ffffffffc0203f22:	00002617          	auipc	a2,0x2
ffffffffc0203f26:	84e60613          	addi	a2,a2,-1970 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0203f2a:	0f100593          	li	a1,241
ffffffffc0203f2e:	00002517          	auipc	a0,0x2
ffffffffc0203f32:	7e250513          	addi	a0,a0,2018 # ffffffffc0206710 <etext+0x1894>
ffffffffc0203f36:	cfcfc0ef          	jal	ffffffffc0200432 <__panic>
    return KADDR(page2pa(page));
ffffffffc0203f3a:	00002617          	auipc	a2,0x2
ffffffffc0203f3e:	be660613          	addi	a2,a2,-1050 # ffffffffc0205b20 <etext+0xca4>
ffffffffc0203f42:	06900593          	li	a1,105
ffffffffc0203f46:	00002517          	auipc	a0,0x2
ffffffffc0203f4a:	c0250513          	addi	a0,a0,-1022 # ffffffffc0205b48 <etext+0xccc>
ffffffffc0203f4e:	ce4fc0ef          	jal	ffffffffc0200432 <__panic>
        panic("pa2page called with invalid pa");
ffffffffc0203f52:	00002617          	auipc	a2,0x2
ffffffffc0203f56:	c9e60613          	addi	a2,a2,-866 # ffffffffc0205bf0 <etext+0xd74>
ffffffffc0203f5a:	06200593          	li	a1,98
ffffffffc0203f5e:	00002517          	auipc	a0,0x2
ffffffffc0203f62:	bea50513          	addi	a0,a0,-1046 # ffffffffc0205b48 <etext+0xccc>
ffffffffc0203f66:	cccfc0ef          	jal	ffffffffc0200432 <__panic>
    assert(sum == 0);
ffffffffc0203f6a:	00003697          	auipc	a3,0x3
ffffffffc0203f6e:	9ae68693          	addi	a3,a3,-1618 # ffffffffc0206918 <etext+0x1a9c>
ffffffffc0203f72:	00001617          	auipc	a2,0x1
ffffffffc0203f76:	7fe60613          	addi	a2,a2,2046 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0203f7a:	11700593          	li	a1,279
ffffffffc0203f7e:	00002517          	auipc	a0,0x2
ffffffffc0203f82:	79250513          	addi	a0,a0,1938 # ffffffffc0206710 <etext+0x1894>
ffffffffc0203f86:	cacfc0ef          	jal	ffffffffc0200432 <__panic>
    assert(find_vma(mm, addr) == vma);
ffffffffc0203f8a:	00003697          	auipc	a3,0x3
ffffffffc0203f8e:	96e68693          	addi	a3,a3,-1682 # ffffffffc02068f8 <etext+0x1a7c>
ffffffffc0203f92:	00001617          	auipc	a2,0x1
ffffffffc0203f96:	7de60613          	addi	a2,a2,2014 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0203f9a:	10d00593          	li	a1,269
ffffffffc0203f9e:	00002517          	auipc	a0,0x2
ffffffffc0203fa2:	77250513          	addi	a0,a0,1906 # ffffffffc0206710 <etext+0x1894>
ffffffffc0203fa6:	c8cfc0ef          	jal	ffffffffc0200432 <__panic>
    assert(pgdir[0] == 0);
ffffffffc0203faa:	00002697          	auipc	a3,0x2
ffffffffc0203fae:	27668693          	addi	a3,a3,630 # ffffffffc0206220 <etext+0x13a4>
ffffffffc0203fb2:	00001617          	auipc	a2,0x1
ffffffffc0203fb6:	7be60613          	addi	a2,a2,1982 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0203fba:	10500593          	li	a1,261
ffffffffc0203fbe:	00002517          	auipc	a0,0x2
ffffffffc0203fc2:	75250513          	addi	a0,a0,1874 # ffffffffc0206710 <etext+0x1894>
ffffffffc0203fc6:	c6cfc0ef          	jal	ffffffffc0200432 <__panic>
    assert(nr_free_pages_store == nr_free_pages());
ffffffffc0203fca:	00003697          	auipc	a3,0x3
ffffffffc0203fce:	95e68693          	addi	a3,a3,-1698 # ffffffffc0206928 <etext+0x1aac>
ffffffffc0203fd2:	00001617          	auipc	a2,0x1
ffffffffc0203fd6:	79e60613          	addi	a2,a2,1950 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0203fda:	12400593          	li	a1,292
ffffffffc0203fde:	00002517          	auipc	a0,0x2
ffffffffc0203fe2:	73250513          	addi	a0,a0,1842 # ffffffffc0206710 <etext+0x1894>
...
ffffffffc0204070:	6145                	addi	sp,sp,48
...
ffffffffc0204088:	95450513          	addi	a0,a0,-1708 # ffffffffc02069d8 <etext+0x1b5c>
...
ffffffffc020409c:	8f050513          	addi	a0,a0,-1808 # ffffffffc0206988 <etext+0x1b0c>
...
ffffffffc02040ac:	95850513          	addi	a0,a0,-1704 # ffffffffc0206a00 <etext+0x1b84>
...
ffffffffc02040ba:	90250513          	addi	a0,a0,-1790 # ffffffffc02069b8 <etext+0x1b3c>
...
ffffffffc02040d6:	60a2                	ld	ra,8(sp)
    max_swap_offset = ide_device_size(SWAP_DEV_NO) / (PGSIZE / SECTSIZE);
ffffffffc02040d8:	810d                	srli	a0,a0,0x3
...
ffffffffc02040ea:	94260613          	addi	a2,a2,-1726 # ffffffffc0206a28 <etext+0x1bac>
ffffffffc02040ee:	45b5                	li	a1,13
ffffffffc02040f0:	00003517          	auipc	a0,0x3
ffffffffc02040f4:	95850513          	addi	a0,a0,-1704 # ffffffffc0206a48 <etext+0x1bcc>
...
ffffffffc0204100:	00855793          	srli	a5,a0,0x8
...
ffffffffc020411c:	4065d613          	srai	a2,a1,0x6
ffffffffc0204120:	00003717          	auipc	a4,0x3
ffffffffc0204124:	e4873703          	ld	a4,-440(a4) # ffffffffc0206f68 <nbase>
ffffffffc0204128:	963a                	add	a2,a2,a4
    return KADDR(page2pa(page));
ffffffffc020412a:	00c61713          	slli	a4,a2,0xc
...
ffffffffc0204138:	0037959b          	slliw	a1,a5,0x3
    return page2ppn(page) << PGSHIFT;
ffffffffc020413c:	0632                	slli	a2,a2,0xc
    return KADDR(page2pa(page));
...
ffffffffc020415e:	90660613          	addi	a2,a2,-1786 # ffffffffc0206a60 <etext+0x1be4>
ffffffffc0204162:	45d1                	li	a1,20
ffffffffc0204164:	00003517          	auipc	a0,0x3
ffffffffc0204168:	8e450513          	addi	a0,a0,-1820 # ffffffffc0206a48 <etext+0x1bcc>
...
ffffffffc020417a:	9aa60613          	addi	a2,a2,-1622 # ffffffffc0205b20 <etext+0xca4>
ffffffffc020417e:	00002517          	auipc	a0,0x2
ffffffffc0204182:	9ca50513          	addi	a0,a0,-1590 # ffffffffc0205b48 <etext+0xccc>
...
ffffffffc020418a:	1141                	addi	sp,sp,-16
ffffffffc020418c:	e406                	sd	ra,8(sp)
    return ide_write_secs(SWAP_DEV_NO, swap_offset(entry) * PAGE_NSECT, page2kva(page), PAGE_NSECT);
ffffffffc020418e:	00855793          	srli	a5,a0,0x8
...
ffffffffc02041aa:	4065d613          	srai	a2,a1,0x6
ffffffffc02041ae:	00003717          	auipc	a4,0x3
ffffffffc02041b2:	dba73703          	ld	a4,-582(a4) # ffffffffc0206f68 <nbase>
ffffffffc02041b6:	963a                	add	a2,a2,a4
    return KADDR(page2pa(page));
ffffffffc02041b8:	00c61713          	slli	a4,a2,0xc
ffffffffc02041bc:	8331                	srli	a4,a4,0xc
ffffffffc02041be:	00011697          	auipc	a3,0x11
ffffffffc02041c2:	3ba6b683          	ld	a3,954(a3) # ffffffffc0215578 <npage>
ffffffffc02041c6:	0037959b          	slliw	a1,a5,0x3
    return page2ppn(page) << PGSHIFT;
ffffffffc02041ca:	0632                	slli	a2,a2,0xc
    return KADDR(page2pa(page));
...
ffffffffc02041ec:	87860613          	addi	a2,a2,-1928 # ffffffffc0206a60 <etext+0x1be4>
ffffffffc02041f0:	45e5                	li	a1,25
ffffffffc02041f2:	00003517          	auipc	a0,0x3
ffffffffc02041f6:	85650513          	addi	a0,a0,-1962 # ffffffffc0206a48 <etext+0x1bcc>
...
ffffffffc0204208:	91c60613          	addi	a2,a2,-1764 # ffffffffc0205b20 <etext+0xca4>
ffffffffc020420c:	00002517          	auipc	a0,0x2
ffffffffc0204210:	93c50513          	addi	a0,a0,-1732 # ffffffffc0205b48 <etext+0xccc>
...
ffffffffc020421a:	9402                	jalr	s0
	...
	jal do_exit
ffffffffc020421c:	3cc000ef          	jal	ffffffffc02045e8 <do_exit>
...
alloc_proc(void) {
ffffffffc0204220:	1141                	addi	sp,sp,-16
...
ffffffffc0204234:	1782                	slli	a5,a5,0x20
ffffffffc0204236:	e11c                	sd	a5,0(a0)
        ...
        proc->cr3 = boot_cr3;
ffffffffc0204238:	00011797          	auipc	a5,0x11
ffffffffc020423c:	3287b783          	ld	a5,808(a5) # ffffffffc0215560 <boot_cr3>
        proc->kstack = 0;
ffffffffc0204240:	00053823          	sd	zero,16(a0)
        proc->runs = 0;
...
ffffffffc0204250:	02053423          	sd	zero,40(a0)
        proc->tf = NULL;
ffffffffc0204254:	0a053023          	sd	zero,160(a0)
        proc->flags = 0;
ffffffffc0204258:	0a052823          	sw	zero,176(a0)
        proc->cr3 = boot_cr3;
ffffffffc020425c:	f55c                	sd	a5,168(a0)

        memset(&(proc->context), 0, sizeof(struct context)); 
ffffffffc020425e:	07000613          	li	a2,112
ffffffffc0204262:	4581                	li	a1,0
ffffffffc0204264:	03050513          	addi	a0,a0,48
ffffffffc0204268:	3c7000ef          	jal	ffffffffc0204e2e <memset>
        memset(proc->name, 0, PROC_NAME_LEN + 1);
ffffffffc020426c:	4641                	li	a2,16
ffffffffc020426e:	4581                	li	a1,0
ffffffffc0204270:	0b440513          	addi	a0,s0,180
ffffffffc0204274:	3bb000ef          	jal	ffffffffc0204e2e <memset>
...
ffffffffc020427e:	0141                	addi	sp,sp,16
...
static int
init_main(void *arg) {
ffffffffc0204290:	1101                	addi	sp,sp,-32
...
ffffffffc02042a8:	27450513          	addi	a0,a0,628 # ffffffffc0211518 <name.2>
init_main(void *arg) {
...
ffffffffc02042b0:	0044a903          	lw	s2,4(s1)
    memset(name, 0, sizeof(name));
ffffffffc02042b4:	37b000ef          	jal	ffffffffc0204e2e <memset>
    return memcpy(name, proc->name, PROC_NAME_LEN);
ffffffffc02042b8:	0b448593          	addi	a1,s1,180
ffffffffc02042bc:	463d                	li	a2,15
ffffffffc02042be:	0000d517          	auipc	a0,0xd
ffffffffc02042c2:	25a50513          	addi	a0,a0,602 # ffffffffc0211518 <name.2>
ffffffffc02042c6:	37b000ef          	jal	ffffffffc0204e40 <memcpy>
ffffffffc02042ca:	862a                	mv	a2,a0
    cprintf("this initproc, pid = %d, name = \"%s\"\n", current->pid, get_proc_name(current));
ffffffffc02042cc:	85ca                	mv	a1,s2
ffffffffc02042ce:	00002517          	auipc	a0,0x2
ffffffffc02042d2:	7b250513          	addi	a0,a0,1970 # ffffffffc0206a80 <etext+0x1c04>
...
ffffffffc02042e0:	7cc50513          	addi	a0,a0,1996 # ffffffffc0206aa8 <etext+0x1c2c>
ffffffffc02042e4:	e9dfb0ef          	jal	ffffffffc0200180 <cprintf>
    cprintf("To U: \"en.., Bye, Bye. :)\"\n");
ffffffffc02042e8:	00002517          	auipc	a0,0x2
ffffffffc02042ec:	7d050513          	addi	a0,a0,2000 # ffffffffc0206ab8 <etext+0x1c3c>
...
ffffffffc0204302:	7179                	addi	sp,sp,-48
ffffffffc0204304:	ec4a                	sd	s2,24(sp)
    if (proc != current) {
ffffffffc0204306:	00011917          	auipc	s2,0x11
ffffffffc020430a:	2b290913          	addi	s2,s2,690 # ffffffffc02155b8 <current>
proc_run(struct proc_struct *proc) {
...
ffffffffc020433a:	03050593          	addi	a1,a0,48
ffffffffc020433e:	03048513          	addi	a0,s1,48
ffffffffc0204342:	528000ef          	jal	ffffffffc020486a <switch_to>
    if (flag) {
...
ffffffffc0204370:	7179                	addi	sp,sp,-48
ffffffffc0204372:	e84a                	sd	s2,16(sp)
    if (nr_process >= MAX_PROCESS) {
ffffffffc0204374:	00011917          	auipc	s2,0x11
ffffffffc0204378:	23c90913          	addi	s2,s2,572 # ffffffffc02155b0 <nr_process>
ffffffffc020437c:	00092703          	lw	a4,0(s2)
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
ffffffffc0204380:	f406                	sd	ra,40(sp)
    if (nr_process >= MAX_PROCESS) {
ffffffffc0204382:	6785                	lui	a5,0x1
ffffffffc0204384:	1cf75c63          	bge	a4,a5,ffffffffc020455c <do_fork+0x1ec>
ffffffffc0204388:	f022                	sd	s0,32(sp)
ffffffffc020438a:	ec26                	sd	s1,24(sp)
ffffffffc020438c:	e44e                	sd	s3,8(sp)
ffffffffc020438e:	e052                	sd	s4,0(sp)
ffffffffc0204390:	89ae                	mv	s3,a1
ffffffffc0204392:	8432                	mv	s0,a2
    proc->parent = current;
ffffffffc0204394:	00011a17          	auipc	s4,0x11
ffffffffc0204398:	224a0a13          	addi	s4,s4,548 # ffffffffc02155b8 <current>
    proc= alloc_proc();
ffffffffc020439c:	e85ff0ef          	jal	ffffffffc0204220 <alloc_proc>
    proc->parent = current;
ffffffffc02043a0:	000a3783          	ld	a5,0(s4)
    proc= alloc_proc();
ffffffffc02043a4:	84aa                	mv	s1,a0
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc02043a6:	4509                	li	a0,2
    proc->parent = current;
ffffffffc02043a8:	f09c                	sd	a5,32(s1)
    struct Page *page = alloc_pages(KSTACKPAGE);
ffffffffc02043aa:	e56fd0ef          	jal	ffffffffc0201a00 <alloc_pages>
    if (page != NULL) {
ffffffffc02043ae:	18050e63          	beqz	a0,ffffffffc020454a <do_fork+0x1da>
    return page - pages + nbase;
ffffffffc02043b2:	00011797          	auipc	a5,0x11
ffffffffc02043b6:	1ce7b783          	ld	a5,462(a5) # ffffffffc0215580 <pages>
ffffffffc02043ba:	40f506b3          	sub	a3,a0,a5
ffffffffc02043be:	8699                	srai	a3,a3,0x6
ffffffffc02043c0:	00003797          	auipc	a5,0x3
ffffffffc02043c4:	ba87b783          	ld	a5,-1112(a5) # ffffffffc0206f68 <nbase>
ffffffffc02043c8:	96be                	add	a3,a3,a5
    return KADDR(page2pa(page));
ffffffffc02043ca:	00c69793          	slli	a5,a3,0xc
ffffffffc02043ce:	83b1                	srli	a5,a5,0xc
ffffffffc02043d0:	00011717          	auipc	a4,0x11
ffffffffc02043d4:	1a873703          	ld	a4,424(a4) # ffffffffc0215578 <npage>
    return page2ppn(page) << PGSHIFT;
ffffffffc02043d8:	06b2                	slli	a3,a3,0xc
    return KADDR(page2pa(page));
ffffffffc02043da:	1ae7f363          	bgeu	a5,a4,ffffffffc0204580 <do_fork+0x210>
    assert(current->mm == NULL);
ffffffffc02043de:	000a3783          	ld	a5,0(s4)
ffffffffc02043e2:	00011717          	auipc	a4,0x11
ffffffffc02043e6:	18e73703          	ld	a4,398(a4) # ffffffffc0215570 <va_pa_offset>
ffffffffc02043ea:	96ba                	add	a3,a3,a4
ffffffffc02043ec:	779c                	ld	a5,40(a5)
        proc->kstack = (uintptr_t)page2kva(page);
ffffffffc02043ee:	e894                	sd	a3,16(s1)
    assert(current->mm == NULL);
ffffffffc02043f0:	16079863          	bnez	a5,ffffffffc0204560 <do_fork+0x1f0>
...
ffffffffc02043fc:	8622                	mv	a2,s0
    proc->tf = (struct trapframe *)(proc->kstack + KSTACKSIZE - sizeof(struct trapframe));
ffffffffc02043fe:	f0d4                	sd	a3,160(s1)
    *(proc->tf) = *tf;
ffffffffc0204400:	87b6                	mv	a5,a3
ffffffffc0204402:	12040593          	addi	a1,s0,288
ffffffffc0204406:	00063883          	ld	a7,0(a2)
ffffffffc020440a:	00863803          	ld	a6,8(a2)
ffffffffc020440e:	6a08                	ld	a0,16(a2)
ffffffffc0204410:	6e18                	ld	a4,24(a2)
ffffffffc0204412:	0117b023          	sd	a7,0(a5)
ffffffffc0204416:	0107b423          	sd	a6,8(a5)
ffffffffc020441a:	eb88                	sd	a0,16(a5)
ffffffffc020441c:	ef98                	sd	a4,24(a5)
ffffffffc020441e:	02060613          	addi	a2,a2,32
ffffffffc0204422:	02078793          	addi	a5,a5,32
ffffffffc0204426:	feb610e3          	bne	a2,a1,ffffffffc0204406 <do_fork+0x96>
    proc->tf->gpr.a0 = 0;
ffffffffc020442a:	0406b823          	sd	zero,80(a3)
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc020442e:	10098663          	beqz	s3,ffffffffc020453a <do_fork+0x1ca>
    if (++ last_pid >= MAX_PID) {
ffffffffc0204432:	00006817          	auipc	a6,0x6
ffffffffc0204436:	c2a80813          	addi	a6,a6,-982 # ffffffffc020a05c <last_pid.1>
ffffffffc020443a:	00082783          	lw	a5,0(a6)
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc020443e:	0136b823          	sd	s3,16(a3)
    proc->context.ra = (uintptr_t)forkret;
ffffffffc0204442:	00000717          	auipc	a4,0x0
ffffffffc0204446:	e4070713          	addi	a4,a4,-448 # ffffffffc0204282 <forkret>
    if (++ last_pid >= MAX_PID) {
ffffffffc020444a:	0017851b          	addiw	a0,a5,1
    proc->context.ra = (uintptr_t)forkret;
ffffffffc020444e:	f898                	sd	a4,48(s1)
    proc->context.sp = (uintptr_t)(proc->tf);
ffffffffc0204450:	fc94                	sd	a3,56(s1)
    if (++ last_pid >= MAX_PID) {
ffffffffc0204452:	00a82023          	sw	a0,0(a6)
ffffffffc0204456:	6789                	lui	a5,0x2
ffffffffc0204458:	06f55b63          	bge	a0,a5,ffffffffc02044ce <do_fork+0x15e>
    if (last_pid >= next_safe) {
ffffffffc020445c:	00006317          	auipc	t1,0x6
ffffffffc0204460:	bfc30313          	addi	t1,t1,-1028 # ffffffffc020a058 <next_safe.0>
...
ffffffffc0204470:	06f55763          	bge	a0,a5,ffffffffc02044de <do_fork+0x16e>
    proc->pid =get_pid();
ffffffffc0204474:	c0c8                	sw	a0,4(s1)
    list_add(hash_list + pid_hashfn(proc->pid), &(proc->hash_link));
ffffffffc0204476:	45a9                	li	a1,10
ffffffffc0204478:	2501                	sext.w	a0,a0
ffffffffc020447a:	520000ef          	jal	ffffffffc020499a <hash32>
ffffffffc020447e:	02051793          	slli	a5,a0,0x20
ffffffffc0204482:	01c7d513          	srli	a0,a5,0x1c
ffffffffc0204486:	0000d797          	auipc	a5,0xd
ffffffffc020448a:	0a278793          	addi	a5,a5,162 # ffffffffc0211528 <hash_list>
ffffffffc020448e:	953e                	add	a0,a0,a5
    __list_add(elm, listelm, listelm->next);
ffffffffc0204490:	6510                	ld	a2,8(a0)
ffffffffc0204492:	0d848793          	addi	a5,s1,216
ffffffffc0204496:	6414                	ld	a3,8(s0)
    prev->next = next->prev = elm;
...
ffffffffc02044a0:	0c848713          	addi	a4,s1,200
    elm->prev = prev;
ffffffffc02044a4:	ece8                	sd	a0,216(s1)
    elm->next = next;
ffffffffc02044a6:	f0f0                	sd	a2,224(s1)
    prev->next = next->prev = elm;
ffffffffc02044a8:	e298                	sd	a4,0(a3)
    elm->prev = prev;
ffffffffc02044aa:	e4e0                	sd	s0,200(s1)
    wakeup_proc(proc);
ffffffffc02044ac:	8526                	mv	a0,s1
    nr_process++;
ffffffffc02044ae:	2785                	addiw	a5,a5,1
    elm->next = next;
ffffffffc02044b0:	e8f4                	sd	a3,208(s1)
    prev->next = next->prev = elm;
ffffffffc02044b2:	e418                	sd	a4,8(s0)
ffffffffc02044b4:	00f92023          	sw	a5,0(s2)
    wakeup_proc(proc);
ffffffffc02044b8:	41c000ef          	jal	ffffffffc02048d4 <wakeup_proc>
    ret = proc->pid;
ffffffffc02044bc:	40c8                	lw	a0,4(s1)
ffffffffc02044be:	7402                	ld	s0,32(sp)
ffffffffc02044c0:	64e2                	ld	s1,24(sp)
ffffffffc02044c2:	69a2                	ld	s3,8(sp)
ffffffffc02044c4:	6a02                	ld	s4,0(sp)
}
ffffffffc02044c6:	70a2                	ld	ra,40(sp)
ffffffffc02044c8:	6942                	ld	s2,16(sp)
ffffffffc02044ca:	6145                	addi	sp,sp,48
...
ffffffffc02044d6:	00006317          	auipc	t1,0x6
ffffffffc02044da:	b8230313          	addi	t1,t1,-1150 # ffffffffc020a058 <next_safe.0>
    return listelm->next;
ffffffffc02044de:	00011417          	auipc	s0,0x11
ffffffffc02044e2:	04a40413          	addi	s0,s0,74 # ffffffffc0215528 <proc_list>
...
ffffffffc02044f2:	4581                	li	a1,0
        while ((le = list_next(le)) != list) {
ffffffffc02044f4:	028e0e63          	beq	t3,s0,ffffffffc0204530 <do_fork+0x1c0>
ffffffffc02044f8:	88ae                	mv	a7,a1
ffffffffc02044fa:	87f2                	mv	a5,t3
ffffffffc02044fc:	6609                	lui	a2,0x2
ffffffffc02044fe:	a811                	j	ffffffffc0204512 <do_fork+0x1a2>
            else if (proc->pid > last_pid && next_safe > proc->pid) {
ffffffffc0204500:	00e6d663          	bge	a3,a4,ffffffffc020450c <do_fork+0x19c>
ffffffffc0204504:	00c75463          	bge	a4,a2,ffffffffc020450c <do_fork+0x19c>
                next_safe = proc->pid;
...
ffffffffc020450c:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc020450e:	00878d63          	beq	a5,s0,ffffffffc0204528 <do_fork+0x1b8>
            if (proc->pid == last_pid) {
ffffffffc0204512:	f3c7a703          	lw	a4,-196(a5) # 1f3c <kern_entry-0xffffffffc01fe0c4>
ffffffffc0204516:	fed715e3          	bne	a4,a3,ffffffffc0204500 <do_fork+0x190>
                if (++ last_pid >= next_safe) {
ffffffffc020451a:	2685                	addiw	a3,a3,1
ffffffffc020451c:	02c6d163          	bge	a3,a2,ffffffffc020453e <do_fork+0x1ce>
ffffffffc0204520:	679c                	ld	a5,8(a5)
ffffffffc0204522:	4585                	li	a1,1
        while ((le = list_next(le)) != list) {
ffffffffc0204524:	fe8797e3          	bne	a5,s0,ffffffffc0204512 <do_fork+0x1a2>
ffffffffc0204528:	00088463          	beqz	a7,ffffffffc0204530 <do_fork+0x1c0>
ffffffffc020452c:	00c32023          	sw	a2,0(t1)
ffffffffc0204530:	d1b1                	beqz	a1,ffffffffc0204474 <do_fork+0x104>
ffffffffc0204532:	00d82023          	sw	a3,0(a6)
            else if (proc->pid > last_pid && next_safe > proc->pid) {
ffffffffc0204536:	8536                	mv	a0,a3
ffffffffc0204538:	bf35                	j	ffffffffc0204474 <do_fork+0x104>
    proc->tf->gpr.sp = (esp == 0) ? (uintptr_t)proc->tf : esp;
ffffffffc020453a:	89b6                	mv	s3,a3
ffffffffc020453c:	bddd                	j	ffffffffc0204432 <do_fork+0xc2>
                    if (last_pid >= MAX_PID) {
ffffffffc020453e:	6789                	lui	a5,0x2
ffffffffc0204540:	00f6c363          	blt	a3,a5,ffffffffc0204546 <do_fork+0x1d6>
                        last_pid = 1;
ffffffffc0204544:	4685                	li	a3,1
                    goto repeat;
ffffffffc0204546:	4585                	li	a1,1
ffffffffc0204548:	b775                	j	ffffffffc02044f4 <do_fork+0x184>
    kfree(proc);
ffffffffc020454a:	8526                	mv	a0,s1
ffffffffc020454c:	b86fd0ef          	jal	ffffffffc02018d2 <kfree>
    ret = -E_NO_MEM;
ffffffffc0204550:	5571                	li	a0,-4
    goto fork_out;
ffffffffc0204552:	7402                	ld	s0,32(sp)
ffffffffc0204554:	64e2                	ld	s1,24(sp)
ffffffffc0204556:	69a2                	ld	s3,8(sp)
ffffffffc0204558:	6a02                	ld	s4,0(sp)
ffffffffc020455a:	b7b5                	j	ffffffffc02044c6 <do_fork+0x156>
    int ret = -E_NO_FREE_PROC;
ffffffffc020455c:	556d                	li	a0,-5
ffffffffc020455e:	b7a5                	j	ffffffffc02044c6 <do_fork+0x156>
    assert(current->mm == NULL);
ffffffffc0204560:	00002697          	auipc	a3,0x2
ffffffffc0204564:	57868693          	addi	a3,a3,1400 # ffffffffc0206ad8 <etext+0x1c5c>
ffffffffc0204568:	00001617          	auipc	a2,0x1
ffffffffc020456c:	20860613          	addi	a2,a2,520 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0204570:	11900593          	li	a1,281
ffffffffc0204574:	00002517          	auipc	a0,0x2
ffffffffc0204578:	57c50513          	addi	a0,a0,1404 # ffffffffc0206af0 <etext+0x1c74>
ffffffffc020457c:	eb7fb0ef          	jal	ffffffffc0200432 <__panic>
ffffffffc0204580:	00001617          	auipc	a2,0x1
ffffffffc0204584:	5a060613          	addi	a2,a2,1440 # ffffffffc0205b20 <etext+0xca4>
ffffffffc0204588:	06900593          	li	a1,105
ffffffffc020458c:	00001517          	auipc	a0,0x1
ffffffffc0204590:	5bc50513          	addi	a0,a0,1468 # ffffffffc0205b48 <etext+0xccc>
ffffffffc0204594:	e9ffb0ef          	jal	ffffffffc0200432 <__panic>

ffffffffc0204598 <kernel_thread>:
kernel_thread(int (*fn)(void *), void *arg, uint32_t clone_flags) {
ffffffffc0204598:	7129                	addi	sp,sp,-320
ffffffffc020459a:	fa22                	sd	s0,304(sp)
ffffffffc020459c:	f626                	sd	s1,296(sp)
ffffffffc020459e:	f24a                	sd	s2,288(sp)
ffffffffc02045a0:	84ae                	mv	s1,a1
ffffffffc02045a2:	892a                	mv	s2,a0
ffffffffc02045a4:	8432                	mv	s0,a2
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc02045a6:	4581                	li	a1,0
ffffffffc02045a8:	12000613          	li	a2,288
ffffffffc02045ac:	850a                	mv	a0,sp
kernel_thread(int (*fn)(void *), void *arg, uint32_t clone_flags) {
ffffffffc02045ae:	fe06                	sd	ra,312(sp)
    memset(&tf, 0, sizeof(struct trapframe));
ffffffffc02045b0:	07f000ef          	jal	ffffffffc0204e2e <memset>
    tf.gpr.s0 = (uintptr_t)fn;
ffffffffc02045b4:	e0ca                	sd	s2,64(sp)
    tf.gpr.s1 = (uintptr_t)arg;
ffffffffc02045b6:	e4a6                	sd	s1,72(sp)
    tf.status = (read_csr(sstatus) | SSTATUS_SPP | SSTATUS_SPIE) & ~SSTATUS_SIE;
ffffffffc02045b8:	100027f3          	csrr	a5,sstatus
ffffffffc02045bc:	edd7f793          	andi	a5,a5,-291
ffffffffc02045c0:	1207e793          	ori	a5,a5,288
ffffffffc02045c4:	e23e                	sd	a5,256(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02045c6:	860a                	mv	a2,sp
ffffffffc02045c8:	10046513          	ori	a0,s0,256
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc02045cc:	00000797          	auipc	a5,0x0
ffffffffc02045d0:	c4c78793          	addi	a5,a5,-948 # ffffffffc0204218 <kernel_thread_entry>
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02045d4:	4581                	li	a1,0
    tf.epc = (uintptr_t)kernel_thread_entry;
ffffffffc02045d6:	e63e                	sd	a5,264(sp)
    return do_fork(clone_flags | CLONE_VM, 0, &tf);
ffffffffc02045d8:	d99ff0ef          	jal	ffffffffc0204370 <do_fork>
}
ffffffffc02045dc:	70f2                	ld	ra,312(sp)
ffffffffc02045de:	7452                	ld	s0,304(sp)
ffffffffc02045e0:	74b2                	ld	s1,296(sp)
ffffffffc02045e2:	7912                	ld	s2,288(sp)
ffffffffc02045e4:	6131                	addi	sp,sp,320
ffffffffc02045e6:	8082                	ret

ffffffffc02045e8 <do_exit>:
do_exit(int error_code) {
ffffffffc02045e8:	1141                	addi	sp,sp,-16
    panic("process exit!!.\n");
ffffffffc02045ea:	00002617          	auipc	a2,0x2
ffffffffc02045ee:	51e60613          	addi	a2,a2,1310 # ffffffffc0206b08 <etext+0x1c8c>
ffffffffc02045f2:	18200593          	li	a1,386
ffffffffc02045f6:	00002517          	auipc	a0,0x2
ffffffffc02045fa:	4fa50513          	addi	a0,a0,1274 # ffffffffc0206af0 <etext+0x1c74>
do_exit(int error_code) {
ffffffffc02045fe:	e406                	sd	ra,8(sp)
    panic("process exit!!.\n");
ffffffffc0204600:	e33fb0ef          	jal	ffffffffc0200432 <__panic>

ffffffffc0204604 <proc_init>:

// proc_init - set up the first kernel thread idleproc "idle" by itself and 
//           - create the second kernel thread init_main
void
proc_init(void) {
ffffffffc0204604:	7179                	addi	sp,sp,-48
ffffffffc0204606:	ec26                	sd	s1,24(sp)
    elm->prev = elm->next = elm;
ffffffffc0204608:	00011797          	auipc	a5,0x11
ffffffffc020460c:	f2078793          	addi	a5,a5,-224 # ffffffffc0215528 <proc_list>
...
ffffffffc0204618:	0000d497          	auipc	s1,0xd
ffffffffc020461c:	f1048493          	addi	s1,s1,-240 # ffffffffc0211528 <hash_list>
ffffffffc0204620:	e79c                	sd	a5,8(a5)
ffffffffc0204622:	e39c                	sd	a5,0(a5)
    int i;

    list_init(&proc_list);
    for (i = 0; i < HASH_LIST_SIZE; i ++) {
ffffffffc0204624:	00011717          	auipc	a4,0x11
ffffffffc0204628:	f0470713          	addi	a4,a4,-252 # ffffffffc0215528 <proc_list>
ffffffffc020462c:	87a6                	mv	a5,s1
ffffffffc020462e:	e79c                	sd	a5,8(a5)
ffffffffc0204630:	e39c                	sd	a5,0(a5)
ffffffffc0204632:	07c1                	addi	a5,a5,16
ffffffffc0204634:	fee79de3          	bne	a5,a4,ffffffffc020462e <proc_init+0x2a>
        list_init(hash_list + i);
    }

    if ((idleproc = alloc_proc()) == NULL) {
ffffffffc0204638:	be9ff0ef          	jal	ffffffffc0204220 <alloc_proc>
ffffffffc020463c:	00011917          	auipc	s2,0x11
ffffffffc0204640:	f8c90913          	addi	s2,s2,-116 # ffffffffc02155c8 <idleproc>
ffffffffc0204644:	00a93023          	sd	a0,0(s2)
ffffffffc0204648:	18050c63          	beqz	a0,ffffffffc02047e0 <proc_init+0x1dc>
...
ffffffffc0204650:	9d8fd0ef          	jal	ffffffffc0201828 <kmalloc>
    memset(context_mem, 0, sizeof(struct context));
ffffffffc0204654:	07000613          	li	a2,112
ffffffffc0204658:	4581                	li	a1,0
    int *context_mem = (int*) kmalloc(sizeof(struct context));
ffffffffc020465a:	842a                	mv	s0,a0
    memset(context_mem, 0, sizeof(struct context));
ffffffffc020465c:	7d2000ef          	jal	ffffffffc0204e2e <memset>
    int context_init_flag = memcmp(&(idleproc->context), context_mem, sizeof(struct context));
ffffffffc0204660:	00093503          	ld	a0,0(s2)
ffffffffc0204664:	85a2                	mv	a1,s0
ffffffffc0204666:	07000613          	li	a2,112
ffffffffc020466a:	03050513          	addi	a0,a0,48
ffffffffc020466e:	7ea000ef          	jal	ffffffffc0204e58 <memcmp>
ffffffffc0204672:	89aa                	mv	s3,a0

    int *proc_name_mem = (int*) kmalloc(PROC_NAME_LEN);
ffffffffc0204674:	453d                	li	a0,15
ffffffffc0204676:	9b2fd0ef          	jal	ffffffffc0201828 <kmalloc>
    memset(proc_name_mem, 0, PROC_NAME_LEN);
ffffffffc020467a:	463d                	li	a2,15
ffffffffc020467c:	4581                	li	a1,0
    int *proc_name_mem = (int*) kmalloc(PROC_NAME_LEN);
ffffffffc020467e:	842a                	mv	s0,a0
    memset(proc_name_mem, 0, PROC_NAME_LEN);
ffffffffc0204680:	7ae000ef          	jal	ffffffffc0204e2e <memset>
    int proc_name_flag = memcmp(&(idleproc->name), proc_name_mem, PROC_NAME_LEN);
ffffffffc0204684:	00093503          	ld	a0,0(s2)
ffffffffc0204688:	463d                	li	a2,15
ffffffffc020468a:	85a2                	mv	a1,s0
ffffffffc020468c:	0b450513          	addi	a0,a0,180
ffffffffc0204690:	7c8000ef          	jal	ffffffffc0204e58 <memcmp>

    if(idleproc->cr3 == boot_cr3 && idleproc->tf == NULL && !context_init_flag
ffffffffc0204694:	00093783          	ld	a5,0(s2)
ffffffffc0204698:	00011717          	auipc	a4,0x11
ffffffffc020469c:	ec873703          	ld	a4,-312(a4) # ffffffffc0215560 <boot_cr3>
ffffffffc02046a0:	77d4                	ld	a3,168(a5)
ffffffffc02046a2:	0ee68563          	beq	a3,a4,ffffffffc020478c <proc_init+0x188>
...
ffffffffc02046a8:	e398                	sd	a4,0(a5)
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc02046aa:	00003717          	auipc	a4,0x3
ffffffffc02046ae:	95670713          	addi	a4,a4,-1706 # ffffffffc0207000 <bootstack>
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02046b2:	0b478413          	addi	s0,a5,180
    idleproc->kstack = (uintptr_t)bootstack;
ffffffffc02046b6:	eb98                	sd	a4,16(a5)
    idleproc->need_resched = 1;
ffffffffc02046b8:	4705                	li	a4,1
ffffffffc02046ba:	cf98                	sw	a4,24(a5)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc02046bc:	4641                	li	a2,16
ffffffffc02046be:	4581                	li	a1,0
ffffffffc02046c0:	8522                	mv	a0,s0
ffffffffc02046c2:	76c000ef          	jal	ffffffffc0204e2e <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc02046c6:	463d                	li	a2,15
ffffffffc02046c8:	00002597          	auipc	a1,0x2
ffffffffc02046cc:	48858593          	addi	a1,a1,1160 # ffffffffc0206b50 <etext+0x1cd4>
ffffffffc02046d0:	8522                	mv	a0,s0
ffffffffc02046d2:	76e000ef          	jal	ffffffffc0204e40 <memcpy>
    set_proc_name(idleproc, "idle");
    nr_process ++;
ffffffffc02046d6:	00011717          	auipc	a4,0x11
ffffffffc02046da:	eda70713          	addi	a4,a4,-294 # ffffffffc02155b0 <nr_process>
ffffffffc02046de:	431c                	lw	a5,0(a4)

    current = idleproc;
ffffffffc02046e0:	00093683          	ld	a3,0(s2)

    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc02046e4:	4601                	li	a2,0
    nr_process ++;
ffffffffc02046e6:	2785                	addiw	a5,a5,1
    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc02046e8:	00002597          	auipc	a1,0x2
ffffffffc02046ec:	47058593          	addi	a1,a1,1136 # ffffffffc0206b58 <etext+0x1cdc>
ffffffffc02046f0:	00000517          	auipc	a0,0x0
ffffffffc02046f4:	ba050513          	addi	a0,a0,-1120 # ffffffffc0204290 <init_main>
    nr_process ++;
ffffffffc02046f8:	c31c                	sw	a5,0(a4)
    current = idleproc;
ffffffffc02046fa:	00011797          	auipc	a5,0x11
ffffffffc02046fe:	ead7bf23          	sd	a3,-322(a5) # ffffffffc02155b8 <current>
    int pid = kernel_thread(init_main, "Hello world!!", 0);
ffffffffc0204702:	e97ff0ef          	jal	ffffffffc0204598 <kernel_thread>
ffffffffc0204706:	842a                	mv	s0,a0
    if (pid <= 0) {
ffffffffc0204708:	0ea05863          	blez	a0,ffffffffc02047f8 <proc_init+0x1f4>
    if (0 < pid && pid < MAX_PID) {
ffffffffc020470c:	6789                	lui	a5,0x2
ffffffffc020470e:	fff5071b          	addiw	a4,a0,-1
ffffffffc0204712:	17f9                	addi	a5,a5,-2 # 1ffe <kern_entry-0xffffffffc01fe002>
ffffffffc0204714:	2501                	sext.w	a0,a0
ffffffffc0204716:	02e7e463          	bltu	a5,a4,ffffffffc020473e <proc_init+0x13a>
        list_entry_t *list = hash_list + pid_hashfn(pid), *le = list;
ffffffffc020471a:	45a9                	li	a1,10
ffffffffc020471c:	27e000ef          	jal	ffffffffc020499a <hash32>
ffffffffc0204720:	02051713          	slli	a4,a0,0x20
ffffffffc0204724:	01c75793          	srli	a5,a4,0x1c
ffffffffc0204728:	00f486b3          	add	a3,s1,a5
ffffffffc020472c:	87b6                	mv	a5,a3
        while ((le = list_next(le)) != list) {
ffffffffc020472e:	a029                	j	ffffffffc0204738 <proc_init+0x134>
            if (proc->pid == pid) {
ffffffffc0204730:	f2c7a703          	lw	a4,-212(a5)
ffffffffc0204734:	0a870363          	beq	a4,s0,ffffffffc02047da <proc_init+0x1d6>
    return listelm->next;
ffffffffc0204738:	679c                	ld	a5,8(a5)
        while ((le = list_next(le)) != list) {
ffffffffc020473a:	fef69be3          	bne	a3,a5,ffffffffc0204730 <proc_init+0x12c>
    return NULL;
...
ffffffffc0204752:	e01c                	sd	a5,0(s0)
    memset(proc->name, 0, sizeof(proc->name));
ffffffffc0204754:	6da000ef          	jal	ffffffffc0204e2e <memset>
    return memcpy(proc->name, name, PROC_NAME_LEN);
ffffffffc0204758:	463d                	li	a2,15
ffffffffc020475a:	00002597          	auipc	a1,0x2
ffffffffc020475e:	42e58593          	addi	a1,a1,1070 # ffffffffc0206b88 <etext+0x1d0c>
ffffffffc0204762:	8526                	mv	a0,s1
ffffffffc0204764:	6dc000ef          	jal	ffffffffc0204e40 <memcpy>
    set_proc_name(initproc, "init");

    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0204768:	00093783          	ld	a5,0(s2)
ffffffffc020476c:	c3f1                	beqz	a5,ffffffffc0204830 <proc_init+0x22c>
ffffffffc020476e:	43dc                	lw	a5,4(a5)
ffffffffc0204770:	e3e1                	bnez	a5,ffffffffc0204830 <proc_init+0x22c>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0204772:	601c                	ld	a5,0(s0)
ffffffffc0204774:	cfd1                	beqz	a5,ffffffffc0204810 <proc_init+0x20c>
ffffffffc0204776:	43d8                	lw	a4,4(a5)
ffffffffc0204778:	4785                	li	a5,1
ffffffffc020477a:	08f71b63          	bne	a4,a5,ffffffffc0204810 <proc_init+0x20c>
}
...
ffffffffc020478e:	ff01                	bnez	a4,ffffffffc02046a6 <proc_init+0xa2>
ffffffffc0204790:	f0099be3          	bnez	s3,ffffffffc02046a6 <proc_init+0xa2>
        && idleproc->state == PROC_UNINIT && idleproc->pid == -1 && idleproc->runs == 0
ffffffffc0204794:	6394                	ld	a3,0(a5)
ffffffffc0204796:	577d                	li	a4,-1
ffffffffc0204798:	1702                	slli	a4,a4,0x20
ffffffffc020479a:	f0e696e3          	bne	a3,a4,ffffffffc02046a6 <proc_init+0xa2>
ffffffffc020479e:	4798                	lw	a4,8(a5)
ffffffffc02047a0:	f00713e3          	bnez	a4,ffffffffc02046a6 <proc_init+0xa2>
        && idleproc->kstack == 0 && idleproc->need_resched == 0 && idleproc->parent == NULL
ffffffffc02047a4:	6b98                	ld	a4,16(a5)
ffffffffc02047a6:	f00710e3          	bnez	a4,ffffffffc02046a6 <proc_init+0xa2>
ffffffffc02047aa:	4f98                	lw	a4,24(a5)
ffffffffc02047ac:	ee071de3          	bnez	a4,ffffffffc02046a6 <proc_init+0xa2>
ffffffffc02047b0:	7398                	ld	a4,32(a5)
ffffffffc02047b2:	ee071ae3          	bnez	a4,ffffffffc02046a6 <proc_init+0xa2>
        && idleproc->mm == NULL && idleproc->flags == 0 && !proc_name_flag
ffffffffc02047b6:	7798                	ld	a4,40(a5)
ffffffffc02047b8:	ee0717e3          	bnez	a4,ffffffffc02046a6 <proc_init+0xa2>
ffffffffc02047bc:	0b07a703          	lw	a4,176(a5)
ffffffffc02047c0:	8f49                	or	a4,a4,a0
ffffffffc02047c2:	2701                	sext.w	a4,a4
ffffffffc02047c4:	ee0711e3          	bnez	a4,ffffffffc02046a6 <proc_init+0xa2>
        cprintf("alloc_proc() correct!\n");
ffffffffc02047c8:	00002517          	auipc	a0,0x2
ffffffffc02047cc:	37050513          	addi	a0,a0,880 # ffffffffc0206b38 <etext+0x1cbc>
ffffffffc02047d0:	9b1fb0ef          	jal	ffffffffc0200180 <cprintf>
    idleproc->pid = 0;
ffffffffc02047d4:	00093783          	ld	a5,0(s2)
ffffffffc02047d8:	b5f9                	j	ffffffffc02046a6 <proc_init+0xa2>
            struct proc_struct *proc = le2proc(le, hash_link);
ffffffffc02047da:	f2878793          	addi	a5,a5,-216
ffffffffc02047de:	b78d                	j	ffffffffc0204740 <proc_init+0x13c>
        panic("cannot alloc idleproc.\n");
ffffffffc02047e0:	00002617          	auipc	a2,0x2
ffffffffc02047e4:	34060613          	addi	a2,a2,832 # ffffffffc0206b20 <etext+0x1ca4>
ffffffffc02047e8:	19a00593          	li	a1,410
ffffffffc02047ec:	00002517          	auipc	a0,0x2
ffffffffc02047f0:	30450513          	addi	a0,a0,772 # ffffffffc0206af0 <etext+0x1c74>
ffffffffc02047f4:	c3ffb0ef          	jal	ffffffffc0200432 <__panic>
        panic("create init_main failed.\n");
ffffffffc02047f8:	00002617          	auipc	a2,0x2
ffffffffc02047fc:	37060613          	addi	a2,a2,880 # ffffffffc0206b68 <etext+0x1cec>
ffffffffc0204800:	1ba00593          	li	a1,442
ffffffffc0204804:	00002517          	auipc	a0,0x2
ffffffffc0204808:	2ec50513          	addi	a0,a0,748 # ffffffffc0206af0 <etext+0x1c74>
ffffffffc020480c:	c27fb0ef          	jal	ffffffffc0200432 <__panic>
    assert(initproc != NULL && initproc->pid == 1);
ffffffffc0204810:	00002697          	auipc	a3,0x2
ffffffffc0204814:	3a868693          	addi	a3,a3,936 # ffffffffc0206bb8 <etext+0x1d3c>
ffffffffc0204818:	00001617          	auipc	a2,0x1
ffffffffc020481c:	f5860613          	addi	a2,a2,-168 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0204820:	1c100593          	li	a1,449
ffffffffc0204824:	00002517          	auipc	a0,0x2
ffffffffc0204828:	2cc50513          	addi	a0,a0,716 # ffffffffc0206af0 <etext+0x1c74>
ffffffffc020482c:	c07fb0ef          	jal	ffffffffc0200432 <__panic>
    assert(idleproc != NULL && idleproc->pid == 0);
ffffffffc0204830:	00002697          	auipc	a3,0x2
ffffffffc0204834:	36068693          	addi	a3,a3,864 # ffffffffc0206b90 <etext+0x1d14>
ffffffffc0204838:	00001617          	auipc	a2,0x1
ffffffffc020483c:	f3860613          	addi	a2,a2,-200 # ffffffffc0205770 <etext+0x8f4>
ffffffffc0204840:	1c000593          	li	a1,448
ffffffffc0204844:	00002517          	auipc	a0,0x2
ffffffffc0204848:	2ac50513          	addi	a0,a0,684 # ffffffffc0206af0 <etext+0x1c74>
ffffffffc020484c:	be7fb0ef          	jal	ffffffffc0200432 <__panic>

ffffffffc0204850 <cpu_idle>:

// cpu_idle - at the end of kern_init, the first kernel thread idleproc will do below works
void
cpu_idle(void) {
ffffffffc0204850:	1141                	addi	sp,sp,-16
ffffffffc0204852:	e022                	sd	s0,0(sp)
ffffffffc0204854:	e406                	sd	ra,8(sp)
ffffffffc0204856:	00011417          	auipc	s0,0x11
ffffffffc020485a:	d6240413          	addi	s0,s0,-670 # ffffffffc02155b8 <current>
    while (1) {
        if (current->need_resched) {
ffffffffc020485e:	6018                	ld	a4,0(s0)
ffffffffc0204860:	4f1c                	lw	a5,24(a4)
ffffffffc0204862:	dffd                	beqz	a5,ffffffffc0204860 <cpu_idle+0x10>
            schedule();
ffffffffc0204864:	0a2000ef          	jal	ffffffffc0204906 <schedule>
ffffffffc0204868:	bfdd                	j	ffffffffc020485e <cpu_idle+0xe>
...
ffffffffc02048d4:	411c                	lw	a5,0(a0)
ffffffffc02048d6:	4705                	li	a4,1
ffffffffc02048d8:	37f9                	addiw	a5,a5,-2
ffffffffc02048da:	00f77563          	bgeu	a4,a5,ffffffffc02048e4 <wakeup_proc+0x10>
    proc->state = PROC_RUNNABLE;
ffffffffc02048de:	4789                	li	a5,2
ffffffffc02048e0:	c11c                	sw	a5,0(a0)
ffffffffc02048e2:	8082                	ret
wakeup_proc(struct proc_struct *proc) {
ffffffffc02048e4:	1141                	addi	sp,sp,-16
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc02048e6:	00002697          	auipc	a3,0x2
ffffffffc02048ea:	2fa68693          	addi	a3,a3,762 # ffffffffc0206be0 <etext+0x1d64>
ffffffffc02048ee:	00001617          	auipc	a2,0x1
ffffffffc02048f2:	e8260613          	addi	a2,a2,-382 # ffffffffc0205770 <etext+0x8f4>
ffffffffc02048f6:	45a5                	li	a1,9
ffffffffc02048f8:	00002517          	auipc	a0,0x2
ffffffffc02048fc:	32850513          	addi	a0,a0,808 # ffffffffc0206c20 <etext+0x1da4>
wakeup_proc(struct proc_struct *proc) {
ffffffffc0204900:	e406                	sd	ra,8(sp)
    assert(proc->state != PROC_ZOMBIE && proc->state != PROC_RUNNABLE);
ffffffffc0204902:	b31fb0ef          	jal	ffffffffc0200432 <__panic>

ffffffffc0204906 <schedule>:
}
...
ffffffffc020490a:	e022                	sd	s0,0(sp)
    if (read_csr(sstatus) & SSTATUS_SIE) {
ffffffffc020490c:	100027f3          	csrr	a5,sstatus
ffffffffc0204910:	8b89                	andi	a5,a5,2
ffffffffc0204912:	4401                	li	s0,0
ffffffffc0204914:	efbd                	bnez	a5,ffffffffc0204992 <schedule+0x8c>
    bool intr_flag;
...
ffffffffc0204916:	00011897          	auipc	a7,0x11
ffffffffc020491a:	ca28b883          	ld	a7,-862(a7) # ffffffffc02155b8 <current>
ffffffffc020491e:	0008ac23          	sw	zero,24(a7)
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc0204922:	00011517          	auipc	a0,0x11
ffffffffc0204926:	ca653503          	ld	a0,-858(a0) # ffffffffc02155c8 <idleproc>
ffffffffc020492a:	04a88e63          	beq	a7,a0,ffffffffc0204986 <schedule+0x80>
ffffffffc020492e:	0c888693          	addi	a3,a7,200
ffffffffc0204932:	00011617          	auipc	a2,0x11
ffffffffc0204936:	bf660613          	addi	a2,a2,-1034 # ffffffffc0215528 <proc_list>
        le = last;
ffffffffc020493a:	87b6                	mv	a5,a3
    struct proc_struct *next = NULL;
ffffffffc020493c:	4581                	li	a1,0
        do {
            if ((le = list_next(le)) != &proc_list) {
                next = le2proc(le, list_link);
                if (next->state == PROC_RUNNABLE) {
ffffffffc020493e:	4809                	li	a6,2
ffffffffc0204940:	679c                	ld	a5,8(a5)
            if ((le = list_next(le)) != &proc_list) {
ffffffffc0204942:	00c78863          	beq	a5,a2,ffffffffc0204952 <schedule+0x4c>
                if (next->state == PROC_RUNNABLE) {
ffffffffc0204946:	f387a703          	lw	a4,-200(a5)
                next = le2proc(le, list_link);
ffffffffc020494a:	f3878593          	addi	a1,a5,-200
                if (next->state == PROC_RUNNABLE) {
ffffffffc020494e:	03070163          	beq	a4,a6,ffffffffc0204970 <schedule+0x6a>
                    break;
                }
            }
        } while (le != last);
ffffffffc0204952:	fef697e3          	bne	a3,a5,ffffffffc0204940 <schedule+0x3a>
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc0204956:	ed89                	bnez	a1,ffffffffc0204970 <schedule+0x6a>
            next = idleproc;
        }
        next->runs ++;
ffffffffc0204958:	451c                	lw	a5,8(a0)
ffffffffc020495a:	2785                	addiw	a5,a5,1
ffffffffc020495c:	c51c                	sw	a5,8(a0)
        if (next != current) {
ffffffffc020495e:	00a88463          	beq	a7,a0,ffffffffc0204966 <schedule+0x60>
            proc_run(next);
ffffffffc0204962:	9a1ff0ef          	jal	ffffffffc0204302 <proc_run>
    if (flag) {
ffffffffc0204966:	e819                	bnez	s0,ffffffffc020497c <schedule+0x76>
        }
    }
    local_intr_restore(intr_flag);
}
ffffffffc0204968:	60a2                	ld	ra,8(sp)
ffffffffc020496a:	6402                	ld	s0,0(sp)
ffffffffc020496c:	0141                	addi	sp,sp,16
ffffffffc020496e:	8082                	ret
        if (next == NULL || next->state != PROC_RUNNABLE) {
ffffffffc0204970:	4198                	lw	a4,0(a1)
ffffffffc0204972:	4789                	li	a5,2
ffffffffc0204974:	fef712e3          	bne	a4,a5,ffffffffc0204958 <schedule+0x52>
ffffffffc0204978:	852e                	mv	a0,a1
ffffffffc020497a:	bff9                	j	ffffffffc0204958 <schedule+0x52>
}
ffffffffc020497c:	6402                	ld	s0,0(sp)
ffffffffc020497e:	60a2                	ld	ra,8(sp)
ffffffffc0204980:	0141                	addi	sp,sp,16
        intr_enable();
ffffffffc0204982:	c29fb06f          	j	ffffffffc02005aa <intr_enable>
        last = (current == idleproc) ? &proc_list : &(current->list_link);
ffffffffc0204986:	00011617          	auipc	a2,0x11
ffffffffc020498a:	ba260613          	addi	a2,a2,-1118 # ffffffffc0215528 <proc_list>
ffffffffc020498e:	86b2                	mv	a3,a2
ffffffffc0204990:	b76d                	j	ffffffffc020493a <schedule+0x34>
        intr_disable();
ffffffffc0204992:	c1ffb0ef          	jal	ffffffffc02005b0 <intr_disable>
        return 1;
ffffffffc0204996:	4405                	li	s0,1
ffffffffc0204998:	bfbd                	j	ffffffffc0204916 <schedule+0x10>

ffffffffc020499a <hash32>:
 *
...
ffffffffc020499a:	9e3707b7          	lui	a5,0x9e370
ffffffffc020499e:	2785                	addiw	a5,a5,1 # ffffffff9e370001 <kern_entry-0x21e8ffff>
ffffffffc02049a0:	02a787bb          	mulw	a5,a5,a0
    return (hash >> (32 - bits));
ffffffffc02049a4:	02000513          	li	a0,32
ffffffffc02049a8:	9d0d                	subw	a0,a0,a1
}
ffffffffc02049aa:	00a7d53b          	srlw	a0,a5,a0
ffffffffc02049ae:	8082                	ret

ffffffffc02049b0 <printnum>:
 * */
static void
...
ffffffffc02049b0:	02069813          	slli	a6,a3,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc02049b4:	7179                	addi	sp,sp,-48
    unsigned mod = do_div(result, base);
ffffffffc02049b6:	02085813          	srli	a6,a6,0x20
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc02049ba:	e052                	sd	s4,0(sp)
    unsigned mod = do_div(result, base);
ffffffffc02049bc:	03067a33          	remu	s4,a2,a6
        unsigned long long num, unsigned base, int width, int padc) {
ffffffffc02049c0:	f022                	sd	s0,32(sp)
ffffffffc02049c2:	ec26                	sd	s1,24(sp)
ffffffffc02049c4:	e84a                	sd	s2,16(sp)
ffffffffc02049c6:	f406                	sd	ra,40(sp)
ffffffffc02049c8:	84aa                	mv	s1,a0
ffffffffc02049ca:	892e                	mv	s2,a1
    ...
    if (num >= base) {
        ...
        while (-- width > 0)
ffffffffc02049cc:	fff7041b          	addiw	s0,a4,-1
    unsigned mod = do_div(result, base);
ffffffffc02049d0:	2a01                	sext.w	s4,s4
    if (num >= base) {
ffffffffc02049d2:	05067063          	bgeu	a2,a6,ffffffffc0204a12 <printnum+0x62>
ffffffffc02049d6:	e44e                	sd	s3,8(sp)
ffffffffc02049d8:	89be                	mv	s3,a5
        while (-- width > 0)
ffffffffc02049da:	4785                	li	a5,1
ffffffffc02049dc:	00e7d763          	bge	a5,a4,ffffffffc02049ea <printnum+0x3a>
            putch(padc, putdat);
ffffffffc02049e0:	85ca                	mv	a1,s2
ffffffffc02049e2:	854e                	mv	a0,s3
        while (-- width > 0)
ffffffffc02049e4:	347d                	addiw	s0,s0,-1
            putch(padc, putdat);
ffffffffc02049e6:	9482                	jalr	s1
        while (-- width > 0)
ffffffffc02049e8:	fc65                	bnez	s0,ffffffffc02049e0 <printnum+0x30>
ffffffffc02049ea:	69a2                	ld	s3,8(sp)
    }
    // then print this (the least significant) digit
    putch("0123456789abcdef"[mod], putdat);
ffffffffc02049ec:	1a02                	slli	s4,s4,0x20
ffffffffc02049ee:	020a5a13          	srli	s4,s4,0x20
ffffffffc02049f2:	00002797          	auipc	a5,0x2
ffffffffc02049f6:	24678793          	addi	a5,a5,582 # ffffffffc0206c38 <etext+0x1dbc>
ffffffffc02049fa:	97d2                	add	a5,a5,s4
}
ffffffffc02049fc:	7402                	ld	s0,32(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc02049fe:	0007c503          	lbu	a0,0(a5)
}
ffffffffc0204a02:	70a2                	ld	ra,40(sp)
ffffffffc0204a04:	6a02                	ld	s4,0(sp)
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204a06:	85ca                	mv	a1,s2
ffffffffc0204a08:	87a6                	mv	a5,s1
}
ffffffffc0204a0a:	6942                	ld	s2,16(sp)
ffffffffc0204a0c:	64e2                	ld	s1,24(sp)
ffffffffc0204a0e:	6145                	addi	sp,sp,48
    putch("0123456789abcdef"[mod], putdat);
ffffffffc0204a10:	8782                	jr	a5
        printnum(putch, putdat, result, base, width - 1, padc);
ffffffffc0204a12:	03065633          	divu	a2,a2,a6
ffffffffc0204a16:	8722                	mv	a4,s0
ffffffffc0204a18:	f99ff0ef          	jal	ffffffffc02049b0 <printnum>
ffffffffc0204a1c:	bfc1                	j	ffffffffc02049ec <printnum+0x3c>

ffffffffc0204a1e <vprintfmt>:
 *
 * Call this function if you are already dealing with a va_list.
...
ffffffffc0204a1e:	7119                	addi	sp,sp,-128
ffffffffc0204a20:	f4a6                	sd	s1,104(sp)
ffffffffc0204a22:	f0ca                	sd	s2,96(sp)
ffffffffc0204a24:	ecce                	sd	s3,88(sp)
ffffffffc0204a26:	e8d2                	sd	s4,80(sp)
ffffffffc0204a28:	e4d6                	sd	s5,72(sp)
ffffffffc0204a2a:	e0da                	sd	s6,64(sp)
ffffffffc0204a2c:	f862                	sd	s8,48(sp)
ffffffffc0204a2e:	fc86                	sd	ra,120(sp)
ffffffffc0204a30:	f8a2                	sd	s0,112(sp)
ffffffffc0204a32:	fc5e                	sd	s7,56(sp)
ffffffffc0204a34:	f466                	sd	s9,40(sp)
ffffffffc0204a36:	f06a                	sd	s10,32(sp)
ffffffffc0204a38:	ec6e                	sd	s11,24(sp)
ffffffffc0204a3a:	892a                	mv	s2,a0
ffffffffc0204a3c:	84ae                	mv	s1,a1
ffffffffc0204a3e:	8c32                	mv	s8,a2
ffffffffc0204a40:	8a36                	mv	s4,a3
    register int ch, err;
...
ffffffffc0204a46:	05500b13          	li	s6,85
ffffffffc0204a4a:	00002a97          	auipc	s5,0x2
ffffffffc0204a4e:	38ea8a93          	addi	s5,s5,910 # ffffffffc0206dd8 <default_pmm_manager+0x38>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204a52:	000c4503          	lbu	a0,0(s8)
ffffffffc0204a56:	001c0413          	addi	s0,s8,1
ffffffffc0204a5a:	01350a63          	beq	a0,s3,ffffffffc0204a6e <vprintfmt+0x50>
            if (ch == '\0') {
ffffffffc0204a5e:	cd0d                	beqz	a0,ffffffffc0204a98 <vprintfmt+0x7a>
            putch(ch, putdat);
ffffffffc0204a60:	85a6                	mv	a1,s1
ffffffffc0204a62:	9902                	jalr	s2
        while ((ch = *(unsigned char *)fmt ++) != '%') {
ffffffffc0204a64:	00044503          	lbu	a0,0(s0)
ffffffffc0204a68:	0405                	addi	s0,s0,1
ffffffffc0204a6a:	ff351ae3          	bne	a0,s3,ffffffffc0204a5e <vprintfmt+0x40>
        char padc = ' ';
ffffffffc0204a6e:	02000d93          	li	s11,32
        lflag = altflag = 0;
ffffffffc0204a72:	4b81                	li	s7,0
ffffffffc0204a74:	4601                	li	a2,0
        width = precision = -1;
ffffffffc0204a76:	5d7d                	li	s10,-1
ffffffffc0204a78:	5cfd                	li	s9,-1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204a7a:	00044683          	lbu	a3,0(s0)
ffffffffc0204a7e:	00140c13          	addi	s8,s0,1
ffffffffc0204a82:	fdd6859b          	addiw	a1,a3,-35
ffffffffc0204a86:	0ff5f593          	zext.b	a1,a1
ffffffffc0204a8a:	02bb6663          	bltu	s6,a1,ffffffffc0204ab6 <vprintfmt+0x98>
ffffffffc0204a8e:	058a                	slli	a1,a1,0x2
ffffffffc0204a90:	95d6                	add	a1,a1,s5
ffffffffc0204a92:	4198                	lw	a4,0(a1)
ffffffffc0204a94:	9756                	add	a4,a4,s5
ffffffffc0204a96:	8702                	jr	a4
            for (fmt --; fmt[-1] != '%'; fmt --)
                /* do nothing */;
            break;
        }
...
ffffffffc0204a98:	70e6                	ld	ra,120(sp)
ffffffffc0204a9a:	7446                	ld	s0,112(sp)
ffffffffc0204a9c:	74a6                	ld	s1,104(sp)
ffffffffc0204a9e:	7906                	ld	s2,96(sp)
ffffffffc0204aa0:	69e6                	ld	s3,88(sp)
ffffffffc0204aa2:	6a46                	ld	s4,80(sp)
ffffffffc0204aa4:	6aa6                	ld	s5,72(sp)
ffffffffc0204aa6:	6b06                	ld	s6,64(sp)
ffffffffc0204aa8:	7be2                	ld	s7,56(sp)
ffffffffc0204aaa:	7c42                	ld	s8,48(sp)
ffffffffc0204aac:	7ca2                	ld	s9,40(sp)
ffffffffc0204aae:	7d02                	ld	s10,32(sp)
ffffffffc0204ab0:	6de2                	ld	s11,24(sp)
ffffffffc0204ab2:	6109                	addi	sp,sp,128
ffffffffc0204ab4:	8082                	ret
            putch('%', putdat);
ffffffffc0204ab6:	85a6                	mv	a1,s1
ffffffffc0204ab8:	02500513          	li	a0,37
ffffffffc0204abc:	9902                	jalr	s2
            for (fmt --; fmt[-1] != '%'; fmt --)
ffffffffc0204abe:	fff44703          	lbu	a4,-1(s0)
ffffffffc0204ac2:	02500793          	li	a5,37
ffffffffc0204ac6:	8c22                	mv	s8,s0
ffffffffc0204ac8:	f8f705e3          	beq	a4,a5,ffffffffc0204a52 <vprintfmt+0x34>
ffffffffc0204acc:	02500713          	li	a4,37
ffffffffc0204ad0:	ffec4783          	lbu	a5,-2(s8)
ffffffffc0204ad4:	1c7d                	addi	s8,s8,-1
ffffffffc0204ad6:	fee79de3          	bne	a5,a4,ffffffffc0204ad0 <vprintfmt+0xb2>
ffffffffc0204ada:	bfa5                	j	ffffffffc0204a52 <vprintfmt+0x34>
                ch = *fmt;
ffffffffc0204adc:	00144783          	lbu	a5,1(s0)
                if (ch < '0' || ch > '9') {
ffffffffc0204ae0:	4725                	li	a4,9
                precision = precision * 10 + ch - '0';
ffffffffc0204ae2:	fd068d1b          	addiw	s10,a3,-48
                if (ch < '0' || ch > '9') {
ffffffffc0204ae6:	fd07859b          	addiw	a1,a5,-48
                ch = *fmt;
ffffffffc0204aea:	0007869b          	sext.w	a3,a5
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204aee:	8462                	mv	s0,s8
                if (ch < '0' || ch > '9') {
ffffffffc0204af0:	02b76563          	bltu	a4,a1,ffffffffc0204b1a <vprintfmt+0xfc>
ffffffffc0204af4:	4525                	li	a0,9
                ch = *fmt;
ffffffffc0204af6:	00144783          	lbu	a5,1(s0)
                precision = precision * 10 + ch - '0';
ffffffffc0204afa:	002d171b          	slliw	a4,s10,0x2
ffffffffc0204afe:	01a7073b          	addw	a4,a4,s10
ffffffffc0204b02:	0017171b          	slliw	a4,a4,0x1
ffffffffc0204b06:	9f35                	addw	a4,a4,a3
                if (ch < '0' || ch > '9') {
ffffffffc0204b08:	fd07859b          	addiw	a1,a5,-48
            for (precision = 0; ; ++ fmt) {
ffffffffc0204b0c:	0405                	addi	s0,s0,1
                precision = precision * 10 + ch - '0';
ffffffffc0204b0e:	fd070d1b          	addiw	s10,a4,-48
                ch = *fmt;
ffffffffc0204b12:	0007869b          	sext.w	a3,a5
                if (ch < '0' || ch > '9') {
ffffffffc0204b16:	feb570e3          	bgeu	a0,a1,ffffffffc0204af6 <vprintfmt+0xd8>
            if (width < 0)
ffffffffc0204b1a:	f60cd0e3          	bgez	s9,ffffffffc0204a7a <vprintfmt+0x5c>
                width = precision, precision = -1;
ffffffffc0204b1e:	8cea                	mv	s9,s10
ffffffffc0204b20:	5d7d                	li	s10,-1
ffffffffc0204b22:	bfa1                	j	ffffffffc0204a7a <vprintfmt+0x5c>
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204b24:	8db6                	mv	s11,a3
ffffffffc0204b26:	8462                	mv	s0,s8
ffffffffc0204b28:	bf89                	j	ffffffffc0204a7a <vprintfmt+0x5c>
ffffffffc0204b2a:	8462                	mv	s0,s8
            altflag = 1;
ffffffffc0204b2c:	4b85                	li	s7,1
            goto reswitch;
ffffffffc0204b2e:	b7b1                	j	ffffffffc0204a7a <vprintfmt+0x5c>
    if (lflag >= 2) {
ffffffffc0204b30:	4785                	li	a5,1
            precision = va_arg(ap, int);
ffffffffc0204b32:	008a0713          	addi	a4,s4,8
    if (lflag >= 2) {
ffffffffc0204b36:	00c7c463          	blt	a5,a2,ffffffffc0204b3e <vprintfmt+0x120>
    else if (lflag) {
ffffffffc0204b3a:	1a060163          	beqz	a2,ffffffffc0204cdc <vprintfmt+0x2be>
        return va_arg(*ap, unsigned long);
ffffffffc0204b3e:	000a3603          	ld	a2,0(s4)
ffffffffc0204b42:	46c1                	li	a3,16
ffffffffc0204b44:	8a3a                	mv	s4,a4
            printnum(putch, putdat, num, base, width, padc);
ffffffffc0204b46:	000d879b          	sext.w	a5,s11
ffffffffc0204b4a:	8766                	mv	a4,s9
ffffffffc0204b4c:	85a6                	mv	a1,s1
ffffffffc0204b4e:	854a                	mv	a0,s2
ffffffffc0204b50:	e61ff0ef          	jal	ffffffffc02049b0 <printnum>
            break;
ffffffffc0204b54:	bdfd                	j	ffffffffc0204a52 <vprintfmt+0x34>
            putch(va_arg(ap, int), putdat);
ffffffffc0204b56:	000a2503          	lw	a0,0(s4)
ffffffffc0204b5a:	85a6                	mv	a1,s1
ffffffffc0204b5c:	0a21                	addi	s4,s4,8
ffffffffc0204b5e:	9902                	jalr	s2
            break;
ffffffffc0204b60:	bdcd                	j	ffffffffc0204a52 <vprintfmt+0x34>
    if (lflag >= 2) {
ffffffffc0204b62:	4785                	li	a5,1
            precision = va_arg(ap, int);
ffffffffc0204b64:	008a0713          	addi	a4,s4,8
    if (lflag >= 2) {
ffffffffc0204b68:	00c7c463          	blt	a5,a2,ffffffffc0204b70 <vprintfmt+0x152>
    else if (lflag) {
ffffffffc0204b6c:	16060363          	beqz	a2,ffffffffc0204cd2 <vprintfmt+0x2b4>
        return va_arg(*ap, unsigned long);
ffffffffc0204b70:	000a3603          	ld	a2,0(s4)
ffffffffc0204b74:	46a9                	li	a3,10
ffffffffc0204b76:	8a3a                	mv	s4,a4
ffffffffc0204b78:	b7f9                	j	ffffffffc0204b46 <vprintfmt+0x128>
            putch('0', putdat);
ffffffffc0204b7a:	85a6                	mv	a1,s1
ffffffffc0204b7c:	03000513          	li	a0,48
ffffffffc0204b80:	9902                	jalr	s2
            putch('x', putdat);
ffffffffc0204b82:	85a6                	mv	a1,s1
ffffffffc0204b84:	07800513          	li	a0,120
...
ffffffffc0204b8e:	46c1                	li	a3,16
            num = (unsigned long long)(uintptr_t)va_arg(ap, void *);
ffffffffc0204b90:	0a21                	addi	s4,s4,8
            goto number;
ffffffffc0204b92:	bf55                	j	ffffffffc0204b46 <vprintfmt+0x128>
            putch(ch, putdat);
ffffffffc0204b94:	85a6                	mv	a1,s1
ffffffffc0204b96:	02500513          	li	a0,37
ffffffffc0204b9a:	9902                	jalr	s2
            break;
ffffffffc0204b9c:	bd5d                	j	ffffffffc0204a52 <vprintfmt+0x34>
            precision = va_arg(ap, int);
ffffffffc0204b9e:	000a2d03          	lw	s10,0(s4)
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204ba2:	8462                	mv	s0,s8
            precision = va_arg(ap, int);
ffffffffc0204ba4:	0a21                	addi	s4,s4,8
            goto process_precision;
ffffffffc0204ba6:	bf95                	j	ffffffffc0204b1a <vprintfmt+0xfc>
    if (lflag >= 2) {
ffffffffc0204ba8:	4785                	li	a5,1
            precision = va_arg(ap, int);
ffffffffc0204baa:	008a0713          	addi	a4,s4,8
    if (lflag >= 2) {
ffffffffc0204bae:	00c7c463          	blt	a5,a2,ffffffffc0204bb6 <vprintfmt+0x198>
    else if (lflag) {
ffffffffc0204bb2:	10060b63          	beqz	a2,ffffffffc0204cc8 <vprintfmt+0x2aa>
        return va_arg(*ap, unsigned long);
ffffffffc0204bb6:	000a3603          	ld	a2,0(s4)
ffffffffc0204bba:	46a1                	li	a3,8
ffffffffc0204bbc:	8a3a                	mv	s4,a4
ffffffffc0204bbe:	b761                	j	ffffffffc0204b46 <vprintfmt+0x128>
            if (width < 0)
ffffffffc0204bc0:	fffcc793          	not	a5,s9
ffffffffc0204bc4:	97fd                	srai	a5,a5,0x3f
ffffffffc0204bc6:	00fcf7b3          	and	a5,s9,a5
ffffffffc0204bca:	00078c9b          	sext.w	s9,a5
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204bce:	8462                	mv	s0,s8
            goto reswitch;
ffffffffc0204bd0:	b56d                	j	ffffffffc0204a7a <vprintfmt+0x5c>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204bd2:	000a3403          	ld	s0,0(s4)
ffffffffc0204bd6:	008a0793          	addi	a5,s4,8
ffffffffc0204bda:	e43e                	sd	a5,8(sp)
ffffffffc0204bdc:	12040063          	beqz	s0,ffffffffc0204cfc <vprintfmt+0x2de>
            if (width > 0 && padc != '-') {
ffffffffc0204be0:	0d905963          	blez	s9,ffffffffc0204cb2 <vprintfmt+0x294>
ffffffffc0204be4:	02d00793          	li	a5,45
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204be8:	00140a13          	addi	s4,s0,1
            if (width > 0 && padc != '-') {
ffffffffc0204bec:	12fd9763          	bne	s11,a5,ffffffffc0204d1a <vprintfmt+0x2fc>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204bf0:	00044783          	lbu	a5,0(s0)
ffffffffc0204bf4:	0007851b          	sext.w	a0,a5
ffffffffc0204bf8:	cb9d                	beqz	a5,ffffffffc0204c2e <vprintfmt+0x210>
ffffffffc0204bfa:	547d                	li	s0,-1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204bfc:	05e00d93          	li	s11,94
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204c00:	000d4563          	bltz	s10,ffffffffc0204c0a <vprintfmt+0x1ec>
ffffffffc0204c04:	3d7d                	addiw	s10,s10,-1
ffffffffc0204c06:	028d0263          	beq	s10,s0,ffffffffc0204c2a <vprintfmt+0x20c>
                    putch('?', putdat);
ffffffffc0204c0a:	85a6                	mv	a1,s1
                if (altflag && (ch < ' ' || ch > '~')) {
ffffffffc0204c0c:	0c0b8d63          	beqz	s7,ffffffffc0204ce6 <vprintfmt+0x2c8>
ffffffffc0204c10:	3781                	addiw	a5,a5,-32
ffffffffc0204c12:	0cfdfa63          	bgeu	s11,a5,ffffffffc0204ce6 <vprintfmt+0x2c8>
                    putch('?', putdat);
ffffffffc0204c16:	03f00513          	li	a0,63
ffffffffc0204c1a:	9902                	jalr	s2
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204c1c:	000a4783          	lbu	a5,0(s4)
ffffffffc0204c20:	3cfd                	addiw	s9,s9,-1
ffffffffc0204c22:	0a05                	addi	s4,s4,1
ffffffffc0204c24:	0007851b          	sext.w	a0,a5
ffffffffc0204c28:	ffe1                	bnez	a5,ffffffffc0204c00 <vprintfmt+0x1e2>
            for (; width > 0; width --) {
ffffffffc0204c2a:	01905963          	blez	s9,ffffffffc0204c3c <vprintfmt+0x21e>
                putch(' ', putdat);
ffffffffc0204c2e:	85a6                	mv	a1,s1
ffffffffc0204c30:	02000513          	li	a0,32
            for (; width > 0; width --) {
ffffffffc0204c34:	3cfd                	addiw	s9,s9,-1
                putch(' ', putdat);
ffffffffc0204c36:	9902                	jalr	s2
            for (; width > 0; width --) {
ffffffffc0204c38:	fe0c9be3          	bnez	s9,ffffffffc0204c2e <vprintfmt+0x210>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204c3c:	6a22                	ld	s4,8(sp)
ffffffffc0204c3e:	bd11                	j	ffffffffc0204a52 <vprintfmt+0x34>
    if (lflag >= 2) {
ffffffffc0204c40:	4785                	li	a5,1
            precision = va_arg(ap, int);
ffffffffc0204c42:	008a0b93          	addi	s7,s4,8
    if (lflag >= 2) {
ffffffffc0204c46:	00c7c363          	blt	a5,a2,ffffffffc0204c4c <vprintfmt+0x22e>
    else if (lflag) {
ffffffffc0204c4a:	ce25                	beqz	a2,ffffffffc0204cc2 <vprintfmt+0x2a4>
        return va_arg(*ap, long);
ffffffffc0204c4c:	000a3403          	ld	s0,0(s4)
            if ((long long)num < 0) {
ffffffffc0204c50:	08044d63          	bltz	s0,ffffffffc0204cea <vprintfmt+0x2cc>
            num = getint(&ap, lflag);
ffffffffc0204c54:	8622                	mv	a2,s0
ffffffffc0204c56:	8a5e                	mv	s4,s7
ffffffffc0204c58:	46a9                	li	a3,10
ffffffffc0204c5a:	b5f5                	j	ffffffffc0204b46 <vprintfmt+0x128>
            if (err < 0) {
ffffffffc0204c5c:	000a2783          	lw	a5,0(s4)
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204c60:	4619                	li	a2,6
            if (err < 0) {
ffffffffc0204c62:	41f7d71b          	sraiw	a4,a5,0x1f
ffffffffc0204c66:	8fb9                	xor	a5,a5,a4
ffffffffc0204c68:	40e786bb          	subw	a3,a5,a4
            if (err > MAXERROR || (p = error_string[err]) == NULL) {
ffffffffc0204c6c:	02d64663          	blt	a2,a3,ffffffffc0204c98 <vprintfmt+0x27a>
ffffffffc0204c70:	00369713          	slli	a4,a3,0x3
ffffffffc0204c74:	00002797          	auipc	a5,0x2
ffffffffc0204c78:	2bc78793          	addi	a5,a5,700 # ffffffffc0206f30 <error_string>
ffffffffc0204c7c:	97ba                	add	a5,a5,a4
ffffffffc0204c7e:	639c                	ld	a5,0(a5)
ffffffffc0204c80:	cf81                	beqz	a5,ffffffffc0204c98 <vprintfmt+0x27a>
                printfmt(putch, putdat, "%s", p);
ffffffffc0204c82:	86be                	mv	a3,a5
ffffffffc0204c84:	00000617          	auipc	a2,0x0
ffffffffc0204c88:	22460613          	addi	a2,a2,548 # ffffffffc0204ea8 <etext+0x2c>
ffffffffc0204c8c:	85a6                	mv	a1,s1
ffffffffc0204c8e:	854a                	mv	a0,s2
ffffffffc0204c90:	0e8000ef          	jal	ffffffffc0204d78 <printfmt>
            err = va_arg(ap, int);
ffffffffc0204c94:	0a21                	addi	s4,s4,8
ffffffffc0204c96:	bb75                	j	ffffffffc0204a52 <vprintfmt+0x34>
                printfmt(putch, putdat, "error %d", err);
ffffffffc0204c98:	00002617          	auipc	a2,0x2
ffffffffc0204c9c:	fc060613          	addi	a2,a2,-64 # ffffffffc0206c58 <etext+0x1ddc>
ffffffffc0204ca0:	85a6                	mv	a1,s1
ffffffffc0204ca2:	854a                	mv	a0,s2
ffffffffc0204ca4:	0d4000ef          	jal	ffffffffc0204d78 <printfmt>
            err = va_arg(ap, int);
ffffffffc0204ca8:	0a21                	addi	s4,s4,8
ffffffffc0204caa:	b365                	j	ffffffffc0204a52 <vprintfmt+0x34>
            lflag ++;
ffffffffc0204cac:	2605                	addiw	a2,a2,1
        switch (ch = *(unsigned char *)fmt ++) {
ffffffffc0204cae:	8462                	mv	s0,s8
            goto reswitch;
ffffffffc0204cb0:	b3e9                	j	ffffffffc0204a7a <vprintfmt+0x5c>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204cb2:	00044783          	lbu	a5,0(s0)
ffffffffc0204cb6:	0007851b          	sext.w	a0,a5
ffffffffc0204cba:	d3c9                	beqz	a5,ffffffffc0204c3c <vprintfmt+0x21e>
ffffffffc0204cbc:	00140a13          	addi	s4,s0,1
ffffffffc0204cc0:	bf2d                	j	ffffffffc0204bfa <vprintfmt+0x1dc>
        return va_arg(*ap, int);
ffffffffc0204cc2:	000a2403          	lw	s0,0(s4)
ffffffffc0204cc6:	b769                	j	ffffffffc0204c50 <vprintfmt+0x232>
        return va_arg(*ap, unsigned int);
ffffffffc0204cc8:	000a6603          	lwu	a2,0(s4)
ffffffffc0204ccc:	46a1                	li	a3,8
ffffffffc0204cce:	8a3a                	mv	s4,a4
ffffffffc0204cd0:	bd9d                	j	ffffffffc0204b46 <vprintfmt+0x128>
ffffffffc0204cd2:	000a6603          	lwu	a2,0(s4)
ffffffffc0204cd6:	46a9                	li	a3,10
ffffffffc0204cd8:	8a3a                	mv	s4,a4
ffffffffc0204cda:	b5b5                	j	ffffffffc0204b46 <vprintfmt+0x128>
ffffffffc0204cdc:	000a6603          	lwu	a2,0(s4)
ffffffffc0204ce0:	46c1                	li	a3,16
ffffffffc0204ce2:	8a3a                	mv	s4,a4
ffffffffc0204ce4:	b58d                	j	ffffffffc0204b46 <vprintfmt+0x128>
                    putch(ch, putdat);
ffffffffc0204ce6:	9902                	jalr	s2
ffffffffc0204ce8:	bf15                	j	ffffffffc0204c1c <vprintfmt+0x1fe>
                putch('-', putdat);
ffffffffc0204cea:	85a6                	mv	a1,s1
ffffffffc0204cec:	02d00513          	li	a0,45
ffffffffc0204cf0:	9902                	jalr	s2
                num = -(long long)num;
ffffffffc0204cf2:	40800633          	neg	a2,s0
ffffffffc0204cf6:	8a5e                	mv	s4,s7
ffffffffc0204cf8:	46a9                	li	a3,10
ffffffffc0204cfa:	b5b1                	j	ffffffffc0204b46 <vprintfmt+0x128>
            if (width > 0 && padc != '-') {
ffffffffc0204cfc:	01905663          	blez	s9,ffffffffc0204d08 <vprintfmt+0x2ea>
ffffffffc0204d00:	02d00793          	li	a5,45
ffffffffc0204d04:	04fd9263          	bne	s11,a5,ffffffffc0204d48 <vprintfmt+0x32a>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204d08:	02800793          	li	a5,40
ffffffffc0204d0c:	00002a17          	auipc	s4,0x2
ffffffffc0204d10:	f45a0a13          	addi	s4,s4,-187 # ffffffffc0206c51 <etext+0x1dd5>
ffffffffc0204d14:	02800513          	li	a0,40
ffffffffc0204d18:	b5cd                	j	ffffffffc0204bfa <vprintfmt+0x1dc>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d1a:	85ea                	mv	a1,s10
ffffffffc0204d1c:	8522                	mv	a0,s0
ffffffffc0204d1e:	094000ef          	jal	ffffffffc0204db2 <strnlen>
ffffffffc0204d22:	40ac8cbb          	subw	s9,s9,a0
ffffffffc0204d26:	01905963          	blez	s9,ffffffffc0204d38 <vprintfmt+0x31a>
                    putch(padc, putdat);
ffffffffc0204d2a:	2d81                	sext.w	s11,s11
ffffffffc0204d2c:	85a6                	mv	a1,s1
ffffffffc0204d2e:	856e                	mv	a0,s11
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d30:	3cfd                	addiw	s9,s9,-1
                    putch(padc, putdat);
ffffffffc0204d32:	9902                	jalr	s2
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d34:	fe0c9ce3          	bnez	s9,ffffffffc0204d2c <vprintfmt+0x30e>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204d38:	00044783          	lbu	a5,0(s0)
ffffffffc0204d3c:	0007851b          	sext.w	a0,a5
ffffffffc0204d40:	ea079de3          	bnez	a5,ffffffffc0204bfa <vprintfmt+0x1dc>
            if ((p = va_arg(ap, char *)) == NULL) {
ffffffffc0204d44:	6a22                	ld	s4,8(sp)
ffffffffc0204d46:	b331                	j	ffffffffc0204a52 <vprintfmt+0x34>
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d48:	85ea                	mv	a1,s10
ffffffffc0204d4a:	00002517          	auipc	a0,0x2
ffffffffc0204d4e:	f0650513          	addi	a0,a0,-250 # ffffffffc0206c50 <etext+0x1dd4>
ffffffffc0204d52:	060000ef          	jal	ffffffffc0204db2 <strnlen>
ffffffffc0204d56:	40ac8cbb          	subw	s9,s9,a0
                p = "(null)";
ffffffffc0204d5a:	00002417          	auipc	s0,0x2
ffffffffc0204d5e:	ef640413          	addi	s0,s0,-266 # ffffffffc0206c50 <etext+0x1dd4>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
ffffffffc0204d62:	00002a17          	auipc	s4,0x2
ffffffffc0204d66:	eefa0a13          	addi	s4,s4,-273 # ffffffffc0206c51 <etext+0x1dd5>
ffffffffc0204d6a:	02800793          	li	a5,40
ffffffffc0204d6e:	02800513          	li	a0,40
                for (width -= strnlen(p, precision); width > 0; width --) {
ffffffffc0204d72:	fb904ce3          	bgtz	s9,ffffffffc0204d2a <vprintfmt+0x30c>
ffffffffc0204d76:	b551                	j	ffffffffc0204bfa <vprintfmt+0x1dc>

ffffffffc0204d78 <printfmt>:
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204d78:	715d                	addi	sp,sp,-80
    va_start(ap, fmt);
ffffffffc0204d7a:	02810313          	addi	t1,sp,40
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204d7e:	f436                	sd	a3,40(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204d80:	869a                	mv	a3,t1
printfmt(void (*putch)(int, void*), void *putdat, const char *fmt, ...) {
ffffffffc0204d82:	ec06                	sd	ra,24(sp)
ffffffffc0204d84:	f83a                	sd	a4,48(sp)
ffffffffc0204d86:	fc3e                	sd	a5,56(sp)
ffffffffc0204d88:	e0c2                	sd	a6,64(sp)
ffffffffc0204d8a:	e4c6                	sd	a7,72(sp)
    va_start(ap, fmt);
ffffffffc0204d8c:	e41a                	sd	t1,8(sp)
    vprintfmt(putch, putdat, fmt, ap);
ffffffffc0204d8e:	c91ff0ef          	jal	ffffffffc0204a1e <vprintfmt>
}
ffffffffc0204d92:	60e2                	ld	ra,24(sp)
ffffffffc0204d94:	6161                	addi	sp,sp,80
ffffffffc0204d96:	8082                	ret

ffffffffc0204d98 <strlen>:
...
strlen(const char *s) {
    size_t cnt = 0;
    while (*s ++ != '\0') {
ffffffffc0204d98:	00054783          	lbu	a5,0(a0)
strlen(const char *s) {
ffffffffc0204d9c:	872a                	mv	a4,a0
    size_t cnt = 0;
ffffffffc0204d9e:	4501                	li	a0,0
    while (*s ++ != '\0') {
ffffffffc0204da0:	cb81                	beqz	a5,ffffffffc0204db0 <strlen+0x18>
        cnt ++;
ffffffffc0204da2:	0505                	addi	a0,a0,1
    while (*s ++ != '\0') {
ffffffffc0204da4:	00a707b3          	add	a5,a4,a0
ffffffffc0204da8:	0007c783          	lbu	a5,0(a5)
ffffffffc0204dac:	fbfd                	bnez	a5,ffffffffc0204da2 <strlen+0xa>
...
ffffffffc0204db2:	4781                	li	a5,0
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204db4:	e589                	bnez	a1,ffffffffc0204dbe <strnlen+0xc>
ffffffffc0204db6:	a811                	j	ffffffffc0204dca <strnlen+0x18>
        cnt ++;
ffffffffc0204db8:	0785                	addi	a5,a5,1
    while (cnt < len && *s ++ != '\0') {
ffffffffc0204dba:	00f58863          	beq	a1,a5,ffffffffc0204dca <strnlen+0x18>
ffffffffc0204dbe:	00f50733          	add	a4,a0,a5
ffffffffc0204dc2:	00074703          	lbu	a4,0(a4)
ffffffffc0204dc6:	fb6d                	bnez	a4,ffffffffc0204db8 <strnlen+0x6>
ffffffffc0204dc8:	85be                	mv	a1,a5
    }
    return cnt;
}
ffffffffc0204dca:	852e                	mv	a0,a1
ffffffffc0204dcc:	8082                	ret

ffffffffc0204dce <strcpy>:
char *
...
ffffffffc0204dd6:	0585                	addi	a1,a1,1
ffffffffc0204dd8:	fee78fa3          	sb	a4,-1(a5)
ffffffffc0204ddc:	fb75                	bnez	a4,ffffffffc0204dd0 <strcpy+0x2>
        /* nothing */;
    return dst;
...
ffffffffc0204de4:	e791                	bnez	a5,ffffffffc0204df0 <strcmp+0x10>
ffffffffc0204de6:	a02d                	j	ffffffffc0204e10 <strcmp+0x30>
ffffffffc0204de8:	00054783          	lbu	a5,0(a0)
ffffffffc0204dec:	cf89                	beqz	a5,ffffffffc0204e06 <strcmp+0x26>
ffffffffc0204dee:	85b6                	mv	a1,a3
ffffffffc0204df0:	0005c703          	lbu	a4,0(a1)
        s1 ++, s2 ++;
ffffffffc0204df4:	0505                	addi	a0,a0,1
ffffffffc0204df6:	00158693          	addi	a3,a1,1
    while (*s1 != '\0' && *s1 == *s2) {
ffffffffc0204dfa:	fef707e3          	beq	a4,a5,ffffffffc0204de8 <strcmp+0x8>
    }
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204dfe:	0007851b          	sext.w	a0,a5
#endif /* __HAVE_ARCH_STRCMP */
}
ffffffffc0204e02:	9d19                	subw	a0,a0,a4
ffffffffc0204e04:	8082                	ret
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204e06:	0015c703          	lbu	a4,1(a1)
ffffffffc0204e0a:	4501                	li	a0,0
}
ffffffffc0204e0c:	9d19                	subw	a0,a0,a4
ffffffffc0204e0e:	8082                	ret
    return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204e10:	0005c703          	lbu	a4,0(a1)
ffffffffc0204e14:	4501                	li	a0,0
ffffffffc0204e16:	b7f5                	j	ffffffffc0204e02 <strcmp+0x22>

ffffffffc0204e18 <strchr>:
...
strchr(const char *s, char c) {
    while (*s != '\0') {
ffffffffc0204e18:	00054783          	lbu	a5,0(a0)
ffffffffc0204e1c:	c799                	beqz	a5,ffffffffc0204e2a <strchr+0x12>
        if (*s == c) {
ffffffffc0204e1e:	00f58763          	beq	a1,a5,ffffffffc0204e2c <strchr+0x14>
    while (*s != '\0') {
ffffffffc0204e22:	00154783          	lbu	a5,1(a0)
            return (char *)s;
        }
        s ++;
ffffffffc0204e26:	0505                	addi	a0,a0,1
    while (*s != '\0') {
ffffffffc0204e28:	fbfd                	bnez	a5,ffffffffc0204e1e <strchr+0x6>
    }
    return NULL;
...
memset(void *s, char c, size_t n) {
    ...
    char *p = s;
    while (n -- > 0) {
ffffffffc0204e2e:	ca01                	beqz	a2,ffffffffc0204e3e <memset+0x10>
ffffffffc0204e30:	962a                	add	a2,a2,a0
    char *p = s;
ffffffffc0204e32:	87aa                	mv	a5,a0
        *p ++ = c;
ffffffffc0204e34:	0785                	addi	a5,a5,1
ffffffffc0204e36:	feb78fa3          	sb	a1,-1(a5)
    while (n -- > 0) {
ffffffffc0204e3a:	fef61de3          	bne	a2,a5,ffffffffc0204e34 <memset+0x6>
    }
    return s;
...
ffffffffc0204e40 <memcpy>:
    ...
    char *d = dst;
    while (n -- > 0) {
ffffffffc0204e40:	ca19                	beqz	a2,ffffffffc0204e56 <memcpy+0x16>
ffffffffc0204e42:	962e                	add	a2,a2,a1
    char *d = dst;
ffffffffc0204e44:	87aa                	mv	a5,a0
        *d ++ = *s ++;
ffffffffc0204e46:	0005c703          	lbu	a4,0(a1)
ffffffffc0204e4a:	0585                	addi	a1,a1,1
ffffffffc0204e4c:	0785                	addi	a5,a5,1
ffffffffc0204e4e:	fee78fa3          	sb	a4,-1(a5)
    while (n -- > 0) {
ffffffffc0204e52:	feb61ae3          	bne	a2,a1,ffffffffc0204e46 <memcpy+0x6>
    }
    return dst;
...
memcmp(const void *v1, const void *v2, size_t n) {
    ...
    while (n -- > 0) {
ffffffffc0204e58:	c205                	beqz	a2,ffffffffc0204e78 <memcmp+0x20>
ffffffffc0204e5a:	962a                	add	a2,a2,a0
ffffffffc0204e5c:	a019                	j	ffffffffc0204e62 <memcmp+0xa>
ffffffffc0204e5e:	00c50d63          	beq	a0,a2,ffffffffc0204e78 <memcmp+0x20>
        if (*s1 != *s2) {
ffffffffc0204e62:	00054783          	lbu	a5,0(a0)
ffffffffc0204e66:	0005c703          	lbu	a4,0(a1)
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
        }
        s1 ++, s2 ++;
ffffffffc0204e6a:	0505                	addi	a0,a0,1
ffffffffc0204e6c:	0585                	addi	a1,a1,1
        if (*s1 != *s2) {
ffffffffc0204e6e:	fee788e3          	beq	a5,a4,ffffffffc0204e5e <memcmp+0x6>
            return (int)((unsigned char)*s1 - (unsigned char)*s2);
ffffffffc0204e72:	40e7853b          	subw	a0,a5,a4
